...
level: intermediate
source: "https://en.wikipedia.org/wiki/Automatic_image_annotation"
wikipedia_categories: ["Applications of artificial intelligence", "Applications of computer vision", "Natural language processing"]
related: ["[[Artificial intelligence content detection]]", "[[Fake nude photography]]", "[[Vehicle infrastructure integration]]", "[[3D reconstruction from multiple images]]", "[[3D selfie]]", "[[3D tracking]]", "[[Abdul Majid Bhurgri Institute of Language Engineering]]", "[[ACL Data Collection Initiative]]", "[[Adversarial stylometry]]", "[[Affix grammar over a finite lattice]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Automatic_image_annotation