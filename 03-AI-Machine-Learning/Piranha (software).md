---
title: "Piranha (software)"
tags: ["cs", "ai-machine-learning", "intermediate"]
domain: AI & Machine Learning
level: intermediate
source: "https://en.wikipedia.org/wiki/Piranha_(software)"
wikipedia_categories: ["Agent-based software", "Cluster computing", "Data mining and machine learning software"]
related: ["[[Apache Spark]]", "[[Distributed R]]", "[[Aiyara cluster]]", "[[Alewife (multiprocessor)]]", "[[Anne O'Tate]]", "[[Apache Giraph]]", "[[Apache Mahout]]", "[[Aphelion (software)]]", "[[Beowulf cluster]]", "[[BisQue (Bioimage Analysis and Management Platform)]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Piranha_(software)