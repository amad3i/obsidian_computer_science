...
level: intermediate
source: "https://en.wikipedia.org/wiki/Business_rules_engine"
wikipedia_categories: ["Decision support systems", "Expert systems", "Rule engines"]
related: ["[[Business rule management system]]", "[[Clinical quality management system]]", "[[Cleverpath AION Business Rules Expert]]", "[[Expert system]]", "[[Expert systems for mortgages]]", "[[InRule Technology]]", "[[Jess (programming language)]]", "[[Legal expert system]]", "[[Artificial intelligence in fraud detection]]", "[[Backward chaining]]"]
---
