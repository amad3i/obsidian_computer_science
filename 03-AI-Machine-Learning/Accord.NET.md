...
level: intermediate
source: "https://en.wikipedia.org/wiki/Accord.NET"
wikipedia_categories: [".NET software", "Computer libraries", "Computer vision software"]
related: ["[[Amira (software)]]", "[[Aphelion (software)]]", "[[Avizo (software)]]", "[[Ayotle]]", "[[Binary recompiler]]", "[[Compiler]]", "[[DeepDream]]", "[[Dlib]]", "[[Dynamic library]]", "[[Dynamic linker]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Accord.NET