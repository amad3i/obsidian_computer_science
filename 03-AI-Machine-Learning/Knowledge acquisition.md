...
level: intermediate
source: "https://en.wikipedia.org/wiki/Knowledge_acquisition"
wikipedia_categories: ["Expert systems", "Knowledge economy", "Knowledge sharing"]
related: ["[[Artificial intelligence in fraud detection]]", "[[Backward chaining]]", "[[Business rule management system]]", "[[Business rules engine]]", "[[CADUCEUS (expert system)]]", "[[Cleverpath AION Business Rules Expert]]", "[[Clinical quality management system]]", "[[CLIPS]]", "[[Dendral]]", "[[EGanges]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Knowledge_acquisition