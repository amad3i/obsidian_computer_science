...
level: intermediate
source: "https://en.wikipedia.org/wiki/Knowledge_integration"
wikipedia_categories: ["Knowledge representation", "Learning", "Machine learning"]
related: ["[[Document classification]]", "[[Inferential theory of learning]]", "[[Machine learning]]", "[[Proactive learning]]", "[[Robot learning]]", "[[Stability (learning theory)]]", "[[4E cognition]]", "[[80 Million Tiny Images]]", "[[A Logical Calculus of the Ideas Immanent in Nervous Activity]]", "[[Accelerated Linear Algebra]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Knowledge_integration