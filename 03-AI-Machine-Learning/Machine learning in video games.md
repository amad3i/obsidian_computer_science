...
level: intermediate
source: "https://en.wikipedia.org/wiki/Machine_learning_in_video_games"
wikipedia_categories: ["Game artificial intelligence", "Machine learning"]
related: ["[[80 Million Tiny Images]]", "[[A Logical Calculus of the Ideas Immanent in Nervous Activity]]", "[[A- search algorithm]]", "[[Accelerated Linear Algebra]]", "[[Active learning (machine learning)]]", "[[Adversarial machine learning]]", "[[AI data center]]", "[[AI observability]]", "[[AIOps]]", "[[AIXI]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Machine_learning_in_video_games