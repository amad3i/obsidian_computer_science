...
level: intermediate
source: "https://en.wikipedia.org/wiki/DATR"
wikipedia_categories: ["Domain-specific knowledge representation languages", "Natural language processing", "Natural language processing stubs"]
related: ["[[Affix grammar over a finite lattice]]", "[[AsoSoft text corpus]]", "[[Averbis]]", "[[Calais (Reuters product)]]", "[[Cloem]]", "[[Computational semantics]]", "[[Corpus of Linguistic Acceptability]]", "[[Cross-language information retrieval]]", "[[Few-shot learning]]", "[[Gorn address]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/DATR