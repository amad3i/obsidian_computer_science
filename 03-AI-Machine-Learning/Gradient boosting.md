...
wikipedia_categories: ["Classification algorithms", "Decision trees", "Ensemble learning"]
related: ["[[AdaBoost]]", "[[Alternating decision tree]]", "[[Boosting (machine learning)]]", "[[BrownBoost]]", "[[Cascading classifiers]]", "[[Decision tree learning]]", "[[Grafting (decision trees)]]", "[[ID3 algorithm]]", "[[Information gain ratio]]", "[[LogitBoost]]"]
---
