---
title: "Language Computer Corporation"
tags: ["cs", "ai-machine-learning", "intermediate"]
domain: AI & Machine Learning
level: intermediate
source: "https://en.wikipedia.org/wiki/Language_Computer_Corporation"
wikipedia_categories: ["Companies based in Richardson, Texas", "Computational linguistics", "Natural language processing", "Natural language processing stubs", "Semantic Web companies", "Software companies based in Texas", "Software companies of the United States"]
related: ["[[Calais (Reuters product)]]", "[[Computational semantics]]", "[[Minimal recursion semantics]]", "[[Semantic analysis (computational)]]", "[[ACL Data Collection Initiative]]", "[[Adversarial stylometry]]", "[[Affix grammar over a finite lattice]]", "[[Aggregation (linguistics)]]", "[[Arabic Ontology]]", "[[Artificial intelligence content detection]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Language_Computer_Corporation