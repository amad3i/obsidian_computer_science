...
level: intermediate
source: "https://en.wikipedia.org/wiki/Semantic_neural_network"
wikipedia_categories: ["Artificial neural networks", "Natural language processing"]
related: ["[[Embedding (machine learning)]]", "[[Sentence embedding]]", "[[Seq2seq]]", "[[Word embedding]]", "[[A Logical Calculus of the Ideas Immanent in Nervous Activity]]", "[[Abdul Majid Bhurgri Institute of Language Engineering]]", "[[ACL Data Collection Initiative]]", "[[Activation function]]", "[[ADALINE]]", "[[Adaptive neuro fuzzy inference system]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Semantic_neural_network