...
wikipedia_categories: ["Neural network architectures", "Probabilistic models"]
related: ["[[AlexNet]]", "[[Class activation mapping]]", "[[Convolutional neural network]]", "[[Factored language model]]", "[[Flow-based generative model]]", "[[Gating mechanism]]", "[[Generative adversarial network]]", "[[Generative model]]", "[[Graph neural network]]", "[[Highway network]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Deep_belief_network