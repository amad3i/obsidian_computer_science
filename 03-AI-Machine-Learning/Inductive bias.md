...
level: intermediate
source: "https://en.wikipedia.org/wiki/Inductive_bias"
wikipedia_categories: ["Bias", "Machine learning"]
related: ["[[Algorithmic bias]]", "[[Equalized odds]]", "[[Fairness (machine learning)]]", "[[Temporal bias]]", "[[Ugly duckling theorem]]", "[[80 Million Tiny Images]]", "[[A Logical Calculus of the Ideas Immanent in Nervous Activity]]", "[[Accelerated Linear Algebra]]", "[[Active learning (machine learning)]]", "[[Adversarial machine learning]]"]
---
