...
wikipedia_categories: ["Logistic regression", "Predictive analytics", "Regression models"]
related: ["[[Bradley–Terry model]]", "[[Multinomial logistic regression]]", "[[Discriminative model]]", "[[EM algorithm and GMM model]]", "[[Factor regression model]]", "[[Geolitica]]", "[[Local case-control sampling]]", "[[Multi-attribute global inference of quality]]", "[[Predictive analytics]]", "[[Structural equation modeling]]"]
---
