...
wikipedia_categories: ["Artificial intelligence", "Heuristics"]
related: ["[[Admissible heuristic]]", "[[Extremal optimization]]", "[[ai]]", "[[2025–present global memory supply shortage]]", "[[2026 OpenAI agent cyberattacks]]", "[[Actor-critic algorithm]]", "[[Agent harness]]", "[[Agent verification]]", "[[Agentive logic]]", "[[AI agent]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Computational_heuristic_intelligence