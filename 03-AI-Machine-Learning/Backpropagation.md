...
related: ["[[Dehaene–Changeux model]]", "[[Growing self-organizing map]]", "[[Hyper basis function network]]", "[[Leabra]]", "[[Linde–Buzo–Gray algorithm]]", "[[LoRA (machine learning)]]", "[[Quickprop]]", "[[Rprop]]", "[[Self-organizing map]]", "[[A Logical Calculus of the Ideas Immanent in Nervous Activity]]"]
---
