...
level: intermediate
source: "https://en.wikipedia.org/wiki/Flux_(machine-learning_framework)"
wikipedia_categories: ["Free software programmed in Julia", "Machine learning", "Software using the MIT license"]
related: ["[[Julia (programming language)]]", "[[80 Million Tiny Images]]", "[[A Logical Calculus of the Ideas Immanent in Nervous Activity]]", "[[A-Frame (software)]]", "[[Accelerated Linear Algebra]]", "[[Active learning (machine learning)]]", "[[ADO.NET]]", "[[Adversarial machine learning]]", "[[AI data center]]", "[[AI observability]]"]
---
