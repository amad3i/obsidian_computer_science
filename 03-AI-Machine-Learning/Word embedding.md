...
wikipedia_categories: ["Artificial neural networks", "Computational linguistics", "Language modeling", "Natural language processing", "Semantic relations"]
related: ["[[Sentence embedding]]", "[[Cache language model]]", "[[Foundation model]]", "[[N-gram]]", "[[ACL Data Collection Initiative]]", "[[Adversarial stylometry]]", "[[Aggregation (linguistics)]]", "[[Arabic Ontology]]", "[[Artificial intelligence content detection]]", "[[Association for Computational Linguistics]]"]
---
