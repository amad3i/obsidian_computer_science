...
level: intermediate
source: "https://en.wikipedia.org/wiki/Action_selection"
wikipedia_categories: ["Functional analysis", "Motor cognition", "Motor control", "Problems in artificial intelligence"]
related: ["[[AI winter]]", "[[Antiunitary operator]]", "[[Asymptotic geometry]]", "[[Circular convolution]]", "[[Complementarity theory]]", "[[Convolution]]", "[[Cyclical monotonicity]]", "[[Density matrix]]", "[[Discretization]]", "[[Dual norm]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Action_selection