...
level: intermediate
source: "https://en.wikipedia.org/wiki/Neural_computation"
wikipedia_categories: ["Artificial intelligence", "Cognitive science", "Computational neuroscience", "Neurons", "Theory of mind"]
related: ["[[AI alignment]]", "[[Artificial brain]]", "[[Artificial consciousness]]", "[[Artificial general intelligence]]", "[[Artificial intelligence]]", "[[Artificial intelligence arms race]]", "[[Artificial psychology]]", "[[Artificial wisdom]]", "[[Automated machine learning]]", "[[Behavior informatics]]"]
---
...
Neural computation can be studied by, for example, building models of neural computation.
Work on artificial neural networks has been somewhat inspired by knowledge of neural computation.
...
- Wikipedia: https://en.wikipedia.org/wiki/Neural_computation