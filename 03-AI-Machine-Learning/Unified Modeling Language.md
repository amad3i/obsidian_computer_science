...
wikipedia_categories: ["Architecture description language", "Data modeling diagrams", "Data modeling languages", "Diagrams", "ISO standards", "Knowledge representation", "Modeling languages", "Software modeling language"]
related: ["[[ERIL]]", "[[C4 model]]", "[[Entity–relationship model]]", "[[ArchiMate]]", "[[Architecture description language]]", "[[Basic Formal Ontology]]", "[[Concept map]]", "[[Conceptual graph]]", "[[Control-flow diagram]]", "[[Data-flow diagram]]"]
---
