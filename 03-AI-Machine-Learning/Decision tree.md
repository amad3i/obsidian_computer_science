...
wikipedia_categories: ["Decision analysis", "Decision trees"]
related: ["[[Alternating decision tree]]", "[[Decision analysis]]", "[[Decision stump]]", "[[Decision table]]", "[[Decision tree learning]]", "[[Decision tree model]]", "[[Decision tree pruning]]", "[[Fast-and-frugal trees]]", "[[Gradient boosting]]", "[[Grafting (decision trees)]]"]
---
...
Binary decision diagram – Data structure for Boolean functions
Boosting (machine learning) – Ensemble learning method
...
Random forest – Tree-based ensemble machine learning methods
...
Topological combinatorics – Mathematical subject
