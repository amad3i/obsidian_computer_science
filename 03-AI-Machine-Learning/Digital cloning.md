...
level: intermediate
source: "https://en.wikipedia.org/wiki/Digital_cloning"
wikipedia_categories: ["Applications of artificial intelligence", "Computer graphics", "Deep learning", "Identity theft", "Special effects"]
related: ["[[Digital video effect]]", "[[Fake nude photography]]", "[[Human image synthesis]]", "[[LTX (text-to-video model)]]", "[[Morphing]]", "[[Perlin noise]]", "[[Text-to-image personalization]]", "[[2D computer graphics]]", "[[3D computer graphics]]", "[[3D lookup table]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Digital_cloning