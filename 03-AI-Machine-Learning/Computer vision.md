...
wikipedia_categories: ["Computer vision", "Image processing", "Packaging machinery"]
related: ["[[3D selfie]]", "[[Class activation mapping]]", "[[Color normalization]]", "[[Contextual image classification]]", "[[Digital image processing]]", "[[Document mosaicing]]", "[[Dynamic texture]]", "[[Image destriping]]", "[[Image formation]]", "[[Image moment]]"]
---
