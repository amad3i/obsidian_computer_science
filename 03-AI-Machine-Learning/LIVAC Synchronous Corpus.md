...
level: advanced
source: "https://en.wikipedia.org/wiki/LIVAC_Synchronous_Corpus"
wikipedia_categories: ["Applied linguistics", "Computational linguistics", "Corpus linguistics", "Linguistic research", "Natural language processing", "Online databases"]
related: ["[[Manually Annotated Sub-Corpus]]", "[[Corpus manager]]", "[[Google Books Ngram Viewer]]", "[[N-gram]]", "[[Native-language identification]]", "[[PropBank]]", "[[TIMIT]]", "[[ACL Data Collection Initiative]]", "[[Adversarial stylometry]]", "[[Aggregation (linguistics)]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/LIVAC_Synchronous_Corpus