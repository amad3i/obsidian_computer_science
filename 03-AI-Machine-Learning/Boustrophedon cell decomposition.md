---
title: "Boustrophedon cell decomposition"
tags: ["cs", "ai-machine-learning", "intermediate"]
domain: AI & Machine Learning
level: intermediate
source: "https://en.wikipedia.org/wiki/Boustrophedon_cell_decomposition"
wikipedia_categories: ["Computer vision", "Robot control"]
related: ["[[3D pose estimation]]", "[[Joint compatibility branch and bound]]", "[[Pose (computer vision)]]", "[[Stereo cameras]]", "[[Visual servoing]]", "[[3D body scanning]]", "[[3D Morphable Model]]", "[[3D reconstruction]]", "[[3D scanning]]", "[[3D selfie]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Boustrophedon_cell_decomposition