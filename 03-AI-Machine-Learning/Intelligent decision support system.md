...
level: intermediate
source: "https://en.wikipedia.org/wiki/Intelligent_decision_support_system"
wikipedia_categories: ["Artificial intelligence", "Decision support systems", "Information systems", "Knowledge engineering"]
related: ["[[Decision support system]]", "[[Clinical decision support system]]", "[[Connectionist expert system]]", "[[Executive information system]]", "[[Expert system]]", "[[Expert systems for mortgages]]", "[[Knowledge-based systems]]", "[[Legal expert system]]", "[[Preference elicitation]]", "[[Self-service]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Intelligent_decision_support_system