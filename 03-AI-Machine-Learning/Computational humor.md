...
level: intermediate
source: "https://en.wikipedia.org/wiki/Computational_humor"
wikipedia_categories: ["Artificial intelligence", "Computational fields of study", "Computational linguistics"]
related: ["[[Adversarial stylometry]]", "[[Artificial intelligence]]", "[[Artificial intelligence content detection]]", "[[Artificial wisdom]]", "[[Computational semantics]]", "[[Foundation model]]", "[[Natural language processing]]", "[[Organoid intelligence]]", "[[Semantic analysis (computational)]]", "[[Statistical semantics]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Computational_humor