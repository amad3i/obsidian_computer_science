...
wikipedia_categories: ["Computational fields of study", "Formal sciences", "Machine learning", "Pattern recognition"]
related: ["[[Artificial intelligence]]", "[[Artificial intelligence content detection]]", "[[Artificial wisdom]]", "[[Feature (machine learning)]]", "[[Organoid intelligence]]", "[[80 Million Tiny Images]]", "[[A Logical Calculus of the Ideas Immanent in Nervous Activity]]", "[[Accelerated Linear Algebra]]", "[[Active learning (machine learning)]]", "[[Adversarial machine learning]]"]
---
