...
level: intermediate
source: "https://en.wikipedia.org/wiki/Machine_perception"
wikipedia_categories: ["Artificial intelligence", "Artificial intelligence engineering"]
related: ["[[AIOps]]", "[[Argumentation framework]]", "[[AZFinText]]", "[[Bayesian programming]]", "[[Emergent algorithm]]", "[[Explainable artificial intelligence]]", "[[ai]]", "[[2025–present global memory supply shortage]]", "[[2026 OpenAI agent cyberattacks]]", "[[Actor-critic algorithm]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Machine_perception