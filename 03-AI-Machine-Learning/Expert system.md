...
wikipedia_categories: ["Decision support systems", "Expert systems", "Information systems"]
related: ["[[Expert systems for mortgages]]", "[[Legal expert system]]", "[[Business rule management system]]", "[[Business rules engine]]", "[[Clinical decision support system]]", "[[Clinical quality management system]]", "[[Decision support system]]", "[[Executive information system]]", "[[Intelligent decision support system]]", "[[Preference elicitation]]"]
---
...
It can be argued that expert systems have moved into the area of business rules and business rules management systems.
