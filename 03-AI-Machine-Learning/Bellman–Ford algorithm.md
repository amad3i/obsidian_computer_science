...
wikipedia_categories: ["Dynamic programming", "Graph algorithms", "Graph distance", "Polynomial-time problems"]
related: ["[[Floyd–Warshall algorithm]]", "[[Seidel's algorithm]]", "[[A- search algorithm]]", "[[Centrality]]", "[[Dijkstra's algorithm]]", "[[Group centrality]]", "[[Johnson's algorithm]]", "[[K shortest path routing]]", "[[Longest common subsequence]]", "[[Longest path problem]]"]
---
...
Cormen, Thomas H.; Leiserson, Charles E.; Rivest, Ronald L.; Stein, Clifford (2022) . Introduction to Algorithms (4th ed.). MIT Press and McGraw-Hill. ISBN 0-262-04630-X. Section 22.1: The Bellman–Ford algorithm, pp. 612–616. Problem 22–1, p. 640.
...
- Wikipedia: https://en.wikipedia.org/wiki/Bellman–Ford_algorithm