...
level: intermediate
source: "https://en.wikipedia.org/wiki/Automatic_identification_and_data_capture"
wikipedia_categories: ["Automatic identification and data capture", "Encodings", "Human–computer interaction", "Multimodal interaction", "Radio-frequency identification"]
related: ["[[10-foot user interface]]", "[[Collaborative information seeking]]", "[[Interaction Design Foundation]]", "[[Irissometry]]", "[[Memex]]", "[[Multimodal Architecture and Interfaces]]", "[[New Interfaces for Musical Expression]]", "[[PACT (interaction design)]]", "[[3D human–computer interaction]]", "[[3Dconnexion]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Automatic_identification_and_data_capture