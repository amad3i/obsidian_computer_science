...
wikipedia_categories: ["Management theory", "Multi-agent systems"]
related: ["[[Business analytics]]", "[[Capability management in business]]", "[[Clustering of self-propelled particles]]", "[[Collective motion]]", "[[Consensus dynamics]]", "[[Deliberative agent]]", "[[Leadership]]", "[[MCACEA]]", "[[Multi-agent pathfinding]]", "[[Multi-agent planning]]"]
---
