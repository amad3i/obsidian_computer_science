...
wikipedia_categories: ["Generative AI", "Machine learning"]
related: ["[[Generative AI]]", "[[H (company)]]", "[[Hallucination (artificial intelligence)]]", "[[Mode collapse]]", "[[Prompt engineering]]", "[[80 Million Tiny Images]]", "[[A Logical Calculus of the Ideas Immanent in Nervous Activity]]", "[[Accelerated Linear Algebra]]", "[[Active learning (machine learning)]]", "[[Adversarial machine learning]]"]
---
