...
level: intermediate
source: "https://en.wikipedia.org/wiki/Terminology_extraction"
wikipedia_categories: ["Computing terminology", "Information science", "Tasks of natural language processing"]
related: ["[[Semantic interoperability]]", "[[Address space]]", "[[Agricultural Information Management Standards]]", "[[Algorithms of Oppression]]", "[[Application posture]]", "[[Arabic Ontology]]", "[[ArchiMate]]", "[[Automated essay scoring]]", "[[Automatic summarization]]", "[[Basic Formal Ontology]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Terminology_extraction