...
level: intermediate
source: "https://en.wikipedia.org/wiki/Artificial_brain"
wikipedia_categories: ["Artificial intelligence", "Brain", "Computational neuroscience", "Robotics engineering", "Thought experiments in philosophy of mind"]
related: ["[[AI alignment]]", "[[Artificial consciousness]]", "[[Artificial general intelligence]]", "[[Artificial intelligence]]", "[[Artificial intelligence arms race]]", "[[Artificial wisdom]]", "[[Automated machine learning]]", "[[Empowerment (artificial intelligence)]]", "[[Intrinsic motivation (artificial intelligence)]]", "[[Neural computation]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Artificial_brain