...
level: intermediate
source: "https://en.wikipedia.org/wiki/Generative_AI"
wikipedia_categories: ["2020s fads and trends", "2020s in computing", "2023 in computing", "2024 in computing", "2025 in computing", "Artificial neural networks", "Deep learning", "Generative AI"]
related: ["[[Spatial computing]]", "[[Circuit (neural network)]]", "[[Convolutional layer]]", "[[Gayfemboy]]", "[[Generative pre-trained transformer]]", "[[Hallucination (artificial intelligence)]]", "[[Hierarchical temporal memory]]", "[[Hyperdimensional computing]]", "[[Kolmogorov–Arnold Networks]]", "[[Large width limits of neural networks]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Generative_AI