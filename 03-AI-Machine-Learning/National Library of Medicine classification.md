...
level: intermediate
source: "https://en.wikipedia.org/wiki/National_Library_of_Medicine_classification"
wikipedia_categories: ["Knowledge representation", "Library cataloging and classification", "Medical classification", "United States National Library of Medicine"]
related: ["[[AgMES]]", "[[Brian Deer Classification System]]", "[[Brinkler classification]]", "[[British Catalogue of Music Classification]]", "[[Chinese Library Classification]]", "[[Colon classification]]", "[[Controlled vocabulary]]", "[[Cutter Expansive Classification]]", "[[Dublin Core]]", "[[Keyword AAA]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/National_Library_of_Medicine_classification