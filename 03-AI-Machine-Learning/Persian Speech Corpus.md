...
level: intermediate
source: "https://en.wikipedia.org/wiki/Persian_Speech_Corpus"
wikipedia_categories: ["Corpus linguistics stubs", "Datasets in machine learning", "Indo-European language stubs", "Library and information science stubs", "Persian corpora", "Persian language"]
related: ["[[TIMIT]]", "[[AsoSoft text corpus]]", "[[Buckeye Corpus]]", "[[PCVC Speech Dataset]]", "[[Speech corpus]]", "[[VoxForge]]", "[[ACL Data Collection Initiative]]", "[[Arabic Speech Corpus]]", "[[Class (knowledge representation)]]", "[[Content format]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Persian_Speech_Corpus