...
level: intermediate
source: "https://en.wikipedia.org/wiki/Cross-language_information_retrieval"
wikipedia_categories: ["Information retrieval genres", "Library and information science stubs", "Natural language processing", "Natural language processing stubs"]
related: ["[[AsoSoft text corpus]]", "[[Affix grammar over a finite lattice]]", "[[Averbis]]", "[[Calais (Reuters product)]]", "[[Cloem]]", "[[Computational semantics]]", "[[Corpus of Linguistic Acceptability]]", "[[DATR]]", "[[Few-shot learning]]", "[[Gorn address]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Cross-language_information_retrieval