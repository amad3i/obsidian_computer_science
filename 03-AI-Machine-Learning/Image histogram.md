...
wikipedia_categories: ["Feature detection (computer vision)", "Image processing", "Photography stubs"]
related: ["[[Box blur]]", "[[Circle Hough Transform]]", "[[Co-occurrence matrix]]", "[[Convolution]]", "[[Epsilon photography]]", "[[Gigamacro]]", "[[Image subtraction]]", "[[Kernel (image processing)]]", "[[Robinson compass mask]]", "[[Steerable filter]]"]
---
