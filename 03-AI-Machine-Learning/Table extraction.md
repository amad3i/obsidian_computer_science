...
level: intermediate
source: "https://en.wikipedia.org/wiki/Table_extraction"
...
Table extraction is the process of recognizing and separating a table from a large document, possibly also recognizing individual rows, columns or elements.
...
- Wikipedia: https://en.wikipedia.org/wiki/Table_extraction