...
wikipedia_categories: ["Computational fields of study", "Computational linguistics", "Natural language processing"]
related: ["[[Adversarial stylometry]]", "[[Artificial intelligence content detection]]", "[[Computational semantics]]", "[[Foundation model]]", "[[Semantic analysis (computational)]]", "[[Voice computing]]", "[[ACL Data Collection Initiative]]", "[[Aggregation (linguistics)]]", "[[Arabic Ontology]]", "[[Association for Computational Linguistics]]"]
---
