...
level: intermediate
source: "https://en.wikipedia.org/wiki/Natural_language"
wikipedia_categories: ["Language", "Linguistics terminology", "Natural language processing", "Neuropsychological assessment", "Philosophical logic", "Philosophy of language"]
related: ["[[Proof-theoretic semantics]]", "[[Term logic]]", "[[Text-to-video model]]", "[[Abdul Majid Bhurgri Institute of Language Engineering]]", "[[ACL Data Collection Initiative]]", "[[Adversarial stylometry]]", "[[Affix grammar over a finite lattice]]", "[[AFNLP]]", "[[Agentive logic]]", "[[Aggregation (linguistics)]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Natural_language