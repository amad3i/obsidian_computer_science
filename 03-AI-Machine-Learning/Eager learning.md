...
level: intermediate
source: "https://en.wikipedia.org/wiki/Eager_learning"
wikipedia_categories: ["Machine learning", "Machine learning stubs"]
related: ["[[Astrostatistics]]", "[[Bayesian learning mechanisms]]", "[[Cost-sensitive machine learning]]", "[[Decision list]]", "[[Equalized odds]]", "[[Expectation propagation]]", "[[Few-shot learning]]", "[[Hidden layer]]", "[[Inauthentic text]]", "[[Inferential theory of learning]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Eager_learning