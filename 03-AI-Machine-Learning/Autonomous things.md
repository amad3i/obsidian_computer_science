...
level: intermediate
source: "https://en.wikipedia.org/wiki/Autonomous_things"
wikipedia_categories: ["Ambient intelligence", "Automation", "Internet of things", "Robotics", "Robotics engineering"]
related: ["[[Behavior-based robotics]]", "[[Bin picking]]", "[[Edge computing]]", "[[Fog computing]]", "[[Human–robot interaction]]", "[[Laboratory automation]]", "[[Laws of robotics]]", "[[Manufacture Modules Technologies]]", "[[Molecular nanotechnology]]", "[[Robotics engineering]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Autonomous_things