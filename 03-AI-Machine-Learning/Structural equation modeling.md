...
level: intermediate
source: "https://en.wikipedia.org/wiki/Structural_equation_modeling"
wikipedia_categories: ["Graphical models", "Latent variable models", "Regression models", "Structural equation models"]
related: ["[[Factor regression model]]", "[[Belief propagation]]", "[[Bradley–Terry model]]", "[[Common-method variance]]", "[[Confirmatory factor analysis]]", "[[Dependability state model]]", "[[Discriminative model]]", "[[Doubly stochastic model]]", "[[Dynamic topic model]]", "[[Dynamic unobserved effects model]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Structural_equation_modeling