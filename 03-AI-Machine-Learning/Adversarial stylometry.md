---
title: "Adversarial stylometry"
tags: ["cs", "ai-machine-learning", "intermediate"]
domain: AI & Machine Learning
level: intermediate
source: "https://en.wikipedia.org/wiki/Adversarial_stylometry"
wikipedia_categories: ["Computational fields of study", "Computational linguistics", "Counter-forensics", "Data anonymization techniques", "Digital humanities", "Information privacy", "Natural language processing", "Personal identification"]
related: ["[[Stylometry]]", "[[Artificial intelligence content detection]]", "[[Computational semantics]]", "[[Foundation model]]", "[[Natural language processing]]", "[[Semantic analysis (computational)]]", "[[Voice computing]]", "[[ACL Data Collection Initiative]]", "[[Aggregation (linguistics)]]", "[[Arabic Ontology]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Adversarial_stylometry