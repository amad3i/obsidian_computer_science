...
wikipedia_categories: ["Regression analysis"]
related: ["[[Calibration (statistics)]]", "[[Guess value]]", "[[Idempotent matrix]]", "[[Identifiability analysis]]", "[[Linear predictor function]]", "[[Optimal experimental design]]", "[[Principal component regression]]", "[[Ridge regression]]", "[[Sliced inverse regression]]"]
---
