...
wikipedia_categories: ["Classification algorithms", "Ensemble learning", "Learning in computer vision", "Object recognition and categorization"]
related: ["[[AdaBoost]]", "[[BrownBoost]]", "[[Cascading classifiers]]", "[[Gradient boosting]]", "[[LogitBoost]]", "[[Random subspace method]]", "[[(1+ε)-approximate nearest neighbor search]]", "[[AlexNet]]", "[[ALOPEX]]", "[[Alternating decision tree]]"]
---
