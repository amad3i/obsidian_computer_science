...
level: intermediate
source: "https://en.wikipedia.org/wiki/Concept_map"
wikipedia_categories: ["Conceptual modelling", "Constructivism (psychological school)", "Diagrams", "Educational technology", "Graph drawing", "Knowledge representation", "Note-taking", "Visual thinking"]
related: ["[[Mind map]]", "[[C4 model]]", "[[Conceptual graph]]", "[[Data-flow diagram]]", "[[ERIL]]", "[[Futures wheel]]", "[[Group concept mapping]]", "[[Issue tree]]", "[[Learning object metadata]]", "[[Mathematical model]]"]
---
