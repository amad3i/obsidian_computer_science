...
level: intermediate
source: "https://en.wikipedia.org/wiki/Model-free_(reinforcement_learning)"
wikipedia_categories: ["Reinforcement learning"]
related: ["[[Actor-critic algorithm]]", "[[AlphaChip]]", "[[Deep reinforcement learning]]", "[[Distributional Soft Actor Critic]]", "[[Multi-agent reinforcement learning]]", "[[OpenAI Five]]", "[[Policy gradient method]]", "[[Proximal policy optimization]]", "[[Q-learning]]", "[[Reinforcement learning from human feedback]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Model-free_(reinforcement_learning)