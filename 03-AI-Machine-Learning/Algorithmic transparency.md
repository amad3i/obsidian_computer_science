...
level: intermediate
source: "https://en.wikipedia.org/wiki/Algorithmic_transparency"
wikipedia_categories: ["Accountability", "Algorithms", "Criticism of artificial intelligence", "Theoretical computer science", "Transparency (behavior)"]
related: ["[[Algorithm]]", "[[Algorithm engineering]]", "[[Algorithmic logic]]", "[[Hindley–Milner type system]]", "[[Learning augmented algorithm]]", "[[Least-squares spectral analysis]]", "[[Right to explanation]]", "[[Unrestricted algorithm]]", "[[Adaptive algorithm]]", "[[AI slop]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Algorithmic_transparency