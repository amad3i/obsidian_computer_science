...
level: intermediate
source: "https://en.wikipedia.org/wiki/Discovery_system_(artificial_intelligence)"
wikipedia_categories: ["Applications of artificial intelligence", "Data mining", "Machine learning"]
related: ["[[Anomaly detection]]", "[[Artificial intelligence in hiring]]", "[[Astrostatistics]]", "[[Automation in construction]]", "[[Concept drift]]", "[[Document classification]]", "[[Feature (machine learning)]]", "[[Formal concept analysis]]", "[[Hierarchical navigable small world]]", "[[Instance selection]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Discovery_system_(artificial_intelligence)