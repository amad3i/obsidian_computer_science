...
level: advanced
source: "https://en.wikipedia.org/wiki/Anthony_Levandowski"
wikipedia_categories: ["1980 births", "American people of Polish descent", "American technology company founders", "American transhumanists", "Artificial intelligence researchers", "Businesspeople from the San Francisco Bay Area", "Google employees", "Machine learning researchers"]
related: ["[[Lior Ron (business executive)]]", "[[Stephen Wolfram]]", "[[Andrew Ng]]", "[[Corinna Cortes]]", "[[Geoffrey Hinton]]", "[[Ilya Sutskever]]", "[[Lore Harp McGovern]]", "[[Martin M. Wattenberg]]", "[[Ray Kurzweil]]", "[[Sebastian Thrun]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Anthony_Levandowski