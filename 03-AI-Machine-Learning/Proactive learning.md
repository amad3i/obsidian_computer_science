...
level: intermediate
source: "https://en.wikipedia.org/wiki/Proactive_learning"
wikipedia_categories: ["Learning", "Machine learning", "Machine learning stubs"]
related: ["[[Inferential theory of learning]]", "[[Astrostatistics]]", "[[Bayesian learning mechanisms]]", "[[Cost-sensitive machine learning]]", "[[Decision list]]", "[[Eager learning]]", "[[Equalized odds]]", "[[Expectation propagation]]", "[[Few-shot learning]]", "[[Hidden layer]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Proactive_learning