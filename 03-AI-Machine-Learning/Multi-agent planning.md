...
level: intermediate
source: "https://en.wikipedia.org/wiki/Multi-agent_planning"
wikipedia_categories: ["Automated planning and scheduling", "Multi-agent systems", "Organization stubs"]
related: ["[[Pebble motion problems]]", "[[Automated planning and scheduling]]", "[[Behavior tree (artificial intelligence, robotics and control)]]", "[[Clustering of self-propelled particles]]", "[[Collective motion]]", "[[Consensus dynamics]]", "[[Deliberative agent]]", "[[Genetic algorithm scheduling]]", "[[Graphplan]]", "[[Kinodynamic planning]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Multi-agent_planning