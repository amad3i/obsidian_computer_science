...
wikipedia_categories: ["Deep learning", "Energy consumption", "Energy policy", "Environmental impact by source", "Environmental impact of the energy industry", "Large language models", "Natural language processing", "Water and the environment"]
related: ["[[AI data center]]", "[[Artificial intelligence content detection]]", "[[Contextual AI]]", "[[Conversica]]", "[[Foundation model]]", "[[Geospatial foundation model]]", "[[Jais (language model)]]", "[[LLM-as-a-Judge]]", "[[Post-training of large language models]]", "[[Prompt engineering]]"]
---
...
Open weights – Public availability of the learned parameters of an artificial intelligence model
