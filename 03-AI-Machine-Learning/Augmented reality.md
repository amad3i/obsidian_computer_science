...
wikipedia_categories: ["3D GUIs", "3D human–computer interaction", "Applications of computer vision", "Augmented reality", "User interface techniques"]
related: ["[[Circular review system]]", "[[3D human–computer interaction]]", "[[3D tracking]]", "[[ARToolKit]]", "[[Eye tracking]]", "[[Finger tracking]]", "[[Meta (augmented reality company)]]", "[[Microsoft Mesh]]", "[[Virtual reality]]", "[[Zooming user interface]]"]
---
