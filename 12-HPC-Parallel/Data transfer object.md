...
wikipedia_categories: ["Architectural pattern (computer science)", "Computer programming stubs", "Concurrent computing", "Software design patterns"]
related: ["[[Action–domain–responder]]", "[[Interceptor pattern]]", "[[Active object]]", "[[Active record pattern]]", "[[Aggregate pattern]]", "[[Balking pattern]]", "[[Broker pattern]]", "[[Concurrency pattern]]", "[[Data access object]]", "[[Data mapper pattern]]"]
---
