...
related: ["[[Alewife (multiprocessor)]]", "[[Automatic mutual exclusion]]", "[[Cellular multiprocessing]]", "[[Cost efficiency]]", "[[Degree of parallelism]]", "[[HBJ model]]", "[[Implicit parallelism]]", "[[LogP machine]]", "[[Microparallelism]]", "[[Program dependence graph]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Explicit_parallelism