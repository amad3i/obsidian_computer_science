...
domain: HPC & Parallel
level: intermediate
source: "https://en.wikipedia.org/wiki/Finite_element_machine"
wikipedia_categories: ["Finite element method", "History of Hampton, Virginia", "Massively parallel computers", "NASA", "NASA online", "One-of-a-kind computers", "Parallel computing", "Supercomputers"]
related: ["[[ILLIAC IV]]", "[[Connection Machine]]", "[[IWarp]]", "[[Parsytec]]", "[[SUPRENUM]]", "[[Thinking Machines Corporation]]", "[[WARP (systolic array)]]", "[[Computer cluster]]", "[[Content-addressable parallel processor]]", "[[Heterogeneous Element Processor]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Finite_element_machine