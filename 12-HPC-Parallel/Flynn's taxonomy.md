...
tags: ["cs", "hpc-parallel", "core"]
domain: HPC & Parallel
level: core
source: "https://en.wikipedia.org/wiki/Flynn's_taxonomy"
wikipedia_categories: ["Classes of computers", "Flynn's taxonomy"]
related: ["[[Asymmetric multiprocessing]]", "[[Multiple instruction, multiple data]]", "[[Multiple instruction, single data]]", "[[Single instruction, multiple data]]", "[[Symmetric multiprocessing]]", "[[Von Neumann architecture]]", "[[Amorphous computing]]", "[[Bare machine]]", "[[Blobotics]]", "[[Cellular architecture]]"]
---
...
An alternative name for this type of register-based SIMD is "packed SIMD" and another is SIMD within a register (SWAR).
...
- Wikipedia: https://en.wikipedia.org/wiki/Flynn's_taxonomy