...
domain: HPC & Parallel
level: intermediate
source: "https://en.wikipedia.org/wiki/Master-checker"
wikipedia_categories: ["Fault-tolerant computer systems", "Microcomputer stubs", "Parallel computing"]
related: ["[[Computer cluster]]", "[[Milbeaut]]", "[[OpenVMS]]", "[[ABIT BP6]]", "[[Advanced Synchronization Facility]]", "[[Aiyara cluster]]", "[[Alewife (multiprocessor)]]", "[[Algorithmic skeleton]]", "[[All nearest smaller values]]", "[[All-to-all (parallel pattern)]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Master-checker