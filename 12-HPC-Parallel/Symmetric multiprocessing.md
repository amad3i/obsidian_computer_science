...
related: ["[[Asymmetric multiprocessing]]", "[[Multiple instruction, multiple data]]", "[[Multiple instruction, single data]]", "[[Single instruction, multiple data]]", "[[Amorphous computing]]", "[[Cellular architecture]]", "[[Computer cluster]]", "[[Fifth Generation Computer Systems]]", "[[Flynn's taxonomy]]", "[[Locale (computer hardware)]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Symmetric_multiprocessing