...
related: ["[[Alewife (multiprocessor)]]", "[[Automatic mutual exclusion]]", "[[Cost efficiency]]", "[[Degree of parallelism]]", "[[Explicit parallelism]]", "[[HBJ model]]", "[[Implicit parallelism]]", "[[LogP machine]]", "[[Microparallelism]]", "[[Program dependence graph]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Cellular_multiprocessing