...
related: ["[[Abstract data type]]", "[[Associative array]]", "[[Container (abstract data type)]]", "[[Priority queue]]", "[[Queue (abstract data type)]]"]
---
...
== Further reading ==
Knuth, Donald (1997). "§2.2.1: Stacks, Queues, and Deques". The Art of Computer Programming. Vol. 1: Fundamental Algorithms (3rd ed.). Addison-Wesley. pp. 238–243. ISBN 0-201-89683-4.
