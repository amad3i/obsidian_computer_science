...
wikipedia_categories: ["Computational complexity theory", "Cryptography"]
related: ["[[123 Reg]]", "[[Aanderaa–Karp–Rosenberg conjecture]]", "[[Accumulator (cryptography)]]", "[[Adaptive redaction]]", "[[Advanced Encryption Standard]]", "[[Advice (complexity)]]", "[[Alice and Bob]]", "[[Analysis of algorithms]]", "[[Anonymous matching]]", "[[Anonymous remailer]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Proof_of_knowledge