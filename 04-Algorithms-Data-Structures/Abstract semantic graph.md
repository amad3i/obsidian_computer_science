...
level: intermediate
source: "https://en.wikipedia.org/wiki/Abstract_semantic_graph"
wikipedia_categories: ["Formal languages", "Graph data structures"]
related: ["[[Abstract family of acceptors]]", "[[Abstract family of languages]]", "[[Abstract rewriting system]]", "[[Abstract syntax tree]]", "[[Action algebra]]", "[[Adaptive grammar]]", "[[Affix grammar]]", "[[Agent Communications Language]]", "[[Algorithmic learning theory]]", "[[Alphabet (formal languages)]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Abstract_semantic_graph