...
wikipedia_categories: ["Complexity classes", "NP-hard problems"]
related: ["[[Catalytic computing]]", "[[Closest string]]", "[[Complexity class]]", "[[Graph bandwidth]]", "[[Graph coloring]]", "[[List of computability and complexity topics]]", "[[Pseudo-polynomial time]]", "[[Pseudo-polynomial transformation]]", "[[Quadratic assignment problem]]", "[[Quasi-polynomial time]]"]
---
