...
wikipedia_categories: ["Analysis of algorithms", "Computational complexity theory"]
related: ["[[Best, worst and average case]]", "[[Combinatorial search]]", "[[Computational complexity]]", "[[Half-exponential function]]", "[[Klee–Minty cube]]", "[[Pseudo-polynomial time]]", "[[Quasi-polynomial time]]", "[[Smoothed analysis]]", "[[Time complexity]]", "[[Aanderaa–Karp–Rosenberg conjecture]]"]
---
