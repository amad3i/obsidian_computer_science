---
title: "Shared snapshot objects"
tags: ["cs", "algorithms-data-structures", "intermediate"]
domain: Algorithms & Data Structures
level: intermediate
source: "https://en.wikipedia.org/wiki/Shared_snapshot_objects"
wikipedia_categories: ["Distributed algorithms", "Distributed computing", "Distributed computing problems"]
related: ["[[Mega-Merger]]", "[[SWIM Protocol]]", "[[Yo-yo (algorithm)]]", "[[ActivityPub]]", "[[AT Protocol]]", "[[Automatic vectorization]]", "[[Availability zone]]", "[[Big memory]]", "[[Botnet]]", "[[Brooks–Iyengar algorithm]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Shared_snapshot_objects