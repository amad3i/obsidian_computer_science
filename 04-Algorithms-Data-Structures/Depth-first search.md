...
related: ["[[A- search algorithm]]", "[[Alpha–beta pruning]]", "[[B-]]", "[[Bidirectional search]]", "[[Breadth-first search]]", "[[Contraction hierarchies]]", "[[D-]]", "[[Dijkstra's algorithm]]", "[[Fringe search]]", "[[Iterative deepening A-]]"]
---
...
Iterative deepening depth-first search – Tree searching strategy
