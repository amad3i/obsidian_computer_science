...
level: intermediate
source: "https://en.wikipedia.org/wiki/Adaptive_algorithm"
wikipedia_categories: ["Algorithms", "Software engineering stubs"]
related: ["[[Active reviews for intermediate designs]]", "[[Algorism]]", "[[Algorithm]]", "[[Algorithm characterizations]]", "[[Algorithm engineering]]", "[[Algorithm IMED]]", "[[Algorithmic amplification]]", "[[Algorithmic logic]]", "[[Algorithmic management]]", "[[Algorithmic mechanism design]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Adaptive_algorithm