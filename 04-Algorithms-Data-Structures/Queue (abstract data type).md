...
wikipedia_categories: ["Abstract data types"]
related: ["[[Abstract data type]]", "[[Associative array]]", "[[Container (abstract data type)]]", "[[Priority queue]]", "[[Stack (abstract data type)]]"]
---
...
A doubly linked list has 
 ...
 insertion and deletion at both ends, so it is a natural choice for queues.
...
, but individual operations can take 
 ...
 is the number of elements in the queue. The second implementation is called a real-time queue and it allows the queue to be persistent with operations in O(1) worst-case time. It is a more complex implementation and requires lazy lists with memoization. 
...
Let us call 
 ...
 reversed. Let us furthermore assume that 
...
, and return the concatenation of 
...
, forces the computation of a part of the (lazy) list 
