...
wikipedia_categories: ["3D computer graphics", "Computer graphics", "Computer graphics data structures"]
related: ["[[3D computer graphics]]", "[[Fiducial marker]]", "[[Function representation]]", "[[Joint constraints]]", "[[Kinematic chain]]", "[[Nonobtuse mesh]]", "[[Per-pixel lighting]]", "[[Polygon mesh]]", "[[Polygon soup]]", "[[Rasterisation]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Viewport