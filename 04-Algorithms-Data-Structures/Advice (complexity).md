...
level: advanced
source: "https://en.wikipedia.org/wiki/Advice_(complexity)"
wikipedia_categories: ["Computational complexity theory"]
related: ["[[Aanderaa–Karp–Rosenberg conjecture]]", "[[Analysis of algorithms]]", "[[Approximation algorithm]]", "[[Asymptotic computational complexity]]", "[[Averaging argument]]", "[[Bernstein–Vazirani algorithm]]", "[[Best, worst and average case]]", "[[Boolean circuit]]", "[[Certificate (complexity)]]", "[[Circuit complexity]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Advice_(complexity)