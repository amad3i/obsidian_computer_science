...
wikipedia_categories: ["Algorithms", "Parallel computing", "Pointers (computer programming)"]
related: ["[[Broadcast (parallel pattern)]]", "[[Collective operation]]", "[[Communication-avoiding algorithm]]", "[[ABIT BP6]]", "[[Adaptive algorithm]]", "[[Advanced Synchronization Facility]]", "[[Aiyara cluster]]", "[[Alewife (multiprocessor)]]", "[[Algorism]]", "[[Algorithm]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Pointer_jumping