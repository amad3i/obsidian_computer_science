...
wikipedia_categories: ["Distributed data storage", "Distributed data structures", "File sharing", "Hash-based data structures", "Hashing", "Network architecture"]
related: ["[[Darknet]]", "[[EncroChat]]", "[[InterPlanetary File System]]", "[[Tor (network)]]", "[[Anonymous remailer]]", "[[Application Defined Network]]", "[[Application delivery network]]", "[[Asynchronous system]]", "[[Backhaul (telecommunications)]]", "[[Client–server model]]"]
---
...
In 2001, four systems—CAN, Chord, Pastry, and Tapestry—brought attention to DHTs. 
