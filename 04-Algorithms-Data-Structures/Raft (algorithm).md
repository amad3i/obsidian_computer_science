...
wikipedia_categories: ["Distributed algorithms", "Fault-tolerant computer systems"]
related: ["[[Paxos (computer science)]]", "[[SWIM Protocol]]", "[[Availability zone]]", "[[Bully algorithm]]", "[[Byzantine fault]]", "[[Commitment ordering]]", "[[Computer cluster]]", "[[Consensus (computer science)]]", "[[Data redundancy]]", "[[Error-tolerant design]]"]
---
