...
wikipedia_categories: ["1962 in computing", "Amortized data structures", "Binary trees", "Search trees", "Soviet inventions"]
related: ["[[Red–black tree]]", "[[Binary search tree]]", "[[Address programming language]]", "[[Binary space partitioning]]", "[[Binary tree]]", "[[Disjoint-set data structure]]", "[[Group method of data handling]]", "[[Military robot]]", "[[Search tree]]"]
---
