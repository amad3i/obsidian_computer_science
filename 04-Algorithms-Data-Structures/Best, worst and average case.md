...
level: advanced
source: "https://en.wikipedia.org/wiki/Best,_worst_and_average_case"
wikipedia_categories: ["Analysis of algorithms", "Computational complexity theory"]
related: ["[[Analysis of algorithms]]", "[[Combinatorial search]]", "[[Computational complexity]]", "[[Half-exponential function]]", "[[Klee–Minty cube]]", "[[Pseudo-polynomial time]]", "[[Quasi-polynomial time]]", "[[Smoothed analysis]]", "[[Time complexity]]", "[[Aanderaa–Karp–Rosenberg conjecture]]"]
---
