...
level: advanced
source: "https://en.wikipedia.org/wiki/Complexity_class"
wikipedia_categories: ["Complexity classes", "Computational complexity theory", "Measures of complexity", "Theoretical computer science"]
related: ["[[Combinatorial optimization]]", "[[Effective complexity]]", "[[Glossary of quantum computing]]", "[[Kolmogorov complexity]]", "[[Logical depth]]", "[[Pseudo-polynomial time]]", "[[Pseudo-polynomial transformation]]", "[[Quantum capacity]]", "[[Quantum complexity theory]]", "[[Quantum computing]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Complexity_class