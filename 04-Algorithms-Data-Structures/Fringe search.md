...
level: intermediate
source: "https://en.wikipedia.org/wiki/Fringe_search"
wikipedia_categories: ["Graph algorithms", "Search algorithms"]
related: ["[[A- search algorithm]]", "[[Alpha–beta pruning]]", "[[B-]]", "[[Bidirectional search]]", "[[Breadth-first search]]", "[[Contraction hierarchies]]", "[[D-]]", "[[Depth-first search]]", "[[Dijkstra's algorithm]]", "[[Iterative deepening A-]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Fringe_search