...
level: advanced
source: "https://en.wikipedia.org/wiki/Primitive_recursive_function"
wikipedia_categories: ["Computability theory", "Functions and mappings", "Recursion", "Theory of computation"]
related: ["[[Primitive recursive set function]]", "[[Recursive language]]", "[[Ackermann function]]", "[[Admissible numbering]]", "[[Busy beaver]]", "[[Chain rule for Kolmogorov complexity]]", "[[Church–Turing thesis]]", "[[Church–Turing–Deutsch principle]]", "[[Computability]]", "[[Computable function]]"]
---
