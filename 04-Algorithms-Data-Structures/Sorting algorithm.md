...
wikipedia_categories: ["Data processing", "Sorting algorithms"]
related: ["[[Sorting]]", "[[Block swap algorithms]]", "[[CSPro]]", "[[Data analysis]]", "[[Data sonification]]", "[[Epitome (data processing)]]", "[[Inversion (discrete mathematics)]]", "[[Lambda architecture]]", "[[Least-squares spectral analysis]]", "[[MUMPS]]"]
---
...
AHNR algorithm, an integer sorting algorithm which runs in 
...
In Algorithms and Data Structures Niklaus Wirth gives a comparison of the running time of several of the popular algorithms on the Lilith computer.
