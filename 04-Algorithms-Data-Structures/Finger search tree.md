---
title: "Finger search tree"
tags: ["cs", "algorithms-data-structures", "intermediate"]
domain: Algorithms & Data Structures
level: intermediate
source: "https://en.wikipedia.org/wiki/Finger_search_tree"
wikipedia_categories: ["Algorithms and data structures stubs", "Search algorithms", "Trees (data structures)"]
related: ["[[(1+ε)-approximate nearest neighbor search]]", "[[Best bin first]]", "[[Expectiminimax]]", "[[Finger search]]", "[[Rapidly exploring dense trees]]", "[[Ternary search tree]]", "[[A- search algorithm]]", "[[Abstract syntax tree]]", "[[All nearest smaller values]]", "[[Almeida–Pineda recurrent backpropagation]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Finger_search_tree