...
wikipedia_categories: ["Application programming interfaces", "Technical communication"]
related: ["[[AgcXML]]", "[[Altitude3.Net]]", "[[Analyzed Layout and Text Object]]", "[[Application binary interface]]", "[[Asset Description Metadata Schema]]", "[[Binary Application Markup Language]]", "[[BuildingSMART Data Dictionary]]", "[[Busdma]]", "[[C3D Toolkit]]", "[[CEN-XFS]]"]
---
