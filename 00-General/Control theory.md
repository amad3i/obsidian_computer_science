...
wikipedia_categories: ["Computer engineering", "Control engineering", "Control theory"]
related: ["[[Ackermann's formula]]", "[[American Automatic Control Council]]", "[[Control reconfiguration]]", "[[Control system]]", "[[Data-driven control system]]", "[[Hall circles]]", "[[Hierarchical control system]]", "[[Masreliez's theorem]]", "[[Networked control system]]", "[[RISE controllers]]"]
---
