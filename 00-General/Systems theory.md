...
wikipedia_categories: ["Complex systems theory", "Emergence", "Interdisciplinary subfields of sociology", "Systems science", "Systems theory"]
related: ["[[Systems chemistry]]", "[[Complex network]]", "[[Credibility thesis]]", "[[Decentralised system]]", "[[Experimental system]]", "[[Growth and underinvestment]]", "[[High- and low-level]]", "[[Holism in science]]", "[[Personalized medicine]]", "[[Singularity (systems theory)]]"]
---
