---
title: "Run-time infrastructure (simulation)"
tags: ["cs", "general-cs", "intermediate"]
domain: General CS
level: intermediate
source: "https://en.wikipedia.org/wiki/Run-time_infrastructure_(simulation)"
wikipedia_categories: ["Middleware", "Simulation software", "Software type stubs"]
related: ["[[Fan-out (software)]]", "[[Integrated Middleware Platform]]", "[[Object request broker]]", "[[Accelerator table]]", "[[ActiveVOS]]", "[[Adaptive sampling]]", "[[Advanced disaster management simulator]]", "[[Advanced Message Queuing Protocol]]", "[[Advanced Resource Connector]]", "[[AgentSheets]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Run-time_infrastructure_(simulation)