...
related: ["[[Active object]]", "[[Balking pattern]]", "[[Barrier (computer science)]]", "[[Concurrency pattern]]", "[[Concurrency semantics]]", "[[Construction and Analysis of Distributed Processes]]", "[[E-LOTOS]]", "[[Hennessy–Milner logic]]", "[[History monoid]]", "[[Kim Guldstrand Larsen]]"]
---
