...
domain: General CS
level: intermediate
source: "https://en.wikipedia.org/wiki/Computational_logic"
wikipedia_categories: ["Computational fields of study", "Logic in computer science"]
related: ["[[1-in-3-SAT]]", "[[Abstract rewriting system]]", "[[ACM Transactions on Computational Logic]]", "[[Adversarial stylometry]]", "[[Agent verification]]", "[[Agentive logic]]", "[[Algebraic semantics (computer science)]]", "[[Alternating-time temporal logic]]", "[[Artificial intelligence]]", "[[Artificial intelligence content detection]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Computational_logic