...
wikipedia_categories: ["Computer science", "Formal sciences"]
related: ["[[Agnostic (data)]]", "[[Analytics]]", "[[Artificial intelligence]]", "[[Artificial intelligence content detection]]", "[[Artificial wisdom]]", "[[Boolean]]", "[[Catalytic computing]]", "[[Computational gastronomy]]", "[[Computer Science and Engineering Building (UC San Diego)]]", "[[Computer science in sport]]"]
---
