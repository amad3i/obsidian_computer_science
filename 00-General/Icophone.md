...
domain: General CS
level: intermediate
source: "https://en.wikipedia.org/wiki/Icophone"
wikipedia_categories: ["Acoustics"]
related: ["[[Acoustic wayfinding]]", "[[Dereverberation]]", "[[Digital room correction]]", "[[Equivalent rectangular bandwidth]]", "[[Fourier analysis]]", "[[Geophysical MASINT]]", "[[Head-related transfer function]]", "[[Low-pass filter]]", "[[Pure tone]]", "[[Spectrum analyzer]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Icophone