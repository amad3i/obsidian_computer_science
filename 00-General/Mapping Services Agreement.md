---
title: "Mapping Services Agreement"
tags: ["cs", "general-cs", "intermediate"]
domain: General CS
level: intermediate
source: "https://en.wikipedia.org/wiki/Mapping_Services_Agreement"
wikipedia_categories: ["Geographic information systems", "Geography of the United Kingdom", "Law of the United Kingdom"]
related: ["[[3D structure change detection]]", "[[Address geocoding]]", "[[AM-FM-GIS]]", "[[Android Team Awareness Kit]]", "[[Automatic label placement]]", "[[Book of Roads and Kingdoms]]", "[[Buffer analysis]]", "[[Canada Geographic Information System]]", "[[Cartographic generalization]]", "[[Change detection (GIS)]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Mapping_Services_Agreement