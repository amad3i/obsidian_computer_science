...
domain: General CS
level: intermediate
source: "https://en.wikipedia.org/wiki/Communication"
wikipedia_categories: ["Communication", "Main topic articles", "Society"]
related: ["[[Information]]", "[[Academic discipline]]", "[[Communication source]]", "[[Engineering]]", "[[Log-rank conjecture]]", "[[Mathematics]]", "[[Recording format]]", "[[Science]]", "[[Shannon–Weaver model]]", "[[Tangible symbol systems]]"]
---
