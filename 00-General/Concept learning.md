...
domain: General CS
level: intermediate
source: "https://en.wikipedia.org/wiki/Concept_learning"
wikipedia_categories: ["Cognitive psychology", "Educational psychology", "Learning theory (education)"]
related: ["[[Problem solving]]", "[[4E cognition]]", "[[Algorithmic learning theory]]", "[[Bongard problem]]", "[[Cognitive complexity]]", "[[Cognitive philology]]", "[[Enactive interfaces]]", "[[Enactivism]]", "[[Ideal tasks]]", "[[Inclusion (education)]]"]
---
