---
title: "3D structure change detection"
tags: ["cs", "general-cs", "intermediate"]
domain: General CS
level: intermediate
source: "https://en.wikipedia.org/wiki/3D_structure_change_detection"
wikipedia_categories: ["Change detection", "Geographic information systems", "Geography stubs", "Topography techniques"]
related: ["[[Change detection (GIS)]]", "[[Address geocoding]]", "[[AM-FM-GIS]]", "[[Android Team Awareness Kit]]", "[[Automatic label placement]]", "[[Book of Roads and Kingdoms]]", "[[Buffer analysis]]", "[[Canada Geographic Information System]]", "[[Cartographic generalization]]", "[[Conservation Geoportal]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/3D_structure_change_detection