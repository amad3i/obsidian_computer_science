...
domain: General CS
level: intermediate
source: "https://en.wikipedia.org/wiki/Catastrophe_theory"
wikipedia_categories: ["Bifurcation theory", "Chaos theory", "Singularity theory", "Systems theory"]
related: ["[[Hilbert–Arnold problem]]", "[[Singularity (systems theory)]]", "[[Active and passive transformation]]", "[[Activity cycle diagram]]", "[[Allopoiesis]]", "[[Anticausal system]]", "[[Antifragility]]", "[[Autopoiesis]]", "[[Behavioral modeling]]", "[[Biomatrix systems theory]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Catastrophe_theory