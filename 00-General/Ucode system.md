...
domain: General CS
level: intermediate
source: "https://en.wikipedia.org/wiki/Ucode_system"
wikipedia_categories: ["Digital technology", "Information systems"]
related: ["[[Accounting information system]]", "[[ADMAR]]", "[[Alma (library platform)]]", "[[Aptum Technologies]]", "[[Archives management]]", "[[Association for Information Systems]]", "[[Automated decision-making]]", "[[Big bang adoption]]", "[[Bridge management system]]", "[[Business informatics]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Ucode_system