...
wikipedia_categories: ["Formal sciences", "Logic"]
related: ["[[Analytics]]", "[[Artificial intelligence]]", "[[Artificial intelligence content detection]]", "[[Artificial wisdom]]", "[[Belief revision]]", "[[Boolean network]]", "[[Computer science]]", "[[Confrontation analysis]]", "[[Cryptography]]", "[[Data mining]]"]
---
