...
domain: General CS
level: intermediate
source: "https://en.wikipedia.org/wiki/Sales"
wikipedia_categories: ["Business processes", "Business terms", "Distribution (marketing)", "Sales", "Sales occupations"]
related: ["[[Six Sigma]]", "[[Supply chain management]]", "[[Abandonment rate]]", "[[Affinity diagram]]", "[[Archives management]]", "[[Business analyst]]", "[[Business architecture]]", "[[Business ecosystem]]", "[[Business logic]]", "[[Business process automation]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Sales