...
domain: General CS
level: intermediate
source: "https://en.wikipedia.org/wiki/Steady_state"
wikipedia_categories: ["Control theory", "Systems theory"]
related: ["[[Anticausal system]]", "[[Control system]]", "[[Cross Gramian]]", "[[Dynamical structure function]]", "[[Gap metric]]", "[[Hybrid system]]", "[[Internal environment]]", "[[Positive systems]]", "[[Sampled data system]]", "[[Transfer function matrix]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Steady_state