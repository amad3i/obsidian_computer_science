...
wikipedia_categories: ["Architectural design", "Architecture"]
related: ["[[Architectural animation]]", "[[Building information modeling]]", "[[BuildingSMART Data Dictionary]]", "[[Design tool]]", "[[Parametric design]]", "[[Sonata (building design software)]]", "[[Toolkits for user innovation]]", "[[Value sensitive design]]"]
---
