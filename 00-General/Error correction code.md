...
wikipedia_categories: ["Error detection and correction"]
related: ["[[Acknowledgement (data networks)]]", "[[Alternant code]]", "[[BCH code]]", "[[Berger code]]", "[[Berlekamp–Welch algorithm]]", "[[Burst error-correcting code]]", "[[Certifying algorithm]]", "[[Coding gain]]", "[[Coding theory]]", "[[Concatenated error correction code]]"]
---
...
Formally, an error-correcting code is given by its (injective) encoding function 
 ...
 (a concatenation of letters) from the alphabet 
...
. The range 
 ...
 is the set of code-words. The capabilities of the code to detect and correct errors can then be understood from the distance 
 ...
 of the code, which is the minimum Hamming distance separating any two distinct code words. A code with distance 
...
lpdec: discontinued library for LP decoding and related things (Python)
