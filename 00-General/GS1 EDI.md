...
domain: General CS
level: intermediate
source: "https://en.wikipedia.org/wiki/GS1_EDI"
wikipedia_categories: ["Electronic data interchange", "GS1 standards", "Markup languages", "Supply chain management", "Technical communication"]
related: ["[[Analyzed Layout and Text Object]]", "[[Component content management system]]", "[[Continuous Acquisition and Life-cycle Support]]", "[[Darwin Information Typing Architecture]]", "[[DITA Open Toolkit]]", "[[DocBook]]", "[[Encoded Archival Description]]", "[[Extensible Forms Description Language]]", "[[HTML]]", "[[ISO 12083]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/GS1_EDI