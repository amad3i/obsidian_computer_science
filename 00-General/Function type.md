...
wikipedia_categories: ["Data types", "Subroutines", "Type theory"]
related: ["[[Abstract data type]]", "[[Algebraic data type]]", "[[Anonymous function]]", "[[Any type]]", "[[Bottom type]]", "[[Composite data type]]", "[[Enumerated type]]", "[[First-class function]]", "[[Flow-sensitive typing]]", "[[Generalized algebraic data type]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Function_type