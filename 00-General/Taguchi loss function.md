...
domain: General CS
level: intermediate
source: "https://en.wikipedia.org/wiki/Taguchi_loss_function"
wikipedia_categories: ["Loss functions"]
related: ["[[Hinge loss]]", "[[Huber loss]]", "[[Loss function]]", "[[Mean squared error]]", "[[Mean squared prediction error]]", "[[Sum of absolute differences]]", "[[Sum of absolute transformed differences]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Taguchi_loss_function