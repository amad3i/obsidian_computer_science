...
level: intermediate
source: "https://en.wikipedia.org/wiki/Quantum_gate_teleportation"
wikipedia_categories: ["Quantum gates", "Quantum information science"]
related: ["[[Controlled NOT gate]]", "[[KLM protocol]]", "[[Linear optical quantum computing]]", "[[Quantum logic gate]]", "[[1QBit]]", "[[Absolutely maximally entangled state]]", "[[Alexander Holevo]]", "[[Algebraic theory of topological quantum information]]", "[[Algorithmic cooling]]", "[[Alice & Bob (company)]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Quantum_gate_teleportation