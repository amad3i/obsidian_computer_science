...
wikipedia_categories: ["Australian inventions", "Quantum computing", "Quantum states", "Teleportation", "Units of information"]
related: ["[[Qudit]]", "[[Quantum teleportation]]", "[[Qutrit]]", "[[Absolutely maximally entangled state]]", "[[Adiabatic quantum computation]]", "[[Algorithmic qubits]]", "[[Andrea Morello]]", "[[Bacon–Shor code]]", "[[Bell diagonal state]]", "[[BQP]]"]
---
...
=== Bloch sphere representation ===
 The probability amplitudes for the superposition state, 
...
, α is changed to 0 and β is changed to 1, while the phase factor 
...
== Further reading ==
Nielsen, Michael A.; Chuang, Isaac (2000). Quantum Computation and Quantum Information. Cambridge, England: Cambridge University Press. ISBN 0-521-63235-8. OCLC 43641333.
...
- Wikipedia: https://en.wikipedia.org/wiki/Qubit