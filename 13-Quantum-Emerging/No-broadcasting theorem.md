...
level: intermediate
source: "https://en.wikipedia.org/wiki/No-broadcasting_theorem"
wikipedia_categories: ["No-go theorems", "Quantum information science", "Theorems in quantum mechanics"]
related: ["[[Bell's theorem]]", "[[No-cloning theorem]]", "[[No-communication theorem]]", "[[No-deleting theorem]]", "[[Pusey–Barrett–Rudolph theorem]]", "[[1QBit]]", "[[Absolutely maximally entangled state]]", "[[Alexander Holevo]]", "[[Algebraic theory of topological quantum information]]", "[[Algorithmic cooling]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/No-broadcasting_theorem