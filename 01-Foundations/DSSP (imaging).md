...
level: intermediate
source: "https://en.wikipedia.org/wiki/DSSP_(imaging)"
wikipedia_categories: ["Digital signal processing", "Electronics stubs"]
related: ["[[Channelizer]]", "[[Differential nonlinearity]]", "[[Integral nonlinearity]]", "[[Lapped transform]]", "[[Spurious-free dynamic range]]", "[[2D adaptive filters]]", "[[2D Z-transform]]", "[[Adaptive equalizer]]", "[[Adaptive filter]]", "[[Adaptive predictive coding]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/DSSP_(imaging)