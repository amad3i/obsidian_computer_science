...
wikipedia_categories: ["1847 introductions", "Algebraic logic", "Boolean algebra"]
related: ["[[Relation algebra]]", "[[Residuated Boolean algebra]]", "[[1-in-3-SAT]]", "[[Action algebra]]", "[[Analysis of Boolean functions]]", "[[AND gate]]", "[[Bent function]]", "[[Binary decision diagram]]", "[[Bitwise ternary logic instruction]]", "[[Boolean differential calculus]]"]
---
