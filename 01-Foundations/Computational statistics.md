...
level: intermediate
source: "https://en.wikipedia.org/wiki/Computational_statistics"
wikipedia_categories: ["Computational fields of study", "Computational statistics", "Mathematics of computing", "Numerical analysis"]
related: ["[[Artificial precision]]", "[[Least-squares spectral analysis]]", "[[2Sum]]", "[[Abramowitz and Stegun]]", "[[Actor model theory]]", "[[Adaptive step size]]", "[[Adjoint state method]]", "[[Adversarial stylometry]]", "[[Affine arithmetic]]", "[[Applied element method]]"]
---
