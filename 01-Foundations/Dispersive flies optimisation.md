...
level: intermediate
source: "https://en.wikipedia.org/wiki/Dispersive_flies_optimisation"
wikipedia_categories: ["Evolutionary algorithms", "Mathematical optimization", "Nature-inspired metaheuristics"]
related: ["[[Cultural algorithm]]", "[[Fly algorithm]]", "[[FunSearch]]", "[[Algorithmic problems on convex sets]]", "[[Analysis of Boolean functions]]", "[[Ant colony optimization algorithms]]", "[[Artificial bee colony algorithm]]", "[[Artificial development]]", "[[Backtracking line search]]", "[[Barzilai–Borwein method]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Dispersive_flies_optimisation