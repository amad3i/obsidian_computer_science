...
level: intermediate
source: "https://en.wikipedia.org/wiki/Digital_filter"
wikipedia_categories: ["Digital signal processing", "Signal processing filter", "Synthesiser modules"]
related: ["[[Filter design]]", "[[2D adaptive filters]]", "[[2D Z-transform]]", "[[Adaptive equalizer]]", "[[Adaptive filter]]", "[[Adaptive predictive coding]]", "[[Adaptive-additive algorithm]]", "[[Adjoint filter]]", "[[Advanced process control]]", "[[Aliasing]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Digital_filter