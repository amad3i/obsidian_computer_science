...
wikipedia_categories: ["Curve fitting", "Estimation theory", "Parametric statistics", "Single-equation methods (econometrics)"]
related: ["[[Least-angle regression]]", "[[Multi-attribute global inference of quality]]", "[[Data assimilation]]", "[[Estimation]]", "[[Estimation theory]]", "[[Fisher information]]", "[[Formation matrix]]", "[[Generalized pencil-of-function method]]", "[[Kullback's inequality]]", "[[Matrix regularization]]"]
---
