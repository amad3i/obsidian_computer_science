...
wikipedia_categories: ["1970s software", "Aerospace engineering software", "Array programming languages", "Computer-related introductions in the 1970s", "Computer algebra system software for Linux", "Computer algebra system software for Windows", "Computer algebra system software for macOS", "Computer algebra systems"]
related: ["[[Maple (software)]]", "[[Wolfram Mathematica]]", "[[Mathcad]]", "[[Analytica (software)]]", "[[Wolfram Language]]", "[[A+ (programming language)]]", "[[AMPL]]", "[[APL (programming language)]]", "[[Array programming]]", "[[Boundary representation]]"]
---
