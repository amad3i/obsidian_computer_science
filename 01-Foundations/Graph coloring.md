...
wikipedia_categories: ["Computational problems in graph theory", "Extensions and generalizations of graphs", "Graph coloring", "Graph theory", "NP-complete problems", "NP-hard problems"]
related: ["[[Travelling salesman problem]]", "[[Fractional dominating set]]", "[[Graph edit distance]]", "[[Graph homomorphism]]", "[[Homeomorphism (graph theory)]]", "[[Rainbow-independent set]]", "[[Subgraph isomorphism problem]]", "[[Substructure search]]", "[[Uniconnected subgraph]]", "[[Wiener connector]]"]
---
