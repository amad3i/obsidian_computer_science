...
level: intermediate
source: "https://en.wikipedia.org/wiki/Algorithmic_information_theory"
wikipedia_categories: ["Algorithmic information theory", "Information theory", "Randomized algorithms"]
related: ["[[Linear partial information]]", "[[Chain rule for Kolmogorov complexity]]", "[[Kolmogorov complexity]]", "[[3G MIMO]]", "[[A Mathematical Theory of Communication]]", "[[A Symbolic Analysis of Relay and Switching Circuits]]", "[[Adjusted mutual information]]", "[[Algorithmic probability]]", "[[Ascendency]]", "[[Asymptotic equipartition property]]"]
---
