...
wikipedia_categories: ["Classification algorithms", "Convex optimization", "Kernel methods for machine learning", "Machine learning algorithms", "Statistical classification", "Support vector machines"]
related: ["[[K-nearest neighbors algorithm]]", "[[AdaBoost]]", "[[Calibration (statistics)]]", "[[Co-training]]", "[[Decision boundary]]", "[[Decision tree learning]]", "[[Hyper basis function network]]", "[[IDistance]]", "[[Kernel methods for vector output]]", "[[Kernel perceptron]]"]
---
