...
wikipedia_categories: ["Combinatorics on words", "Formal languages"]
related: ["[[Autocorrelation (words)]]", "[[Compact semigroup]]", "[[Critical exponent of a word]]", "[[Formal language]]", "[[Free monoid]]", "[[Grammar systems theory]]", "[[Hall word]]", "[[Local language (formal language)]]", "[[Locally catenative sequence]]", "[[Morphic word]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Alphabet_(formal_languages)