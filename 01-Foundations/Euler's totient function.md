...
wikipedia_categories: ["Algebra", "Leonhard Euler", "Modular arithmetic", "Multiplicative functions", "Number theory"]
related: ["[[Automorphic number]]", "[[AWM–Microsoft Research Prize in Algebra and Number Theory]]", "[[Cole Prize]]", "[[Cyclotomic polynomial]]", "[[Digital root]]", "[[Euler function]]", "[[Hundred Fowls Problem]]", "[[Multiplicative digital root]]", "[[Multiplicative function]]", "[[Proofs of Fermat's little theorem]]"]
---
