...
wikipedia_categories: ["Decision analysis", "Management systems", "Mathematical optimization", "Multiple-criteria decision analysis", "Utility"]
related: ["[[Ordinal priority approach]]", "[[TOPSIS]]", "[[Multi-attribute global inference of quality]]", "[[Multi-objective optimization]]", "[[Multicriteria classification]]", "[[Stochastic multicriteria acceptability analysis]]", "[[ÉLECTRE]]", "[[Corner solution]]", "[[Goal programming]]", "[[Superiority and inferiority ranking method]]"]
---
