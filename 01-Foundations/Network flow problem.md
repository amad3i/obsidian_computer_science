...
wikipedia_categories: ["Combinatorial optimization", "Directed graphs", "Graph algorithms", "Network flow problem", "Set index articles"]
related: ["[[Gomory–Hu tree]]", "[[A- search algorithm]]", "[[B-]]", "[[Bottleneck traveling salesman problem]]", "[[Capacitated arc routing problem]]", "[[Closure problem]]", "[[Dijkstra's algorithm]]", "[[Dinic's algorithm]]", "[[Edmonds–Karp algorithm]]", "[[Ford–Fulkerson algorithm]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Network_flow_problem