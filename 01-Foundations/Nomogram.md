...
level: intermediate
source: "https://en.wikipedia.org/wiki/Nomogram"
wikipedia_categories: ["Analog computers", "Charts", "Diagrams", "Mathematical tools", "Theory of computation"]
related: ["[[Shadow square]]", "[[State diagram]]", "[[Ackermann function]]", "[[Activity cycle diagram]]", "[[Admissible numbering]]", "[[Analog-to-digital converter]]", "[[And-inverter graph]]", "[[Andreas Brandstädt]]", "[[Antikythera mechanism]]", "[[Associative entity]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Nomogram