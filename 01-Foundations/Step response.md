...
level: intermediate
source: "https://en.wikipedia.org/wiki/Step_response"
wikipedia_categories: ["Analog circuits", "Classical control theory", "Dynamical systems", "Electronic amplifiers", "Electronic design", "Signal processing", "Transient response characteristics"]
related: ["[[Asymptotic gain model]]", "[[Bode plot]]", "[[Norator]]", "[[Nullator]]", "[[Nullor]]", "[[Phase margin]]", "[[Blackman's theorem]]", "[[Causal system]]", "[[Field-programmable analog array]]", "[[Linear time-invariant system]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Step_response