---
title: "Lapped transform"
tags: ["cs", "foundations-math", "intermediate"]
domain: Foundations & Math
level: intermediate
source: "https://en.wikipedia.org/wiki/Lapped_transform"
wikipedia_categories: ["Data compression", "Digital signal processing", "Discrete transforms", "Electronics stubs", "Linear algebra", "Linear algebra stubs"]
related: ["[[Discrete cosine transform]]", "[[Asymmetric norm]]", "[[Channelizer]]", "[[Codec]]", "[[Delta modulation]]", "[[Differential nonlinearity]]", "[[Discrete Fourier transform]]", "[[Discrete wavelet transform]]", "[[DSSP (imaging)]]", "[[Eigengap]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Lapped_transform