...
wikipedia_categories: ["Algorithmic information theory", "Andrey Kolmogorov", "Computability theory", "Computational complexity theory", "Data compression", "Descriptive complexity", "Information theory", "Measures of complexity"]
related: ["[[Chain rule for Kolmogorov complexity]]", "[[Effective complexity]]", "[[Lempel–Ziv complexity]]", "[[Logical depth]]", "[[Algorithmic information theory]]", "[[Communication complexity]]", "[[Complexity class]]", "[[Descriptive complexity theory]]", "[[Entropy (information theory)]]", "[[Error exponent]]"]
---
