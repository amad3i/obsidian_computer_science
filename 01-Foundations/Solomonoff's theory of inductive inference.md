...
level: intermediate
source: "https://en.wikipedia.org/wiki/Solomonoff's_theory_of_inductive_inference"
wikipedia_categories: ["Algorithmic information theory", "Bayesian statistics", "Epistemology", "Inductive reasoning", "Machine learning", "Statistical inference"]
related: ["[[Abductive reasoning]]", "[[Base rate]]", "[[Bayesian interpretation of kernel regularization]]", "[[Bayesian regret]]", "[[Bayesian structural time series]]", "[[Expectation propagation]]", "[[Inductive probability]]", "[[Overfitting]]", "[[Rule induction]]", "[[80 Million Tiny Images]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Solomonoff's_theory_of_inductive_inference