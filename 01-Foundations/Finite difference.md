...
wikipedia_categories: ["Factorial and binomial topics", "Finite differences", "Linear operators in calculus", "Mathematical analysis", "Numerical analysis", "Numerical differential equations"]
related: ["[[Discrete calculus]]", "[[Adaptive step size]]", "[[Bernoulli umbra]]", "[[Bi-directional delay line]]", "[[Boundary knot method]]", "[[Boundary particle method]]", "[[Composite methods for structural dynamics]]", "[[Deep backward stochastic differential equation method]]", "[[Discrete Laplace operator]]", "[[Dormand–Prince method]]"]
---
...
The difference operator, commonly denoted 
 ...
 (uppercase Delta), is the operator that maps a function f to the function 
