...
wikipedia_categories: ["Chess terminology", "Game artificial intelligence", "Game theory"]
related: ["[[Nolot]]", "[[Zugzwang]]", "[[A- search algorithm]]", "[[Alpha–beta pruning]]", "[[Ambiguity aversion]]", "[[Analytic narrative]]", "[[Artificial intelligence in video games]]", "[[Asynchrony (game theory)]]", "[[Aumann's agreement theorem]]", "[[Authority distribution]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Ply_(game_theory)