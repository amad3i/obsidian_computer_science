...
level: intermediate
source: "https://en.wikipedia.org/wiki/Automated_essay_scoring"
wikipedia_categories: ["Computational linguistics", "Educational evaluation methods", "Essays", "Natural language processing", "Statistical classification", "Tasks of natural language processing"]
related: ["[[Automatic summarization]]", "[[Language identification]]", "[[Open information extraction]]", "[[Stemming]]", "[[Text simplification]]", "[[ACL Data Collection Initiative]]", "[[Adversarial stylometry]]", "[[Aggregation (linguistics)]]", "[[Arabic Ontology]]", "[[Artificial intelligence content detection]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Automated_essay_scoring