...
wikipedia_categories: ["Approximation theory", "Numerical analysis"]
related: ["[[Method of dominant balance]]", "[[Modulus of smoothness]]", "[[Radial basis function interpolation]]", "[[Remez algorithm]]", "[[Semi-infinite programming]]", "[[Unisolvent functions]]", "[[Whitney inequality]]", "[[2Sum]]", "[[Abramowitz and Stegun]]", "[[Adaptive step size]]"]
---
