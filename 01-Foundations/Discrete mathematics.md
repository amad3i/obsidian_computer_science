...
wikipedia_categories: ["Discrete mathematics"]
related: ["[[A. W. Faber Model 366]]", "[[Antimatroid]]", "[[Cubicity]]", "[[Cutting sequence]]", "[[DIMACS]]", "[[Direction-preserving function]]", "[[Discrete calculus]]", "[[Discrete fixed-point theorem]]", "[[Discrete Mathematics (journal)]]", "[[Erdős Lectures]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Discrete_mathematics