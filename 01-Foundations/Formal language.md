...
wikipedia_categories: ["Combinatorics on words", "Formal languages", "Mathematical linguistics", "Theoretical computer science"]
related: ["[[Grammar systems theory]]", "[[Alphabet (formal languages)]]", "[[Autocorrelation (words)]]", "[[Categorial grammar]]", "[[Compact semigroup]]", "[[Critical exponent of a word]]", "[[Formal grammar]]", "[[Free monoid]]", "[[Hall word]]", "[[Language-Theoretic Security]]"]
---
...
, where 
 ...
 is the set of all possible finite-length words over 
...
== External links ==
"Formal language", Encyclopedia of Mathematics, EMS Press, 2001 
University of Maryland, Formal Language Definitions Archived 16 February 2008 at the Wayback Machine
