...
wikipedia_categories: ["Quantum information theory"]
related: ["[[Classical shadow]]", "[[Parity measurement]]", "[[Path integral Monte Carlo]]", "[[Quantum capacity]]", "[[Quantum Computing Since Democritus]]", "[[Quantum state discrimination]]", "[[Quantum t-design]]", "[[Schmidt decomposition]]", "[[Solovay–Kitaev theorem]]"]
---
