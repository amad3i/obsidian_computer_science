...
level: intermediate
source: "https://en.wikipedia.org/wiki/Causal_system"
wikipedia_categories: ["Causality", "Classical control theory", "Digital signal processing", "Dynamical systems", "Systems theory"]
related: ["[[Strejc method]]", "[[System identification]]", "[[Anticausal system]]", "[[Behavioral modeling]]", "[[Bistritz stability criterion]]", "[[Black box model of power converter]]", "[[Cellular automaton]]", "[[Dynamical system]]", "[[Escalation archetype]]", "[[Hilbert–Arnold problem]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Causal_system