...
level: intermediate
source: "https://en.wikipedia.org/wiki/Nearest_neighbor_search"
wikipedia_categories: ["Approximation algorithms", "Classification algorithms", "Data mining", "Discrete geometry", "Geometric algorithms", "Mathematical optimization", "Probabilistic data structures", "Search algorithms"]
related: ["[[(1+ε)-approximate nearest neighbor search]]", "[[Locality-sensitive hashing]]", "[[Geometric median]]", "[[Hierarchical navigable small world]]", "[[K-nearest neighbors algorithm]]", "[[Multifactor dimensionality reduction]]", "[[Rapidly exploring random tree]]", "[[Vertex enumeration problem]]", "[[Wiener connector]]", "[[A- search algorithm]]"]
---
