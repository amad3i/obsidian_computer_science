...
level: advanced
source: "https://en.wikipedia.org/wiki/Process_performance_qualification_protocol"
wikipedia_categories: ["Business process management", "Drug manufacturing", "Enterprise modelling", "Formal methods", "Validity (statistics)"]
related: ["[[Business process validation]]", "[[Critical process parameters]]", "[[Process qualification]]", "[[Process validation]]", "[[Continued process verification]]", "[[Design space verification]]", "[[1-in-3-SAT]]", "[[Abstract state machine]]", "[[ADOIT]]", "[[Agent verification]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Process_performance_qualification_protocol