...
wikipedia_categories: ["Information theory", "Theorems in statistics"]
related: ["[[Shannon–Hartley theorem]]", "[[3G MIMO]]", "[[A Mathematical Theory of Communication]]", "[[A Symbolic Analysis of Relay and Switching Circuits]]", "[[Adjusted mutual information]]", "[[Algorithmic information theory]]", "[[Ascendency]]", "[[Aumann's agreement theorem]]", "[[Bandwidth (computing)]]", "[[Bandwidth extension]]"]
---
