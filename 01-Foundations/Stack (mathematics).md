---
title: "Stack (mathematics)"
tags: ["cs", "foundations-math", "advanced"]
domain: Foundations & Math
level: advanced
source: "https://en.wikipedia.org/wiki/Stack_(mathematics)"
wikipedia_categories: ["Algebraic geometry", "Category theory", "Stacks (mathematics)"]
related: ["[[Cotangent complex]]", "[[Descent (mathematics)]]", "[[Esquisse d'un Programme]]", "[[Grothendieck's Galois theory]]", "[[Groupoid object]]", "[[2-Yoneda lemma]]", "[[3-category]]", "[[AB5 category]]", "[[Abstract elementary class]]", "[[Abstract nonsense]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Stack_(mathematics)