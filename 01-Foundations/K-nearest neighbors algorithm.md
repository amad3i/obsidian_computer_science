...
wikipedia_categories: ["Classification algorithms", "Machine learning algorithms", "Nonparametric statistics", "Search algorithms", "Statistical classification"]
related: ["[[Support vector machine]]", "[[Variable kernel density estimation]]", "[[(1+ε)-approximate nearest neighbor search]]", "[[AdaBoost]]", "[[Calibration (statistics)]]", "[[Co-training]]", "[[Decision boundary]]", "[[Decision tree learning]]", "[[Hyper basis function network]]", "[[IDistance]]"]
---
