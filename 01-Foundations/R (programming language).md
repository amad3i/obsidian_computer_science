...
wikipedia_categories: ["Array programming languages", "Cross-platform free software", "Data-centric programming languages", "Data mining and machine learning software", "Dynamically typed programming languages", "Free plotting software", "Free statistical software", "Functional languages"]
related: ["[[Renjin]]", "[[Julia (programming language)]]", "[[MATLAB]]", "[[Programming with Big Data in R]]", "[[APL (programming language)]]", "[[Ciao (programming language)]]", "[[Clojure]]", "[[Erlang (programming language)]]", "[[J (programming language)]]", "[[K (programming language)]]"]
---
