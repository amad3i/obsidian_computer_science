...
wikipedia_categories: ["Basic concepts in set theory", "Factorial and binomial topics"]
related: ["[[Bernoulli umbra]]", "[[Bhargava factorial]]", "[[Binomial coefficient]]", "[[Combinatorial number system]]", "[[Factorial]]", "[[Factorial number system]]", "[[Finite difference]]", "[[Indicator function]]", "[[Inhabited set]]", "[[Kernel (set theory)]]"]
---
