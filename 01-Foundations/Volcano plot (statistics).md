...
related: ["[[Dot plot (bioinformatics)]]", "[[Dual-flashlight plot]]", "[[Sequence logo]]", "[[100,000 Genomes Project]]", "[[1000 Genomes Project]]", "[[3D-Jury]]", "[[ABCD Schema]]", "[[Accession number (bioinformatics)]]", "[[Actino-ugpB RNA motif]]", "[[Adaptive sampling]]"]
---
...
Its x value can be the logarithm of the odds ratio and its y value can be -log10 of the p value from a Chi-square test or a Chi-square test statistic.
Volcano plots show a characteristic upwards two arm shape because the x axis, i.e. the underlying log2-fold changes, are generally normal distributed whereas the y axis, the log10-p values, tend toward greater significance for fold-changes that deviate more strongly from zero.
...
which is a parabola whose arms reach upwards on the right and left sides.
...
- Wikipedia: https://en.wikipedia.org/wiki/Volcano_plot_(statistics)