...
level: intermediate
source: "https://en.wikipedia.org/wiki/Digital_signal_controller"
wikipedia_categories: ["Digital signal processing", "Digital signal processors", "Integrated circuits", "Microcontrollers"]
related: ["[[Digital signal processor]]", "[[Media processor]]", "[[Multidimensional DSP with GPU acceleration]]", "[[PLL multibit]]", "[[Sensor hub]]", "[[2D adaptive filters]]", "[[2D Z-transform]]", "[[Adaptive equalizer]]", "[[Adaptive filter]]", "[[Adaptive predictive coding]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Digital_signal_controller