...
level: intermediate
source: "https://en.wikipedia.org/wiki/Free_monoid"
wikipedia_categories: ["Combinatorics on words", "Formal languages", "Free algebraic structures", "Semigroup theory"]
related: ["[[History monoid]]", "[[Local language (formal language)]]", "[[Morphic word]]", "[[Recurrent word]]", "[[Sesquipower]]", "[[Splicing language]]", "[[Trace monoid]]", "[[Unavoidable pattern]]", "[[Alphabet (formal languages)]]", "[[Autocorrelation (words)]]"]
---
