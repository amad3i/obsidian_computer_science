...
level: intermediate
source: "https://en.wikipedia.org/wiki/Comb_generator"
wikipedia_categories: ["Electronic test equipment", "Laboratory equipment", "Signal processing", "Terahertz technology"]
related: ["[[Digital storage oscilloscope]]", "[[Fibre multi-object spectrograph]]", "[[Optical spectrometer]]", "[[Radio-frequency sweep]]", "[[Scanning mobility particle sizer]]", "[[Spectrum analyzer]]", "[[Signal analyzer]]", "[[Vector signal analyzer]]", "[[Video line selector]]", "[[Adaptive beamformer]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Comb_generator