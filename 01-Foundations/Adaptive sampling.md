...
level: intermediate
source: "https://en.wikipedia.org/wiki/Adaptive_sampling"
wikipedia_categories: ["Bioinformatics", "Computational biology", "Computational chemistry", "Hidden Markov models", "Mathematical and theoretical biology", "Molecular modelling", "Simulation software"]
related: ["[[Folding@home]]", "[[List of Folding@home cores]]", "[[Docking (molecular)]]", "[[Molecular modelling]]", "[[Scoring functions for docking]]", "[[Sergey Piletsky]]", "[[SimThyr]]", "[[Statistical potential]]", "[[Accessible surface area]]", "[[AIDA interactive educational freeware diabetes simulator]]"]
---

# Adaptive sampling

Adaptive sampling is an approach to sampling that uses heuristics to provide efficiency. The term adaptive sampling represents a general approach to the problem of sampling, rather than being a special method itself, meaning it can be combined with suitable other approaches/methods.
...
- Wikipedia: https://en.wikipedia.org/wiki/Adaptive_sampling