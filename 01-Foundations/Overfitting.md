...
wikipedia_categories: ["Applied mathematics", "Curve fitting", "Machine learning", "Mathematical modeling", "Statistical inference"]
related: ["[[Game theory on networks]]", "[[Mathematical model]]", "[[PottersWheel]]", "[[Resilience (mathematics)]]", "[[Solomonoff's theory of inductive inference]]", "[[Surrogate model]]", "[[Uncertainty quantification]]", "[[80 Million Tiny Images]]", "[[A Logical Calculus of the Ideas Immanent in Nervous Activity]]", "[[A Symbolic Analysis of Relay and Switching Circuits]]"]
---
