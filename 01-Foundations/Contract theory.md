...
wikipedia_categories: ["Asymmetric information", "Game theory", "Law and economics", "Mathematical economics", "Microeconomic theories"]
related: ["[[Bayesian efficiency]]", "[[Cheap talk]]", "[[Costly state verification]]", "[[Game theory]]", "[[General equilibrium theory]]", "[[Kuhn's theorem]]", "[[Mean-field game theory]]", "[[Median voter theorem]]", "[[Minimum effort game]]", "[[Pareto efficiency]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Contract_theory