...
wikipedia_categories: ["Dynamic programming", "Information theory", "String metrics"]
related: ["[[Gestalt pattern matching]]", "[[Hamming distance]]", "[[3G MIMO]]", "[[A Mathematical Theory of Communication]]", "[[A Symbolic Analysis of Relay and Switching Circuits]]", "[[Adjusted mutual information]]", "[[Algorithmic information theory]]", "[[Ascendency]]", "[[Asymptotic equipartition property]]", "[[Backward induction]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Damerau–Levenshtein_distance