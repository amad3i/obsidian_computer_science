...
wikipedia_categories: ["Mathematical optimization", "Optimal decisions"]
related: ["[[Bayesian efficiency]]", "[[Optimal experimental design]]", "[[Response surface methodology]]", "[[Utility maximization problem]]", "[[Wald's maximin model]]", "[[AIXI]]", "[[Algorithmic problems on convex sets]]", "[[Analysis of Boolean functions]]", "[[Backtracking line search]]", "[[Barzilai–Borwein method]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Feasible_region