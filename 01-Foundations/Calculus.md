...
wikipedia_categories: ["Calculus"]
related: ["[[Discrete calculus]]", "[[Infinitesimal]]", "[[List of mathematical functions]]", "[[List of types of functions]]", "[[Maximum and minimum]]", "[[Periodic function]]", "[[Reduction (mathematics)]]", "[[Ruler function]]", "[[Variable (mathematics)]]"]
---
...
==== India ====
Bhāskara II (c. 1114–1185) was acquainted with some ideas of differential calculus, and devised a way of working with infinitesimals applied to trigonometry.
