...
wikipedia_categories: ["Customer experience", "Formal sciences", "Markov models", "Network performance", "Operations research", "Production planning", "Queueing theory", "Rationing"]
related: ["[[Queuing Rule of Thumb]]", "[[Confrontation analysis]]", "[[Erlang (unit)]]", "[[Layered queueing network]]", "[[Palm–Khintchine theorem]]", "[[4OR]]", "[[Adaptive quality of service multi-hop routing]]", "[[Adversarial queueing network]]", "[[AiScaler]]", "[[ALTQ]]"]
---
...
Also called random order of service (ROS), this discipline states that the next job served is selected at random from the jobs waiting in the queue.
Priority
...
Deitel, Harvey M. (1984) . An introduction to operating systems (revisited first ed.). Addison-Wesley. p. 673. ISBN 978-0-201-14502-1. chap.15, pp. 380–412
