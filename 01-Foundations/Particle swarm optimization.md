...
wikipedia_categories: ["Multi-agent systems", "Nature-inspired metaheuristics", "Optimization algorithms and methods"]
related: ["[[Spiral optimization algorithm]]", "[[Ant colony optimization algorithms]]", "[[Fly algorithm]]", "[[Swarm intelligence]]", "[[Alpha–beta pruning]]", "[[Artificial bee colony algorithm]]", "[[Automatic label placement]]", "[[Backtracking line search]]", "[[Barzilai–Borwein method]]", "[[Bat algorithm]]"]
---
