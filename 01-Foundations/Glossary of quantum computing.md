...
level: advanced
source: "https://en.wikipedia.org/wiki/Glossary_of_quantum_computing"
wikipedia_categories: ["Classes of computers", "Computational complexity theory", "Glossaries of technology", "Information theory", "Models of computation", "Open problems", "Quantum cryptography", "Theoretical computer science"]
related: ["[[Quantum computing]]", "[[Quantum capacity]]", "[[Combinatorial optimization]]", "[[Communication complexity]]", "[[Complexity and Real Computation]]", "[[Complexity class]]", "[[Computational irreducibility]]", "[[Decision tree model]]", "[[Description number]]", "[[Effective complexity]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Glossary_of_quantum_computing