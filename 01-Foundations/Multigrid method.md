...
level: intermediate
source: "https://en.wikipedia.org/wiki/Multigrid_method"
wikipedia_categories: ["Numerical analysis", "Partial differential equations", "Wavelets"]
related: ["[[Bidomain model]]", "[[Calderón projector]]", "[[Discrete wavelet transform]]", "[[Forward problem of electrocardiology]]", "[[Integrable algorithm]]", "[[Partial differential algebraic equation]]", "[[Scale co-occurrence matrix]]", "[[Transfer matrix]]", "[[Well-posed problem]]", "[[2Sum]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Multigrid_method