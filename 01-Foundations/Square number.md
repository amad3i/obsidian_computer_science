...
wikipedia_categories: ["Elementary arithmetic", "Figurate numbers", "Integer sequences", "Integers", "Number theory", "Quadrilaterals", "Squares in number theory"]
related: ["[[Cube (algebra)]]", "[[Eighth power]]", "[[Fifth power (algebra)]]", "[[Fourth power]]", "[[Seventh power]]", "[[Sixth power]]", "[[3x + 1 semigroup]]", "[[Amicable triple]]", "[[Basel problem]]", "[[Bernoulli number]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Square_number