...
level: intermediate
source: "https://en.wikipedia.org/wiki/Wiener_connector"
wikipedia_categories: ["Computational biology", "Computational problems in graph theory", "Data mining", "Geometric algorithms", "Geometric graphs", "Graph algorithms", "Information retrieval", "NP-complete problems"]
related: ["[[Subgraph isomorphism problem]]", "[[Substructure search]]", "[[Travelling salesman problem]]", "[[Argument mining]]", "[[Bottleneck traveling salesman problem]]", "[[Graph coloring]]", "[[Graph edit distance]]", "[[Graph isomorphism problem]]", "[[K shortest path routing]]", "[[Longest path problem]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Wiener_connector