---
title: "Path integral Monte Carlo"
tags: ["cs", "foundations-math", "intermediate"]
domain: Foundations & Math
level: intermediate
source: "https://en.wikipedia.org/wiki/Path_integral_Monte_Carlo"
wikipedia_categories: ["Quantum Monte Carlo", "Quantum algorithms", "Quantum chemistry", "Quantum chemistry stubs", "Quantum information theory"]
related: ["[[Coulomb operator]]", "[[Diffusion Monte Carlo]]", "[[Fermi resonance]]", "[[ONIOM]]", "[[Reaction coordinate]]", "[[Variational Monte Carlo]]", "[[1s Slater-type function]]", "[[Adiabatic connection fluctuation dissipation theorem]]", "[[Aharonov–Jones–Landau algorithm]]", "[[Amplitude amplification]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Path_integral_Monte_Carlo