...
level: intermediate
source: "https://en.wikipedia.org/wiki/Proaftn"
wikipedia_categories: ["Machine learning", "Statistical classification"]
related: ["[[Binary classification]]", "[[Confusion matrix]]", "[[Double descent]]", "[[Evaluation of binary classifiers]]", "[[Leakage (machine learning)]]", "[[Phi coefficient]]", "[[Prior knowledge for pattern recognition]]", "[[Probability matching]]", "[[80 Million Tiny Images]]", "[[A Logical Calculus of the Ideas Immanent in Nervous Activity]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Proaftn