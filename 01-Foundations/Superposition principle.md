...
wikipedia_categories: ["Mathematical physics", "Systems theory", "Waves"]
related: ["[[Active and passive transformation]]", "[[Activity cycle diagram]]", "[[Allopoiesis]]", "[[Anticausal system]]", "[[Antifragility]]", "[[Autopoiesis]]", "[[Baker–Campbell–Hausdorff formula]]", "[[Behavioral modeling]]", "[[Biomatrix systems theory]]", "[[Bistritz stability criterion]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Superposition_principle