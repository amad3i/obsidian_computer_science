...
wikipedia_categories: ["Category theory", "Foundations of mathematics", "Higher category theory"]
related: ["[[Double groupoid]]", "[[Higher-dimensional algebra]]", "[[Pseudomonad (category theory)]]", "[[Tetracategory]]", "[[Timeline of category theory and related mathematics]]", "[[2-Yoneda lemma]]", "[[3-category]]", "[[AB5 category]]", "[[Abstract elementary class]]", "[[Abstract nonsense]]"]
---
...
, called composition of morphisms, such that for any three objects a, b, and c, we have
...
Identity: For every object x, there exists a morphism 
...
) called the identity morphism for x, such that for every morphism 
