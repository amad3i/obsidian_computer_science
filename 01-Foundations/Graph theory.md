...
The graph is said to be minor if it can be formed from another graph by deleting vertices and edges, and by edge-contraction. The earliest result of the graph minor theory is from Wagner's theorem, stating that a finite graph is planar if and only if its minor includes neither the complete graph on five vertices 
 ...
 nor the utility graph. A related result is the Robertson–Seymour theorem, implying the existence of forbidden minor for every property of graphs preserved by deletions and edge contractions.
...
Extremal graph theory also studies forbidden subgraph problem, homomorphism density, and Szemerédi regularity lemma. The forbidden subgraphs problem suggests finding the extremal number of a graph with 
...
Beineke, Lowell W.; Wilson, Robin J. (2009). Topics in Topological Graph Theory. Cambridge University Press. ISBN 978-1-139-64368-9.
...
Bollobás, Béla (2013). Modern Graph Theory. Springer. ISBN 978-1-4612-0619-4.
...
Borgs, Christian; Chayes, Jennifer T.; Lovász, László; Sós, Vera T; Vestergombi, Katalin (2008). "Convergent sequences of dense graphs. I. Subgraph frequencies, metric properties and testing". Advances in Mathematics. 219 (6): 1801–1851. arXiv:math/0702004. doi:10.1016/j.aim.2008.07.008.
Bounceur, Ahcene; Bezoui, Madani; Euler, Reinhardt (2019). Boundaries and Hulls of Euclidean Graphs: From Theory to Practice. CRC Press. ISBN 978-1-351-69028-7.
...
Cayley, A. (2009) . "On the theory of the analytical forms called trees". The Collected Mathematical Papers. Vol. 3. pp. 242–246. doi:10.1017/CBO9780511703690.046. ISBN 978-0-511-70369-0.
Chalopin, J.; Gonçalves, D. (2009). "Every planar graph is the intersection graph of segments in the plane: Extended abstract". Proceedings of the forty-first annual ACM symposium on Theory of computing. pp. 631–638. doi:10.1145/1536414.1536500. ISBN 978-1-60558-506-2.
Chartrand, Gary (1985). Introductory Graph Theory. Dover. ISBN 0-486-24775-9.
Chartrand, Gary; Jordan, Heather; Vatter, Vincent; Zhang, Ping (2024), Graphs & Digraphs (7th ed.), CRC Press, p. 73, ISBN 978-1-032-13340-9.
Cvetković, Dragoš M.; Rowlinson, Peter (2004). "Spectral graph theory". In Beineke, Lowell W.; Wilson, Robin J. (eds.). Topics in Algebraic Graph Theory. Cambridge University Press. ISBN 978-0-521-80197-3.
...
Foulds, L. R. (1992). Graph Theory Applications. Universitext. Springer. ISBN 978-1-4612-0933-1.
...
Godsil, Chris; Royle, Gordon F. (2001). Algebraic Graph Theory. Springer. ISBN 978-1-4613-0163-9.
Golumbic, Martin (1980). Algorithmic Graph Theory and Perfect Graphs. Academic Press.
Gross, J. L.; Tucker, T. W. (2012) . Topological Graph Theory. Dover Publications. ISBN 978-0-486-41741-7.
Grünbaum, Branko (2006). "Configurations of points and lines". The Coxeter Legacy. Providence, RI: American Mathematical Society. pp. 179–225. MR 2209028.
Hahn, Geňa; Tardif, Claude (1997). "Graph homomorphisms: structure and symmetry". In Hahn, Geňa; Sabidussi, Gert (eds.). Graph Symmetry: Algebraic Methods and Applications. Kluwer Academic Publisher. ISBN 978-0-7923-4668-5.
...
Kaveh, A. (2013). Optimal Analysis of Structures by Concepts of Symmetry and Regularity. Springer. ISBN 978-3-7091-1565-7.
...
McKee, Terry A.; McMorris, F. R. (1999). Topics in Intersection Graph Theory. Society for Industrial and Applied Mathematics. ISBN 978-0-89871-430-2.
Mohar, Bojan; Thomassen, Carsten (2001). Graphs on Surfaces. Johns Hopkins University Press. ISBN 978-0-8018-6689-0. OCLC 45102952.
...
". Pacific Journal of Mathematics. 18: 169–173. doi:10.2140/pjm.1966.18.169. MR 0195077.
...
"The George Polya Prize". Looking Back, Looking Ahead: A SIAM History (PDF). Society for Industrial and Applied Mathematics. 2002. p. 26. Archived from the original (PDF) on 2016-03-05. Retrieved 2016-03-14.
Sylvester, James Joseph (1878). "Chemistry and Algebra". Nature. 17 (432): 284. Bibcode:1878Natur..17..284S. doi:10.1038/017284a0.
Thurston, William (March 2002). "§13.6, Andreev's theorem and generalizations, and §13.7, Constructing patterns of circles". The Geometry and Topology of 3-manifolds. MSRI Publications. pp. 330–346. Electronic version 1.1. Retrieved 2025-12-09.
Tutte, W. T. (2001). Graph Theory. Cambridge University Press. ISBN 978-0-521-79489-3.
Wilson, David Bruce (1996). "Generating random spanning trees more quickly than the cover time". Proceedings of the Twenty-Eighth Annual ACM Symposium on the Theory of Computing (STOC 1996). pp. 296–303. doi:10.1145/237814.237880. ISBN 0-89791-785-5. MR 1427525.
Zhao, Yufei (2023). Graph Theory and Additive Combinatorics: Exploring Structure and Randomness. Cambridge University Press. ISBN 978-1-009-31094-9.
Ziegler, Günter M. (2007). "Convex polytopes: extremal constructions and 
...
-vector shapes. Section 1.3: Steinitz's theorem via circle packings". In Miller, Ezra; Reiner, Victor; Sturmfels, Bernd (eds.). Geometric Combinatorics. IAS/Park City Mathematics Series. Vol. 13. American Mathematical Society. pp. 628–642. ISBN 978-0-8218-3736-8.

== External links ==

"Graph theory", Encyclopedia of Mathematics, EMS Press, 2001 
Graph theory tutorial Archived 2012-01-16 at the Wayback Machine
...
A list of graph algorithms Archived 2019-07-13 at the Wayback Machine with references and links to graph library implementations

=== Online textbooks ===
Hartmann, Alexander K.; Weigt, Martin (2005). "Introduction to graphs". Phase Transitions in Combinatorial Optimization Problems: Basics, Algorithms and Statistical Mechanics. Wiley. pp. 25–66. arXiv:cond-mat/0602129. doi:10.1002/3527606734.ch3. ISBN 978-3-527-60673-3.
