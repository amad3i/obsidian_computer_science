...
wikipedia_categories: ["1951 in computing", "American inventions", "Coding theory", "Computer arithmetic", "Error detection and correction"]
related: ["[[Hamming(7,4)]]", "[[Alternant code]]", "[[BCH code]]", "[[Berger code]]", "[[Berlekamp–Welch algorithm]]", "[[Burst error-correcting code]]", "[[Coding gain]]", "[[Coding theory]]", "[[Concatenated error correction code]]", "[[Coset leader]]"]
---
