...
wikipedia_categories: ["Algorithms", "Divide-and-conquer algorithms", "Optimization algorithms and methods"]
related: ["[[Best arm identification]]", "[[Communication-avoiding algorithm]]", "[[Explore-then-commit algorithm]]", "[[Kullback–Leibler Upper Confidence Bound]]", "[[Lai–Robbins lower bound]]", "[[Least-squares spectral analysis]]", "[[List of algorithms]]", "[[Adaptive algorithm]]", "[[Algorism]]", "[[Algorithm]]"]
---
