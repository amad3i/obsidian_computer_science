...
level: intermediate
source: "https://en.wikipedia.org/wiki/Noisy-channel_coding_theorem"
wikipedia_categories: ["Coding theory", "Information theory", "Telecommunication theory", "Theorems in discrete mathematics"]
related: ["[[Bar product]]", "[[Channel capacity]]", "[[Channel state information]]", "[[Communication channel]]", "[[Distributed source coding]]", "[[Generalized minimum-distance decoding]]", "[[Gibbs' inequality]]", "[[Grammar-based code]]", "[[Hamming distance]]", "[[Homomorphic signatures for network coding]]"]
---
