...
wikipedia_categories: ["Nature-inspired metaheuristics", "Optimization algorithms and methods"]
related: ["[[Fly algorithm]]", "[[Particle swarm optimization]]", "[[Spiral optimization algorithm]]", "[[Alpha–beta pruning]]", "[[Artificial bee colony algorithm]]", "[[Automatic label placement]]", "[[Backtracking line search]]", "[[Barzilai–Borwein method]]", "[[Bat algorithm]]", "[[Bees algorithm]]"]
---
