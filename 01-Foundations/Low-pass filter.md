...
wikipedia_categories: ["Acoustics", "Filter frequency response", "Linear filters", "Signal processing", "Sound", "Synthesiser modules"]
related: ["[[Pure tone]]", "[[All-pass filter]]", "[[Bandwidth (signal processing)]]", "[[Bode plot]]", "[[Digital room correction]]", "[[Equivalent rectangular bandwidth]]", "[[Geophysical MASINT]]", "[[Head-related transfer function]]", "[[Log Gabor filter]]", "[[Nominal level]]"]
---
