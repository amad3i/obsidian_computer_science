...
level: intermediate
source: "https://en.wikipedia.org/wiki/Conjectural_variation"
wikipedia_categories: ["Competition (economics)", "Game theory", "Market structure", "Oligopoly"]
related: ["[[Bertrand–Edgeworth model]]", "[[Stackelberg competition]]", "[[Ambiguity aversion]]", "[[Analytic narrative]]", "[[Asynchrony (game theory)]]", "[[Aumann's agreement theorem]]", "[[Authority distribution]]", "[[Backward induction]]", "[[Banzhaf power index]]", "[[Bayesian efficiency]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Conjectural_variation