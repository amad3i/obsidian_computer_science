...
level: advanced
source: "https://en.wikipedia.org/wiki/Linear_discriminant_analysis"
wikipedia_categories: ["Classification algorithms", "Market research", "Market segmentation", "Statistical classification"]
related: ["[[Latent class model]]", "[[Calibration (statistics)]]", "[[Decision boundary]]", "[[Factor analysis]]", "[[K-nearest neighbors algorithm]]", "[[Linear classifier]]", "[[Margin classifier]]", "[[Multiclass classification]]", "[[Multiple discriminant analysis]]", "[[One-class classification]]"]
---
