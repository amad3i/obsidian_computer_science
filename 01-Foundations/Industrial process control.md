...
level: intermediate
source: "https://en.wikipedia.org/wiki/Industrial_process_control"
wikipedia_categories: ["Chemical process engineering", "Control theory", "Industrial processes", "Process engineering", "Statistical process control"]
related: ["[[Process]]", "[[Process simulation]]", "[[Transient state]]", "[[4D-RCS Reference Model Architecture]]", "[[Ackermann's formula]]", "[[Active disturbance rejection control]]", "[[Adaptive control]]", "[[Advanced process control]]", "[[Affect control theory]]", "[[American Automatic Control Council]]"]
---
