...
wikipedia_categories: ["Shading"]
related: ["[[Cel shading]]", "[[Gooch shading]]", "[[Gouraud shading]]", "[[Horizon mapping]]", "[[Per-pixel lighting]]", "[[Rasterisation]]", "[[Ray tracing (graphics)]]", "[[Screen space directional occlusion]]", "[[Shading]]"]
---
