...
wikipedia_categories: ["American inventions", "Digital media", "Games and sports introduced in 1947", "Video games", "Visual arts media"]
related: ["[[BASIC]]", "[[Biological pacemaker]]", "[[Bionic contact lens]]", "[[Bulletin board system]]", "[[Butler in a Box]]", "[[C (programming language)]]", "[[C Sharp (programming language)]]", "[[Cardiac Pacemakers, Inc]]", "[[Centro Digital Pictures]]", "[[Charge-coupled device]]"]
---
