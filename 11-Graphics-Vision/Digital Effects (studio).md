---
title: "Digital Effects (studio)"
tags: ["cs", "graphics-vision", "intermediate"]
domain: Graphics & Vision
level: intermediate
source: "https://en.wikipedia.org/wiki/Digital_Effects_(studio)"
wikipedia_categories: ["1978 establishments in New York City", "1986 disestablishments in New York (state)", "Computer animation", "Computer graphics stubs", "Mass media companies disestablished in 1986", "Mass media companies established in 1978"]
related: ["[[Color cycling]]", "[[Digital Productions]]", "[[Parametric animation]]", "[[Pose space deformation]]", "[[4D reconstruction]]", "[[A Glitch Is a Glitch]]", "[[Adam Powers, The Juggler]]", "[[Alpha to coverage]]", "[[Animusic]]", "[[Asynchronous reprojection]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Digital_Effects_(studio)