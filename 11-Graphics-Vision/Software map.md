...
level: intermediate
source: "https://en.wikipedia.org/wiki/Software_map"
wikipedia_categories: ["Infographics", "Software development", "Software development process", "Software maintenance", "Software metrics", "Software quality", "Software testing", "Visualization (graphics)"]
related: ["[[Software visualization]]", "[[Sourcetrail]]", "[[Dynamic testing]]", "[[Flaky test]]", "[[Alsys]]", "[[Business process validation]]", "[[Chaos engineering]]", "[[Classification Tree Method]]", "[[Continuous test-driven development]]", "[[Design predicates]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Software_map