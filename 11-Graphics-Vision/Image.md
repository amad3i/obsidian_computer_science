...
level: intermediate
source: "https://en.wikipedia.org/wiki/Image"
wikipedia_categories: ["Computer graphics", "Digital photography", "Graphic design", "Photography", "Vision"]
related: ["[[Channel (digital image)]]", "[[Drop shadow]]", "[[Graphics]]", "[[Image editing]]", "[[Operational image]]", "[[Sample (graphics)]]", "[[Thumbnail]]", "[[2D computer graphics]]", "[[3D computer graphics]]", "[[3D lookup table]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Image