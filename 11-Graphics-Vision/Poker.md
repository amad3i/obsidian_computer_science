...
level: intermediate
source: "https://en.wikipedia.org/wiki/Poker"
wikipedia_categories: ["19th-century card games", "American card games", "American inventions", "Gambling games", "Mind sports", "Multi-player card games", "Multiplayer games", "Poker"]
related: ["[[BASIC]]", "[[Biological pacemaker]]", "[[Bionic contact lens]]", "[[Bulletin board system]]", "[[Butler in a Box]]", "[[C (programming language)]]", "[[C Sharp (programming language)]]", "[[Cardiac Pacemakers, Inc]]", "[[Charge-coupled device]]", "[[Compiler]]"]
---
