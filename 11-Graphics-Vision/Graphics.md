...
wikipedia_categories: ["Computer graphics", "Graphic design", "Graphics"]
related: ["[[Drop shadow]]", "[[Image]]", "[[Thumbnail]]", "[[2D computer graphics]]", "[[3D computer graphics]]", "[[3D lookup table]]", "[[4D reconstruction]]", "[[9-slice scaling]]", "[[A-buffer]]", "[[ACM Transactions on Graphics]]"]
---
