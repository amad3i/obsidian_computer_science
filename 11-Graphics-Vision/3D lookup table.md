...
wikipedia_categories: ["Computer graphics", "Display technology", "Film production"]
related: ["[[Dark mode]]", "[[Scan line]]", "[[Screenless video]]", "[[2D computer graphics]]", "[[360-degree video]]", "[[3D computer graphics]]", "[[4D reconstruction]]", "[[9-slice scaling]]", "[[A-buffer]]", "[[ACM Transactions on Graphics]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/3D_lookup_table