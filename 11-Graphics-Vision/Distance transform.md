...
wikipedia_categories: ["Digital geometry", "Image processing"]
related: ["[[Binary image]]", "[[Digital image]]", "[[Heat kernel signature]]", "[[LCD crosstalk]]", "[[Mathematical morphology]]", "[[Pixel]]", "[[Pixel aspect ratio]]", "[[Principal geodesic analysis]]", "[[Shape analysis (digital geometry)]]", "[[Topological skeleton]]"]
---
...
Uniformly-sampled signed distance fields have been used for GPU-accelerated font smoothing, for example by Valve researchers.
