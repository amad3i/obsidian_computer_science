...
wikipedia_categories: ["1853 introductions", "Color schemes", "Color space", "Data compression", "Image processing", "Photometry"]
related: ["[[Standard test image]]", "[[3D selfie]]", "[[Abel transform]]", "[[ActionShot]]", "[[Acutance]]", "[[Adaptive histogram equalization]]", "[[Albert Bijaoui]]", "[[Alpha to coverage]]", "[[Analog image processing]]", "[[Anisotropic diffusion]]"]
---
