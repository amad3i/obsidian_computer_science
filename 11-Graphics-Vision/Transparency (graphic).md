---
title: "Transparency (graphic)"
tags: ["cs", "graphics-vision", "intermediate"]
domain: Graphics & Vision
level: intermediate
source: "https://en.wikipedia.org/wiki/Transparency_(graphic)"
wikipedia_categories: ["Computer graphics", "Digital art"]
related: ["[[Generative art]]", "[[Human Race Machine]]", "[[Texture artist]]", "[[2D computer graphics]]", "[[3D computer graphics]]", "[[3D lookup table]]", "[[4D reconstruction]]", "[[9-slice scaling]]", "[[A-buffer]]", "[[ACM Transactions on Graphics]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Transparency_(graphic)