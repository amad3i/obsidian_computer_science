...
wikipedia_categories: ["3D computer graphics", "3D imaging", "Computer-aided engineering", "Video game design", "Visual effects"]
related: ["[[3D computer graphics]]", "[[T-pose]]", "[[Virtual replay]]", "[[3D projection]]", "[[3D reconstruction]]", "[[3D scanning]]", "[[Geometry processing]]", "[[Parallax barrier]]", "[[Plasticity (software)]]", "[[Volumetric capture]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/3D_modeling