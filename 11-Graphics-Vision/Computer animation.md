...
wikipedia_categories: ["Animation techniques", "Computer animation", "Computer graphics"]
related: ["[[Pose space deformation]]", "[[Cel shading]]", "[[Inbetweening]]", "[[Key frame]]", "[[Live2D]]", "[[Morphing]]", "[[Scanimate]]", "[[Scenery generator]]", "[[Skeletal animation]]", "[[2D computer graphics]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Computer_animation