...
wikipedia_categories: ["Database management systems", "Database stubs"]
related: ["[[Data store]]", "[[Pool (computer science)]]", "[[Relational calculus]]", "[[Spatiotemporal database]]", "[[Tablespace]]", "[[ACID]]", "[[ANSI-SPARC Architecture]]", "[[Armstrong's axioms]]", "[[Array DBMS]]", "[[AutoNumber]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Deductive_database