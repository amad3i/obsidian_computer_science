...
level: intermediate
source: "https://en.wikipedia.org/wiki/Database_theory"
wikipedia_categories: ["Database management systems", "Database theory"]
related: ["[[Bidirectionalization]]", "[[Database design]]", "[[Imieliński–Lipski algebra]]", "[[PACELC design principle]]", "[[Probabilistic database]]", "[[Rollback (data management)]]", "[[Temporal database]]", "[[Triplestore]]", "[[View (SQL)]]", "[[ACID]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Database_theory