...
level: intermediate
source: "https://en.wikipedia.org/wiki/StoredIQ"
wikipedia_categories: ["Companies based in Austin, Texas", "Companies established in 2001", "Data management", "Data warehousing"]
related: ["[[Dashboard (computing)]]", "[[Data blending]]", "[[Data transformation (computing)]]", "[[Data warehouse automation]]", "[[Enterprise bus matrix]]", "[[Log trigger]]", "[[Master data management]]", "[[Operational data store]]", "[[Operational database]]", "[[Operational system]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/StoredIQ