...
wikipedia_categories: ["Computer science stubs", "Data modeling"]
related: ["[[Enterprise data modelling]]", "[[Single version of the truth]]", "[[Alewife (multiprocessor)]]", "[[ALF (proof assistant)]]", "[[Analog image processing]]", "[[Anchor modeling]]", "[[AQUA@home]]", "[[Armstrong's axioms]]", "[[Asynchrony (computer programming)]]", "[[Attentive user interface]]"]
---
