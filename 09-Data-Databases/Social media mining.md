...
wikipedia_categories: ["Big data", "Business intelligence", "Data analysis", "Data mining", "Mass media monitoring", "Social information processing", "Social media", "Social media management"]
related: ["[[Big data]]", "[[Social profiling]]", "[[AMiner (database)]]", "[[Concept drift]]", "[[Continuous analytics]]", "[[Data version control]]", "[[Datafication]]", "[[Intelligence engine]]", "[[Multi-model database]]", "[[Online analytical processing]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Social_media_mining