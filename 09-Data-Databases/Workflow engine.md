...
wikipedia_categories: ["Data management", "Servers (computing)", "Workflow applications", "Workflow technology"]
related: ["[[Data center]]", "[[Data center management]]", "[[Database server]]", "[[Open Compute Project]]", "[[Project workforce management]]", "[[Abstraction (computer science)]]", "[[ActiveVOS]]", "[[Address space]]", "[[ADO.NET]]", "[[AiScaler]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Workflow_engine