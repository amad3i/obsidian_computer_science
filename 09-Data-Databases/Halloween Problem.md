...
level: intermediate
source: "https://en.wikipedia.org/wiki/Halloween_Problem"
wikipedia_categories: ["Database stubs", "Databases"]
related: ["[[Data store]]", "[[Database dump]]", "[[Hekaton (database)]]", "[[Index locking]]", "[[Information schema]]", "[[Integrated test facility]]", "[[International Clinical Trials Registry Platform]]", "[[Load file]]", "[[Locks with ordered sharing]]", "[[Pseudocolumn]]"]
---
...
Contrary to what some believe, the name is not descriptive of the nature of the problem but rather was given due to the day it was discovered on. As recounted by Don Chamberlin:
...
- Wikipedia: https://en.wikipedia.org/wiki/Halloween_Problem