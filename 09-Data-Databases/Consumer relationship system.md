...
level: intermediate
source: "https://en.wikipedia.org/wiki/Consumer_relationship_system"
wikipedia_categories: ["Customer relationship management", "Data management"]
related: ["[[Customer data management]]", "[[Abstraction (computer science)]]", "[[Address space]]", "[[ADO.NET]]", "[[Altitude3.Net]]", "[[ANSI 834 Enrollment Implementation Format]]", "[[Approximate inference]]", "[[Archive site]]", "[[Asset Description Metadata Schema]]", "[[Association rule learning]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Consumer_relationship_system