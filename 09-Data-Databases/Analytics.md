...
wikipedia_categories: ["Analytics", "Big data", "Business intelligence terms", "Financial data analysis", "Formal sciences"]
related: ["[[Prescriptive analytics]]", "[[Big data]]", "[[Embedded analytics]]", "[[Guided analytics]]", "[[IT operations analytics]]", "[[5D optical data storage]]", "[[Administrative data]]", "[[Amazon Kinesis]]", "[[Approximate inference]]", "[[Artificial intelligence]]"]
---
