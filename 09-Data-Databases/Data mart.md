...
wikipedia_categories: ["Data warehousing", "Database management systems"]
related: ["[[Master data management]]", "[[ACID]]", "[[Aggregate (data warehouse)]]", "[[Anchor modeling]]", "[[ANSI-SPARC Architecture]]", "[[Armstrong's axioms]]", "[[Array DBMS]]", "[[AutoNumber]]", "[[Azure Data Explorer]]", "[[Bidirectionalization]]"]
---
