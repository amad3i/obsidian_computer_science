...
wikipedia_categories: ["Concurrency control", "Data management", "Database management systems", "Databases", "Transaction processing"]
related: ["[[Commitment ordering]]", "[[Database transaction schedule]]", "[[Distributed concurrency control]]", "[[Global serializability]]", "[[Locks with ordered sharing]]", "[[Multi-model database]]", "[[ACID]]", "[[Big data]]", "[[Commit (data management)]]", "[[Document-oriented database]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Concurrency_control