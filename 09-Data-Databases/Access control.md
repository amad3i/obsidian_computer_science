...
wikipedia_categories: ["Access control", "Identity management", "Military terminology", "Perimeter security", "Physical security"]
related: ["[[Attack path management]]", "[[Anti-hijack system]]", "[[Authentication]]", "[[Authorization]]", "[[Avatar (computing)]]", "[[Biometric device]]", "[[Common Indexing Protocol]]", "[[Direct voice input]]", "[[Directory information tree]]", "[[Facebook real-name policy controversy]]"]
---
...
US Federal 1037C
US MIL-188
US National Information Systems Security Glossary
