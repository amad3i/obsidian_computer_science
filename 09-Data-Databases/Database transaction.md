...
wikipedia_categories: ["Data management", "Database management systems"]
related: ["[[Commit (data management)]]", "[[Concurrency control]]", "[[Data Analysis Expressions]]", "[[Data hub]]", "[[Database administration]]", "[[Database administrator]]", "[[Database engine]]", "[[Database normalization]]", "[[Distributed database]]", "[[Document-oriented database]]"]
---
