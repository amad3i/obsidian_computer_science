...
level: intermediate
source: "https://en.wikipedia.org/wiki/Database_application"
wikipedia_categories: ["Application software", "Databases"]
related: ["[[Common data model]]", "[[Altibase]]", "[[Application performance engineering]]", "[[Autocommit]]", "[[Big data]]", "[[Catalog server]]", "[[Central Equipment Identity Register]]", "[[ChromaDB]]", "[[Commitment ordering]]", "[[Composite index (database)]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Database_application