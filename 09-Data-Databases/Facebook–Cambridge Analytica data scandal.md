...
wikipedia_categories: ["2018 scandals", "Big data", "Cambridge Analytica", "Corporate scandals", "Data breaches", "Facebook criticisms and controversies", "Political scandals in the United Kingdom", "Political scandals in the United States"]
related: ["[[2026 Brazilian civil defense system false alarm]]", "[[2026 OpenAI agent cyberattacks]]", "[[5D optical data storage]]", "[[Administrative data]]", "[[Amazon Kinesis]]", "[[Analytics]]", "[[Approximate inference]]", "[[Astroinformatics]]", "[[Big data]]", "[[Big data ethics]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Facebook–Cambridge_Analytica_data_scandal