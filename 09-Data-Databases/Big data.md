...
wikipedia_categories: ["Big data", "Business intelligence terms", "Data analysis", "Data management", "Databases", "Social information processing", "Technology forecasting", "Transaction processing"]
related: ["[[Multi-model database]]", "[[Big memory]]", "[[Commitment ordering]]", "[[Concurrency control]]", "[[Data version control]]", "[[Database transaction schedule]]", "[[Datafication]]", "[[Distributed concurrency control]]", "[[Document-oriented database]]", "[[Embedded analytics]]"]
---
...
Variability
Unlike variety, variability captures the notion the fact that formats, structure, or sources of big data change through time and given different circumstances. Interpretation of data depends on a changing context, and with a different context, the old meanings may become invalid.
