...
wikipedia_categories: ["Data protection", "Database management systems", "Databases", "Obfuscation"]
related: ["[[Composite index (database)]]", "[[Concurrency control]]", "[[Data store]]", "[[Database design]]", "[[Database index]]", "[[Datasource]]", "[[Document-oriented database]]", "[[Foreign key]]", "[[Imieliński–Lipski algebra]]", "[[Materialized view]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Data_masking