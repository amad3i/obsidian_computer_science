...
level: core
source: "https://en.wikipedia.org/wiki/Entity–relationship_model"
wikipedia_categories: ["1976 introductions", "Computer-related introductions in 1976", "Data modeling diagrams", "Data modeling languages", "Entity–relationship model", "Modeling languages", "Taiwanese inventions"]
related: ["[[Enhanced entity–relationship model]]", "[[Unified Modeling Language]]", "[[ERIL]]", "[[EXPRESS (data modeling language)]]", "[[Fundamental modeling concepts]]", "[[IDEF1X]]", "[[Object–role modeling]]", "[[Supra-entity]]", "[[QL]]", "[[Anchor modeling]]"]
---
...
An ER model is typically implemented as a database. In a simple relational database implementation, each row of a table represents one instance of an entity type, and each column in a table represents an attribute type. In a relational database a relationship between entities is implemented by storing the primary key of one entity as a pointer or "foreign key" in the table of another entity.
...
Some researchers have extended ER modeling with constructs to represent state changes, an approach supported by the original author; an example is Anchor Modeling.
...
Data structure diagram – Visual representation of a certain kind of data model
