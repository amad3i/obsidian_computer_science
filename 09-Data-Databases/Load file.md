...
level: intermediate
source: "https://en.wikipedia.org/wiki/Load_file"
wikipedia_categories: ["Computer file formats", "Database stubs", "Databases", "Legal software"]
related: ["[[Data store]]", "[[Database dump]]", "[[Halloween Problem]]", "[[Hekaton (database)]]", "[[Index locking]]", "[[Information schema]]", "[[Integrated test facility]]", "[[International Clinical Trials Registry Platform]]", "[[Locks with ordered sharing]]", "[[Pseudocolumn]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Load_file