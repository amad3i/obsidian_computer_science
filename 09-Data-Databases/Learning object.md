...
level: intermediate
source: "https://en.wikipedia.org/wiki/Learning_object"
wikipedia_categories: ["Data management", "Educational materials", "Educational technology"]
related: ["[[Learning object metadata]]", "[[Abstraction (computer science)]]", "[[Address space]]", "[[ADO.NET]]", "[[Altitude3.Net]]", "[[ANSI 834 Enrollment Implementation Format]]", "[[Approximate inference]]", "[[Archive site]]", "[[Asset Description Metadata Schema]]", "[[Association rule learning]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Learning_object