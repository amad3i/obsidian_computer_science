...
level: intermediate
source: "https://en.wikipedia.org/wiki/Sargable"
wikipedia_categories: ["Database management systems", "Relational model"]
related: ["[[Candidate key]]", "[[Imieliński–Lipski algebra]]", "[[Materialized view]]", "[[Relation (database)]]", "[[Relational algebra]]", "[[Relational calculus]]", "[[Relational model]]", "[[Row (database)]]", "[[ACID]]", "[[ANSI-SPARC Architecture]]"]
---
