...
level: intermediate
source: "https://en.wikipedia.org/wiki/Open_Database_Connectivity"
wikipedia_categories: ["Computer programming", "Database APIs", "Microsoft application programming interfaces", "SQL data access"]
related: ["[[ADO.NET]]", "[[IODBC]]", "[[Module SQL]]", "[[Algorave]]", "[[Asynchronous procedure call]]", "[[Asynchrony (computer programming)]]", "[[Bayesian program synthesis]]", "[[Boolean flag]]", "[[Breakpoint]]", "[[CEN-XFS]]"]
---
