...
wikipedia_categories: ["Database management systems", "Subroutines"]
related: ["[[ACID]]", "[[Anonymous function]]", "[[ANSI-SPARC Architecture]]", "[[Armstrong's axioms]]", "[[Array DBMS]]", "[[AutoNumber]]", "[[Azure Data Explorer]]", "[[Bidirectionalization]]", "[[Bigtable]]", "[[Block contention]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Stored_procedure