...
level: intermediate
source: "https://en.wikipedia.org/wiki/Relation_(database)"
wikipedia_categories: ["Database management systems", "Relational model"]
related: ["[[Candidate key]]", "[[Imieliński–Lipski algebra]]", "[[Materialized view]]", "[[Relational algebra]]", "[[Relational calculus]]", "[[Relational model]]", "[[Row (database)]]", "[[Sargable]]", "[[ACID]]", "[[ANSI-SPARC Architecture]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Relation_(database)