...
level: intermediate
source: "https://en.wikipedia.org/wiki/Index_locking"
wikipedia_categories: ["Computing stubs", "Concurrency control", "Database stubs", "Databases", "Transaction processing"]
related: ["[[Locks with ordered sharing]]", "[[Commitment ordering]]", "[[Concurrency control]]", "[[Database transaction schedule]]", "[[Distributed concurrency control]]", "[[Global serializability]]", "[[Snapshot isolation]]", "[[Timestamping (computing)]]", "[[Two-phase locking]]", "[[ACID]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Index_locking