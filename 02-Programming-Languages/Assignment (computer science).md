...
level: intermediate
source: "https://en.wikipedia.org/wiki/Assignment_(computer_science)"
wikipedia_categories: ["Assignment operations", "Programming language concepts"]
related: ["[[Binding time]]", "[[Boxing (computer programming)]]", "[[Bridging (programming)]]", "[[Context-free language reachability]]", "[[Data type]]", "[[Declaration (computer programming)]]", "[[Dynamic variable]]", "[[Expression (computer science)]]", "[[Identifier (computer languages)]]", "[[Immediately invoked function expression]]"]
---
