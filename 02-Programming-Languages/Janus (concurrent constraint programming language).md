...
level: intermediate
source: "https://en.wikipedia.org/wiki/Janus_(concurrent_constraint_programming_language)"
wikipedia_categories: ["Concurrent programming languages", "Constraint programming languages", "Logic programming languages"]
related: ["[[Constraint Handling Rules]]", "[[Oz (programming language)]]", "[[Parlog]]", "[[-Lisp]]", "[[QL]]", "[[Actor-Based Concurrent Language]]", "[[AgentSheets]]", "[[Alef (programming language)]]", "[[Algorithmic skeleton]]", "[[AmbientTalk]]"]
---
