...
wikipedia_categories: ["1998 software", "ActionScript", "Adobe Flash", "Class-based programming languages", "High-level programming languages", "JavaScript programming language family", "Programming languages compiled to bytecode", "Programming languages created in 1998"]
related: ["[[PureBasic]]", "[[XSLT]]", "[[ABAP]]", "[[C Sharp (programming language)]]", "[[C++]]", "[[Clascal]]", "[[CoffeeScript]]", "[[D (programming language)]]", "[[JS++]]", "[[Lasso (programming language)]]"]
---
