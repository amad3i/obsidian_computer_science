...
level: advanced
source: "https://en.wikipedia.org/wiki/Hermes_(programming_language)"
wikipedia_categories: ["Distributed computing", "Programming language topic stubs", "Programming languages", "Static program analysis tools"]
related: ["[[Behavioral Description Language]]", "[[Cameleon (programming language)]]", "[[Clascal]]", "[[CorbaScript]]", "[[COWSEL]]", "[[Céu (programming language)]]", "[[DARSIMCO]]", "[[Dartmouth Oversimplified Programming Experiment]]", "[[ELAN (programming language)]]", "[[FX-87]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Hermes_(programming_language)