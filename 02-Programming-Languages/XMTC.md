...
level: intermediate
source: "https://en.wikipedia.org/wiki/XMTC"
wikipedia_categories: ["C programming language family", "Concurrent programming languages", "Programming language topic stubs"]
related: ["[[Alef (programming language)]]", "[[Newsqueak]]", "[[Chapel (programming language)]]", "[[Cilk]]", "[[Dart (programming language)]]", "[[Ease (programming language)]]", "[[Embedded C]]", "[[Go (programming language)]]", "[[Intel Parallel Building Blocks]]", "[[Java (programming language)]]"]
---
