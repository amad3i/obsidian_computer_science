...
wikipedia_categories: ["Injection exploits", "SQL"]
related: ["[[Alpha (programming language)]]", "[[Apache Drill]]", "[[Armitage (computing)]]", "[[Broker injection]]", "[[Commit (data management)]]", "[[CPLINK]]", "[[Cross-site scripting]]", "[[Cubes (OLAP server)]]", "[[Cursor (databases)]]", "[[Data control language]]"]
---
