...
level: intermediate
source: "https://en.wikipedia.org/wiki/Rebeca_(programming_language)"
wikipedia_categories: ["Concurrent programming languages", "Programming language topic stubs"]
related: ["[[Alef (programming language)]]", "[[Ease (programming language)]]", "[[JoCaml]]", "[[Joule (programming language)]]", "[[Lynx (programming language)]]", "[[MPD (programming language)]]", "[[NESL]]", "[[Newsqueak]]", "[[Occam-π]]", "[[Orc (programming language)]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Rebeca_(programming_language)