...
level: intermediate
source: "https://en.wikipedia.org/wiki/Purely_functional_programming"
wikipedia_categories: ["Functional programming", "Programming paradigms"]
related: ["[[Functional logic programming]]", "[[Functional programming]]", "[[Total functional programming]]", "[[A-normal form]]", "[[Actant]]", "[[Algebraic data type]]", "[[Anonymous function]]", "[[Applicative functor]]", "[[Array programming]]", "[[Arrow (computer science)]]"]
---
