...
wikipedia_categories: ["Algol programming language family", "C++", "C++ programming language family", "Class-based programming languages", "Compiled programming languages", "Cross-platform software", "High-level programming languages", "Object-oriented programming languages"]
related: ["[[D (programming language)]]", "[[ABAP]]", "[[Lasso (programming language)]]", "[[Object REXX]]", "[[PHP]]", "[[Python (programming language)]]", "[[AgentSheets]]", "[[Apache Groovy]]", "[[C (programming language)]]", "[[C Sharp (programming language)]]"]
---
