...
level: intermediate
source: "https://en.wikipedia.org/wiki/Discourse_relation"
wikipedia_categories: ["Discourse analysis", "Formal semantics (natural language)", "Natural language processing", "Semantics"]
related: ["[[Automatic acquisition of sense-tagged corpora]]", "[[Classic monolingual word-sense disambiguation]]", "[[Computational semantics]]", "[[Extension (semantics)]]", "[[Lesk algorithm]]", "[[Lexical substitution]]", "[[Minimal recursion semantics]]", "[[Naive semantics]]", "[[Rhetorical structure theory]]", "[[Semantic analysis (computational)]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Discourse_relation