...
wikipedia_categories: ["1951 introductions", "Automata (computation)", "Formal languages", "Pattern matching", "Programming constructs", "Regular expressions"]
related: ["[[Conference on Implementation and Application of Automata]]", "[[Delimiter]]", "[[Deterministic pushdown automaton]]", "[[Diff]]", "[[Formal grammar]]", "[[Generalized star-height problem]]", "[[Introduction to Automata Theory, Languages, and Computation]]", "[[Metacharacter]]", "[[Nested word]]", "[[Parser Grammar Engine]]"]
---
...
\[.\] matches any single character surrounded by "[" and "]" since the brackets are escaped, for example: "[a]", "[b]", "", "[@]", "[]]", and "[ ]" (bracket space bracket).
