...
level: intermediate
source: "https://en.wikipedia.org/wiki/SPITBOL"
wikipedia_categories: ["Compilers", "Pattern matching programming languages", "SNOBOL programming language family"]
related: ["[[SNOBOL]]", "[[Absoft]]", "[[Accelerated Linear Algebra]]", "[[Ahead-of-time compilation]]", "[[Apple Dylan]]", "[[Arden2ByteCode]]", "[[Ark Compiler]]", "[[AWK]]", "[[Banerjee test]]", "[[Binary optimizer]]"]
---
