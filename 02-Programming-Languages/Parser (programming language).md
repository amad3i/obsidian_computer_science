---
title: "Parser (programming language)"
tags: ["cs", "programming-languages", "intermediate"]
domain: Programming & Languages
level: intermediate
source: "https://en.wikipedia.org/wiki/Parser_(programming_language)"
wikipedia_categories: ["Free and open source compilers", "Macro programming languages", "Procedural programming languages", "Programming languages created in 1997", "Scripting languages"]
related: ["[[Boo (programming language)]]", "[[Ciao (programming language)]]", "[[CLIST]]", "[[D (programming language)]]", "[[Emacs Lisp]]", "[[Go (programming language)]]", "[[Julia (programming language)]]", "[[Perl]]", "[[PHP]]", "[[PowerShell]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Parser_(programming_language)