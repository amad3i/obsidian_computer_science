...
level: intermediate
source: "https://en.wikipedia.org/wiki/Qualification_problem"
wikipedia_categories: ["Epistemology", "Epistemology stubs", "Knowledge representation", "Logic programming"]
related: ["[[Ramification problem]]", "[[Closed-world assumption]]", "[[Event calculus]]", "[[Frame problem]]", "[[Yale shooting problem]]", "[[4E cognition]]", "[[Abductive logic programming]]", "[[Abductive reasoning]]", "[[Advice taker]]", "[[Agent Communications Language]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Qualification_problem