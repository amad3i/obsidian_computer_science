...
wikipedia_categories: ["American inventions", "C programming language family", "Class-based programming languages", "Compiled programming languages", "Concurrent programming languages", "JVM programming languages", "Java (programming language)", "Java (software platform)"]
related: ["[[Outline of the Java programming language]]", "[[AgentSheets]]", "[[Go (programming language)]]", "[[C (programming language)]]", "[[C Sharp (programming language)]]", "[[D (programming language)]]", "[[Objective-C]]", "[[Alef (programming language)]]", "[[Ateji PX]]", "[[C++]]"]
---
