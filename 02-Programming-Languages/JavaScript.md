...
wikipedia_categories: ["American inventions", "Cross-platform software", "Dynamically typed programming languages", "Functional languages", "High-level programming languages", "JavaScript", "Object-based programming languages", "Programming languages"]
related: ["[[Julia (programming language)]]", "[[Perl]]", "[[Qore (programming language)]]", "[[Apache Groovy]]", "[[C (programming language)]]", "[[C Sharp (programming language)]]", "[[Clojure]]", "[[Gleam (programming language)]]", "[[Go (programming language)]]", "[[Haxe]]"]
---
