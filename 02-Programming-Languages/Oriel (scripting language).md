...
level: intermediate
source: "https://en.wikipedia.org/wiki/Oriel_(scripting_language)"
wikipedia_categories: ["Programming languages created in 1991", "Scripting languages"]
related: ["[[Python (programming language)]]", "[[ActionScript]]", "[[Active Scripting]]", "[[ActivePerl]]", "[[Adobe ColdFusion]]", "[[Almquist shell]]", "[[AMPL]]", "[[AngelScript]]", "[[Apache Groovy]]", "[[AppleScript]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Oriel_(scripting_language)