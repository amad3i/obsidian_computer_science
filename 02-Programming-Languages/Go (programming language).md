...
wikipedia_categories: ["American inventions", "C programming language family", "Compiled programming languages", "Concurrent programming languages", "Cross-platform free software", "Cross-platform software", "Free and open source compilers", "Go (programming language)"]
related: ["[[V (programming language)]]", "[[C (programming language)]]", "[[Crystal (programming language)]]", "[[D (programming language)]]", "[[Java (programming language)]]", "[[Zig (programming language)]]", "[[Ciao (programming language)]]", "[[Free Pascal]]", "[[Perl]]", "[[Python (programming language)]]"]
---
