...
wikipedia_categories: ["Debugging"]
related: ["[[Assertion (software development)]]", "[[Breakpoint]]", "[[Ceibo emulator]]", "[[Debug menu]]", "[[Flame graph]]", "[[Flash memory emulator]]", "[[Heisenbug]]", "[[In-circuit emulation]]", "[[In-target probe]]", "[[Probe effect]]"]
---
...
Fault localization is the automated technique of identifying program elements (statements, methods, or components) likely to contain faults.  Modern approaches use machine learning to improve localization accuracy.
...
The Essentials of Debugging –  how to improve your debugging skills
Plug-in Based Debugging For Embedded Systems Archived 2019-12-10 at the Wayback Machine
