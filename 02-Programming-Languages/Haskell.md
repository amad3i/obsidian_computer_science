...
wikipedia_categories: ["Academic programming languages", "Compiled programming languages", "Educational programming languages", "Functional languages", "Haskell programming language family", "Literate programming", "Pattern matching programming languages", "Programming languages created in 1990"]
related: ["[[Curry (programming language)]]", "[[Elm (programming language)]]", "[[Programming Computable Functions]]", "[[Rust (programming language)]]", "[[Swift (programming language)]]", "[[Agda (programming language)]]", "[[ALGOL 68]]", "[[Atom (programming language)]]", "[[C Sharp (programming language)]]", "[[Concurrent Haskell]]"]
---
