...
wikipedia_categories: ["American inventions", "C programming language family", "Cross-platform software", "Dynamic programming languages", "Dynamically typed programming languages", "Free-software conferences", "Free and open source interpreters", "Free software programmed in C"]
related: ["[[Lua]]", "[[PHP]]", "[[Qore (programming language)]]", "[[Tcl (programming language)]]", "[[C (programming language)]]", "[[Julia (programming language)]]", "[[Ruby (programming language)]]", "[[Source (programming language)]]", "[[Apache Groovy]]", "[[Clojure]]"]
---
