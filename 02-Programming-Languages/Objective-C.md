...
wikipedia_categories: ["C programming language family", "Class-based programming languages", "Compiled programming languages", "Dynamically typed programming languages", "GNUstep", "NeXT", "Object-oriented programming languages", "Objective-C"]
related: ["[[D (programming language)]]", "[[Java (programming language)]]", "[[C++]]", "[[Dart (programming language)]]", "[[J (programming language)]]", "[[Lasso (programming language)]]", "[[Object REXX]]", "[[Perl]]", "[[PHP]]", "[[Python (programming language)]]"]
---
