...
wikipedia_categories: ["BASIC compilers", "BASIC interpreters", "BASIC programming language family", "Integrated development environments", "Microsoft BASIC", "Microsoft Visual Studio", "Microsoft development tools", "Microsoft programming languages"]
related: ["[[GLBasic]]", "[[PureBasic]]", "[[FreeBASIC]]", "[[Microsoft Visual Programming Language]]", "[[VBScript]]", "[[Visual FoxPro]]", "[[Absoft]]", "[[ADvantage Framework]]", "[[Apple Dylan]]", "[[AutoIt]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Visual_Basic_(classic)