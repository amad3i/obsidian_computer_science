...
level: intermediate
source: "https://en.wikipedia.org/wiki/ToonTalk"
wikipedia_categories: ["Educational programming languages", "Logic programming languages", "Pedagogic integrated development environments", "Programming games", "Software for children", "Visual programming languages"]
related: ["[[AgentCubes]]", "[[AgentSheets]]", "[[Stagecast Creator]]", "[[Alice (software)]]", "[[Catrobat]]", "[[Etoys (programming language)]]", "[[Mama (software)]]", "[[Open Roberta]]", "[[Raptor (programming language)]]", "[[Scratch (programming language)]]"]
---
