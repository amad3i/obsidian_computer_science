...
wikipedia_categories: ["Data-flow analysis", "Program analysis"]
related: ["[[Abstract interpretation]]", "[[Aliasing (computing)]]", "[[Compiler-compiler]]", "[[Context-free language reachability]]", "[[Dynamic program analysis]]", "[[Effect system]]", "[[Flow-sensitive typing]]", "[[KPI-driven code analysis]]", "[[Live-variable analysis]]", "[[Path explosion]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Reaching_definition