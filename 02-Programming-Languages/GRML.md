...
level: intermediate
source: "https://en.wikipedia.org/wiki/GRML"
wikipedia_categories: ["Markup languages", "Programming language topic stubs"]
related: ["[[Human Markup Language]]", "[[OIOXML]]", "[[WDDX]]", "[[XDXF]]", "[[3DML]]", "[[A-normal form]]", "[[AAP DTD]]", "[[Access query language]]", "[[ADDML]]", "[[Akoma Ntoso]]"]
---
