...
level: intermediate
source: "https://en.wikipedia.org/wiki/LiveCode"
wikipedia_categories: ["2001 software", "Computing platforms", "Cross-platform software", "Formerly open-source or free software", "Integrated development environments", "Programming languages", "Programming languages created in 2001", "Scripting languages"]
related: ["[[AspectJ]]", "[[D (programming language)]]", "[[Processing]]", "[[Apache Groovy]]", "[[JavaScript]]", "[[Joy (programming language)]]", "[[Lua]]", "[[Perl]]", "[[PHP]]", "[[Python (programming language)]]"]
---
