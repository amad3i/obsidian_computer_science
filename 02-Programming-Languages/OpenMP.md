...
wikipedia_categories: ["Application programming interfaces", "C programming language family", "Fortran", "Parallel computing"]
related: ["[[OpenACC]]", "[[OpenHMPP]]", "[[ISP Formal Verification Tool]]", "[[Message Passing Interface]]", "[[OpenCL]]", "[[Portals network programming application programming interface]]", "[[SHMEM]]", "[[Unified Parallel C]]", "[[ABIT BP6]]", "[[Advanced Synchronization Facility]]"]
---
