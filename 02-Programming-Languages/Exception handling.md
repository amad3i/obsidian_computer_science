...
wikipedia_categories: ["Control flow", "Software anomalies"]
related: ["[[Common Weakness Enumeration]]", "[[Crash reporter]]", "[[Dead code]]", "[[Entry point]]", "[[Flaky test]]", "[[Label (computer science)]]", "[[Left recursion]]", "[[Loop invariant]]", "[[Loop variant]]", "[[Setcontext]]"]
---
