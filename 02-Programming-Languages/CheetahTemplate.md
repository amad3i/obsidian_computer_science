...
level: intermediate
source: "https://en.wikipedia.org/wiki/CheetahTemplate"
wikipedia_categories: ["Free and open-source software stubs", "Free software programmed in Python", "Free system software", "Python (programming language) libraries", "Scripting languages", "Software using the MIT license", "Template engines", "Web software stubs"]
related: ["[[Genshi (templating language)]]", "[[CS-Script]]", "[[ASCEND]]", "[[ChatScript]]", "[[CoffeeScript]]", "[[Comparison of web template engines]]", "[[DataViva]]", "[[DeviceKit]]", "[[GameMonkey Script]]", "[[GUN (graph database)]]"]
---
