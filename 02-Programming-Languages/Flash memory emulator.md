---
title: "Flash memory emulator"
tags: ["cs", "programming-languages", "intermediate"]
domain: Programming & Languages
level: intermediate
source: "https://en.wikipedia.org/wiki/Flash_memory_emulator"
wikipedia_categories: ["Debugging", "Embedded systems"]
related: ["[[Ceibo emulator]]", "[[In-circuit emulation]]", "[[In-target probe]]", "[[Adesto Technologies]]", "[[ADvantage Framework]]", "[[Anti-hijack system]]", "[[Apache Celix]]", "[[Assembly language]]", "[[Assertion (software development)]]", "[[ATM]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Flash_memory_emulator