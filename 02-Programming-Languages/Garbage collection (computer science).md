...
wikipedia_categories: ["Automatic memory management", "Memory management", "Solid-state computer storage"]
related: ["[[bss]]", "[[Dispose pattern]]", "[[Finalizer]]", "[[Memory management]]", "[[Memory management (operating systems)]]", "[[Memory segmentation]]", "[[Pool (computer science)]]", "[[Resource allocation (computing)]]", "[[Write barrier]]"]
---
...
=== C and C++ ===
C has never offered official support for garbage collection. C++ added garbage collection support in C++11 to the standard library, however this was removed in C++23 due to no compilers implementing support for the feature. The features that were part of this were related to pointer safety. 
...
The Memory Management Reference Archived 2020-12-13 at the Wayback Machine
