...
wikipedia_categories: ["Operating system technology", "Programming language implementation", "Virtual machines"]
related: ["[[System virtual machine]]", "[[Transterpreter]]", "[[Virtual machine introspection]]", "[[Virtual machining]]", "[[Vkernel]]", "[[bss]]", "[[ALTQ]]", "[[Application binary interface]]", "[[Apptainer]]", "[[Aspect weaver]]"]
---
