...
wikipedia_categories: ["American inventions", "BASIC programming language family", "Programming languages", "Programming languages created in 1964", "Programming languages with an ISO standard"]
related: ["[[APL (programming language)]]", "[[C (programming language)]]", "[[C Sharp (programming language)]]", "[[JavaScript]]", "[[Ada (programming language)]]", "[[COMAL]]", "[[COWSEL]]", "[[Forth (programming language)]]", "[[FreeBASIC]]", "[[Go (programming language)]]"]
---
