...
level: intermediate
source: "https://en.wikipedia.org/wiki/SR_(programming_language)"
wikipedia_categories: ["Concurrent programming languages", "Programming language topic stubs", "SR programming language family"]
related: ["[[MPD (programming language)]]", "[[Alef (programming language)]]", "[[Ease (programming language)]]", "[[JoCaml]]", "[[Joule (programming language)]]", "[[Lynx (programming language)]]", "[[NESL]]", "[[Newsqueak]]", "[[Occam-π]]", "[[Orc (programming language)]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/SR_(programming_language)