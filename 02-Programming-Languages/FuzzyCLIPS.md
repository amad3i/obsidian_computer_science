...
level: intermediate
source: "https://en.wikipedia.org/wiki/FuzzyCLIPS"
wikipedia_categories: ["Expert systems", "Fuzzy logic", "Programming language topic stubs"]
related: ["[[Fuzzy Control Language]]", "[[A-normal form]]", "[[Access query language]]", "[[Adaptive neuro fuzzy inference system]]", "[[Alef (programming language)]]", "[[Alpha (programming language)]]", "[[Array-access analysis]]", "[[Artificial intelligence in fraud detection]]", "[[AtScript]]", "[[Backward chaining]]"]
---
