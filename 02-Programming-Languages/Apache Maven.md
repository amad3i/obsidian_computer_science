...
wikipedia_categories: ["Apache Software Foundation projects", "Build automation", "Compiling tools", "Java development tools", "Software using the Apache license"]
related: ["[[Apache Ant]]", "[[Gradle]]", "[[Apache Accumulo]]", "[[Apache Calcite]]", "[[Apache CarbonData]]", "[[Apache CouchDB]]", "[[Apache Giraph]]", "[[Apache Hive]]", "[[Apache Kylin]]", "[[Apache Mahout]]"]
---
