...
level: intermediate
source: "https://en.wikipedia.org/wiki/Advice_taker"
wikipedia_categories: ["1958 in computing", "Computer-related introductions in 1958", "Experimental programming languages", "History of artificial intelligence", "Logic programming"]
related: ["[[A Logical Calculus of the Ideas Immanent in Nervous Activity]]", "[[Abductive logic programming]]", "[[AI boom]]", "[[AI winter]]", "[[AmbientTalk]]", "[[Answer set programming]]", "[[Artificial intelligence in fraud detection]]", "[[Autoepistemic logic]]", "[[Belief revision]]", "[[BlooP and FlooP]]"]
---
