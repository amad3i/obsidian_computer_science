...
level: intermediate
source: "https://en.wikipedia.org/wiki/Axum_(programming_language)"
wikipedia_categories: [".NET programming languages", "Concurrent programming languages", "Object-oriented programming languages"]
related: ["[[AgentSheets]]", "[[Ateji PX]]", "[[Boo (programming language)]]", "[[Chapel (programming language)]]", "[[Crystal (programming language)]]", "[[Dart (programming language)]]", "[[E (programming language)]]", "[[JADE (programming language)]]", "[[Java (programming language)]]", "[[JoCaml]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Axum_(programming_language)