...
level: intermediate
source: "https://en.wikipedia.org/wiki/Role-oriented_programming"
wikipedia_categories: ["Computer programming stubs", "Object-based programming languages", "Programming paradigms"]
related: ["[[Higher-order programming]]", "[[Programming by example]]", "[[Value semantics]]", "[[Action–domain–responder]]", "[[Active object]]", "[[Aggregate pattern]]", "[[AmbientTalk]]", "[[ArkTS]]", "[[Array programming]]", "[[Aspect-oriented programming]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Role-oriented_programming