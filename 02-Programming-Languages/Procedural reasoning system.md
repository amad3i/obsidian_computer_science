---
title: "Procedural reasoning system"
tags: ["cs", "programming-languages", "intermediate"]
domain: Programming & Languages
level: intermediate
source: "https://en.wikipedia.org/wiki/Procedural_reasoning_system"
wikipedia_categories: ["Agent-based programming languages", "Cognitive architecture", "Knowledge representation", "Multi-agent systems", "SRI International software"]
related: ["[[Open Knowledge Base Connectivity]]", "[[SARL (programming language)]]", "[[4E cognition]]", "[[Agent Communications Language]]", "[[Agentive logic]]", "[[AgentSheets]]", "[[AgMES]]", "[[Agricultural Information Management Standards]]", "[[AGROVOC]]", "[[Allen's interval algebra]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Procedural_reasoning_system