...
wikipedia_categories: ["Data-centric programming languages", "Data modeling languages", "Database management systems", "Declarative programming languages", "Programming languages created in 1974", "Programming languages with an ISO standard", "Query languages", "Relational database management systems"]
related: ["[[SQL syntax]]", "[[SQLf]]", "[[QL]]", "[[List of SPARQL implementations]]", "[[Module SQL]]", "[[QUEL query languages]]", "[[SPARQL]]", "[[Alpha (programming language)]]", "[[Apache Pig]]", "[[Comparison of relational database management systems]]"]
---
