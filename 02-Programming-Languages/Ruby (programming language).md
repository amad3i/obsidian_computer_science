...
wikipedia_categories: ["Class-based programming languages", "Dynamic programming languages", "Dynamically typed programming languages", "Free and open source interpreters", "Free software programmed in C", "Functional languages", "ISO standards", "Japanese inventions"]
related: ["[[PHP]]", "[[Julia (programming language)]]", "[[Lua]]", "[[Perl]]", "[[APL (programming language)]]", "[[C Sharp (programming language)]]", "[[Clojure]]", "[[Erlang (programming language)]]", "[[Harbour (programming language)]]", "[[J (programming language)]]"]
---
