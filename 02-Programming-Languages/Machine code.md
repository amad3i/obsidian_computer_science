...
wikipedia_categories: ["Assembly languages", "Low-level programming languages", "Machine code"]
related: ["[[Addressing mode]]", "[[Assembly language]]", "[[bss]]", "[[Address constant]]", "[[ARB assembly language]]", "[[Autocoder]]", "[[Bit numbering]]", "[[Broker injection]]", "[[Code generation (compiler)]]", "[[Common Intermediate Language]]"]
---
...
Later IBM introduced an assembler (SOAP) that allowed symbolic address and also performed a rough optimization pass.
...
Endianness – Order of bytes in a computer word
List of machine languages – List of programming languages types and the languages that meet its description
Machine code monitor – Software that was popular during the home computer era of the 1970s and 1980s
Micro-Professor MPF-I – Microcomputer released by Multitech in 1981
native executable – Data that causes a computer to follow indicated instructions
Object code – Sequence of statements or instructions in a computer language
P-code machine – Programming virtual machine
Reduced instruction set computer – Processor executing one instruction in minimal clock cycles (RISC)
Very long instruction word – Computer architecture to aid parallelism
