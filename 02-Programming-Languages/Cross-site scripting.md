...
wikipedia_categories: ["Client-side web security exploits", "Hacking (computer security)", "Injection exploits", "Web security exploits"]
related: ["[[Cross-site leaks]]", "[[Broker injection]]", "[[History sniffing]]", "[[Armitage (computing)]]", "[[Attack patterns]]", "[[Black hat (computer security)]]", "[[BREACH]]", "[[Camfecting]]", "[[Capture the flag (cybersecurity)]]", "[[CPLINK]]"]
---
