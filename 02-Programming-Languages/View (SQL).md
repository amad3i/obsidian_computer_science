...
wikipedia_categories: ["Database management systems", "Database theory", "SQL"]
related: ["[[Bidirectionalization]]", "[[Commit (data management)]]", "[[Cursor (databases)]]", "[[Data control language]]", "[[Data query language]]", "[[Database design]]", "[[Database object]]", "[[Database theory]]", "[[Foreign key]]", "[[Hierarchical and recursive queries in SQL]]"]
---
...
Views can structure data in a way that classes of users find natural and intuitive.
