...
wikipedia_categories: ["Academic programming languages", "American inventions", "Dynamically typed programming languages", "Extensible syntax programming languages", "Functional languages", "Lisp (programming language)", "Lisp programming language family", "Programming languages"]
related: ["[[JavaScript]]", "[[Joy (programming language)]]", "[[Julia (programming language)]]", "[[Logo (programming language)]]", "[[Rebol]]", "[[Scheme (programming language)]]", "[[-Lisp]]", "[[Agda (programming language)]]", "[[APL (programming language)]]", "[[C Sharp (programming language)]]"]
---
