...
wikipedia_categories: ["Data modeling", "Database management systems", "Relational database management systems", "SQL"]
related: ["[[Data control language]]", "[[Data query language]]", "[[Database object]]", "[[Foreign key]]", "[[Nested SQL]]", "[[SQL]]", "[[SQL syntax]]", "[[SQLf]]", "[[Armstrong's axioms]]", "[[Candidate key]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Table_(database)