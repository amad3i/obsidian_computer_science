...
wikipedia_categories: ["2012 software", "Cross-platform software", "JavaScript programming language family", "Microsoft free software", "Microsoft programming languages", "Object-based programming languages", "Programming languages", "Programming languages created in 2012"]
related: ["[[Julia (programming language)]]", "[[ArkTS]]", "[[JavaScript]]", "[[JScript]]", "[[Visual Basic (classic)]]", "[[ABAP]]", "[[Apache Groovy]]", "[[AspectJ]]", "[[C (programming language)]]", "[[C Sharp (programming language)]]"]
---
