...
wikipedia_categories: ["Academic programming languages", "Dynamically typed programming languages", "Extensible syntax programming languages", "Lisp programming language family", "Multi-paradigm programming languages", "Programming languages created in 1975", "Scheme (programming language)"]
related: ["[[Lisp (programming language)]]", "[[-Lisp]]", "[[Julia (programming language)]]", "[[MultiLisp]]", "[[Portable Standard Lisp]]", "[[Agda (programming language)]]", "[[Clojure]]", "[[Harbour (programming language)]]", "[[J (programming language)]]", "[[Joy (programming language)]]"]
---
...
The language is formally defined in the standards R5RS (1998), R6RS (2007), and R7RS (2013). They describe standard "forms": keywords and accompanying syntax, which provide the control structure of the language, and standard procedures which perform common tasks.
