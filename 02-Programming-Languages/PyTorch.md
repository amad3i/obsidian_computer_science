...
wikipedia_categories: ["Deep learning software", "Facebook software", "Free science software", "Free software programmed in C", "Free software programmed in Python", "Open-source artificial intelligence", "Python (programming language) scientific libraries", "Software using the BSD license"]
related: ["[[TensorFlow]]", "[[Theano (software)]]", "[[Ganglia (software)]]", "[[Deeplearning4j]]", "[[Emergent (software)]]", "[[Genshi (templating language)]]", "[[Keras]]", "[[Mercurial]]", "[[Natural Language Toolkit]]", "[[Orange (software)]]"]
---
