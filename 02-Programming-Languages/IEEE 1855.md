...
level: intermediate
source: "https://en.wikipedia.org/wiki/IEEE_1855"
wikipedia_categories: ["Domain-specific programming languages", "Fuzzy logic", "IEEE standards"]
related: ["[[Fuzzy Control Language]]", "[[VHDL]]", "[[Adaptive neuro fuzzy inference system]]", "[[Apple Media Tool]]", "[[APT (programming language)]]", "[[AWK]]", "[[Bash (Unix shell)]]", "[[Bayesian inference using Gibbs sampling]]", "[[BEFLIX]]", "[[CLIPS]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/IEEE_1855