...
wikipedia_categories: ["Assembly languages", "Computer-related introductions in 1949", "Embedded systems", "Low-level programming languages", "Programming language implementation", "Programming languages created in 1949"]
related: ["[[bss]]", "[[Machine code]]", "[[Address constant]]", "[[Addressing mode]]", "[[Adesto Technologies]]", "[[ADvantage Framework]]", "[[Anti-hijack system]]", "[[Apache Celix]]", "[[ARB assembly language]]", "[[Aspect weaver]]"]
---
