...
wikipedia_categories: ["1995 software", "Class-based programming languages", "Cross-platform software", "Dynamic programming languages", "Dynamically typed programming languages", "Filename extensions", "Free and open source interpreters", "Free software programmed in C"]
related: ["[[Lua]]", "[[Perl]]", "[[Ruby (programming language)]]", "[[Julia (programming language)]]", "[[Lasso (programming language)]]", "[[Object REXX]]", "[[Qore (programming language)]]", "[[Source (programming language)]]", "[[Tcl (programming language)]]", "[[Apache Groovy]]"]
---
