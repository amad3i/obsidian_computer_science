...
level: intermediate
source: "https://en.wikipedia.org/wiki/Sequential_function_chart"
wikipedia_categories: ["Programmable logic controllers", "Visual programming languages"]
related: ["[[Function block diagram]]", "[[Ladder logic]]", "[[AgentCubes]]", "[[AgentSheets]]", "[[Alice (software)]]", "[[AMBIT]]", "[[Analytica (software)]]", "[[AppWare]]", "[[Automator (macOS)]]", "[[Blockly]]"]
---
