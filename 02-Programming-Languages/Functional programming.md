...
wikipedia_categories: ["Functional programming", "Programming language comparisons", "Programming paradigms"]
related: ["[[Comparison of multi-paradigm programming languages]]", "[[Functional logic programming]]", "[[Higher-order function]]", "[[Imperative programming]]", "[[Option type]]", "[[Pattern matching]]", "[[Polymorphism (computer science)]]", "[[Purely functional programming]]", "[[Tacit programming]]", "[[Total functional programming]]"]
---
