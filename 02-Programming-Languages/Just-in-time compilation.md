...
wikipedia_categories: ["Compiler construction", "Emulation software", "Virtualization"]
related: ["[[Dynamic recompilation]]", "[[Abstract syntax]]", "[[Affix grammar]]", "[[Aliasing (computing)]]", "[[Application Defined Network]]", "[[Array-access analysis]]", "[[Aspect weaver]]", "[[Attribute grammar]]", "[[Backus–Naur form]]", "[[Basic block]]"]
---
