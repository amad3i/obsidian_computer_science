---
title: "Nondeterministic programming"
tags: ["cs", "programming-languages", "intermediate"]
domain: Programming & Languages
level: intermediate
source: "https://en.wikipedia.org/wiki/Nondeterministic_programming"
wikipedia_categories: ["Computer programming", "Determinism", "Programming paradigms"]
related: ["[[Algorave]]", "[[Array programming]]", "[[Aspect-oriented programming]]", "[[Asynchronous procedure call]]", "[[Asynchrony (computer programming)]]", "[[Attribute-oriented programming]]", "[[Automata-based programming]]", "[[Automata-based programming (Shalyto's approach)]]", "[[Automatic programming]]", "[[Bayesian program synthesis]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Nondeterministic_programming