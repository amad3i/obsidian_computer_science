...
wikipedia_categories: ["Concurrent programming languages", "Cross-platform free software", "Free and open source compilers", "Free software programmed in Scala", "Functional languages", "JVM programming languages", "Java programming language family", "Object-oriented programming languages"]
related: ["[[Gosu (programming language)]]", "[[Apache Groovy]]", "[[Ateji PX]]", "[[Ciao (programming language)]]", "[[Crystal (programming language)]]", "[[Processing]]", "[[Umple]]", "[[V (programming language)]]", "[[Agda (programming language)]]", "[[AgentSheets]]"]
---
