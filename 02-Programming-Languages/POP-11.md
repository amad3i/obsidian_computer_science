...
level: intermediate
source: "https://en.wikipedia.org/wiki/POP-11"
wikipedia_categories: ["Artificial intelligence", "History of computing in the United Kingdom", "Lisp programming language family", "Science and technology in East Sussex", "University of Sussex"]
related: ["[[POP-2]]", "[[COWSEL]]", "[[-Lisp]]", "[[ai]]", "[[2025–present global memory supply shortage]]", "[[2026 OpenAI agent cyberattacks]]", "[[ACL2]]", "[[Actor-critic algorithm]]", "[[Admissible heuristic]]", "[[Agent harness]]"]
---
