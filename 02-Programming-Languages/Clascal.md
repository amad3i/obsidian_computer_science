...
level: intermediate
source: "https://en.wikipedia.org/wiki/Clascal"
wikipedia_categories: ["Class-based programming languages", "High-level programming languages", "Object-oriented programming languages", "Pascal programming language family", "Programming language topic stubs", "Programming languages", "Programming languages created in 1983"]
related: ["[[ABAP]]", "[[C++]]", "[[D (programming language)]]", "[[PHP]]", "[[Python (programming language)]]", "[[Apache Groovy]]", "[[Boo (programming language)]]", "[[C Sharp (programming language)]]", "[[CorbaScript]]", "[[DataFlex]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Clascal