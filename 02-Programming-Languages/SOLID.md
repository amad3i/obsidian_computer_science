...
wikipedia_categories: ["Computing acronyms", "Mnemonic acronyms", "Object-oriented programming", "Programming principles", "Software design"]
related: ["[[Interface segregation principle]]", "[[Open–closed principle]]", "[[Ambiguous viewpoint]]", "[[Command–query separation]]", "[[Convention over configuration]]", "[[Coupling (computer programming)]]", "[[Encapsulation (computer programming)]]", "[[Entity–control–boundary]]", "[[Hexagonal architecture (software)]]", "[[Information hiding]]"]
---
