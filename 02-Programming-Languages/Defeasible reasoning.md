...
level: intermediate
source: "https://en.wikipedia.org/wiki/Defeasible_reasoning"
wikipedia_categories: ["Belief revision", "Concepts in logic", "Logic programming", "Philosophy of logic", "Reasoning"]
related: ["[[Abductive reasoning]]", "[[Belief revision]]", "[[Primitive notion]]", "[[Substitution (logic)]]", "[[Syntax (logic)]]", "[[Term logic]]", "[[Abductive logic programming]]", "[[Absoluteness (logic)]]", "[[Advice taker]]", "[[Answer set programming]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Defeasible_reasoning