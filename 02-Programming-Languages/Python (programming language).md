...
wikipedia_categories: ["Class-based programming languages", "Computer science in the Netherlands", "Concurrent programming languages", "Cross-platform free software", "Cross-platform software", "Dutch inventions", "Dynamically typed programming languages", "Educational programming languages"]
related: ["[[AgentSheets]]", "[[Squeak]]", "[[Apache Groovy]]", "[[Ballerina (programming language)]]", "[[Ciao (programming language)]]", "[[Clojure]]", "[[Crystal (programming language)]]", "[[Erlang (programming language)]]", "[[Go (programming language)]]", "[[Lasso (programming language)]]"]
---
