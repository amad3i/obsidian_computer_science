...
level: intermediate
source: "https://en.wikipedia.org/wiki/Subject-oriented_programming"
wikipedia_categories: ["Aspect-oriented software development", "Eclipse (software)", "Object-oriented programming", "Programming paradigms"]
related: ["[[Aspect-oriented programming]]", "[[AspectJ]]", "[[Concurrent object-oriented programming]]", "[[Franca IDL]]", "[[Prototype-based programming]]", "[[Abstraction (computer science)]]", "[[Ambiguous viewpoint]]", "[[Array programming]]", "[[ASCEND]]", "[[Aspect weaver]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Subject-oriented_programming