...
level: intermediate
source: "https://en.wikipedia.org/wiki/Portable_Standard_Lisp"
wikipedia_categories: ["Concurrent programming languages", "Dynamically typed programming languages", "Functional languages", "Lisp programming language family", "Multi-paradigm programming languages"]
related: ["[[-Lisp]]", "[[MultiLisp]]", "[[Julia (programming language)]]", "[[CMS Pipelines]]", "[[Erlang (programming language)]]", "[[Gleam (programming language)]]", "[[J (programming language)]]", "[[Lisp (programming language)]]", "[[Logo (programming language)]]", "[[NewLISP]]"]
---
