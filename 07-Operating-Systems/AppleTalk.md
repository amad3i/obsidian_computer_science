...
level: intermediate
source: "https://en.wikipedia.org/wiki/AppleTalk"
wikipedia_categories: ["Apple Inc. software", "Network operating systems", "Network protocols"]
related: ["[[Bonjour Sleep Proxy]]", "[[Data Stream Interface]]", "[[LANtastic]]", "[[Access stratum]]", "[[Acknowledgement (data networks)]]", "[[Alternating bit protocol]]", "[[AMX192]]", "[[Apple Filing Protocol]]", "[[Apple Media Tool]]", "[[AppleScript]]"]
---
...
The rise of TCP/IP during the 1990s led to a reimplementation of most of these types of support on that protocol, and AppleTalk became unsupported as of the release of Mac OS X Snow Leopard in 2009. Many of AppleTalk's more advanced autoconfiguration features have since been introduced in Bonjour, while Universal Plug and Play serves similar needs.
