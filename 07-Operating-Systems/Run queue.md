...
level: intermediate
source: "https://en.wikipedia.org/wiki/Run_queue"
wikipedia_categories: ["Linux kernel", "Scheduling (computing)"]
related: ["[[Blocking (computing)]]", "[[BogoMips]]", "[[Boot folder]]", "[[Booting process of Linux]]", "[[Configuration Menu Language]]", "[[Copy Fail]]", "[[Cryptoloop]]", "[[Debugfs]]", "[[Dirty COW]]", "[[Dprobes]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Run_queue