...
wikipedia_categories: ["Application programming interfaces", "Operating system technology", "System calls"]
related: ["[[Sysctl]]", "[[Application binary interface]]", "[[Binary Application Markup Language]]", "[[Busdma]]", "[[FreeBSD jail]]", "[[Kqueue]]", "[[ALTQ]]", "[[API]]", "[[Apptainer]]", "[[Asynchronous system trap]]"]
---
