...
level: intermediate
source: "https://en.wikipedia.org/wiki/Open_system_(computing)"
wikipedia_categories: ["Computer systems", "History of computing", "Open standards", "Unix history"]
related: ["[[1984 (advertisement)]]", "[[3D Content Retrieval]]", "[[Actor model later history]]", "[[Actor model middle history]]", "[[Adding machine]]", "[[Advanced Message Queuing Protocol]]", "[[Akoma Ntoso]]", "[[Aladdin (BlackRock)]]", "[[Alert correlation]]", "[[Algorithms + Data Structures = Programs]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Open_system_(computing)