...
wikipedia_categories: ["1969 software", "Operating system families", "Products introduced in 1969", "Time-sharing operating systems", "Unix"]
related: ["[[Unix-like]]", "[[ACM SIGOPS Annual Technical Conference]]", "[[Gecos field]]", "[[Group identifier]]", "[[IBM Remote Access Computing]]", "[[Input Field Separators]]", "[[Ioctl]]", "[[Job control (Unix)]]", "[[Ldconfig]]", "[[Line discipline]]"]
---

# Unix

Unix ( , YOO-niks; trademarked as UNIX) is a family of multitasking, multi-user computer operating systems that derive from the original AT&T Unix, the development of which started in 1969 at the Bell Labs research center by Ken Thompson, Dennis Ritchie, and others. Initially intended for use inside the Bell System, AT&T licensed Unix to outside parties in the late 1970s, leading to a variety of both academic and commercial Unix variants from vendors including University of California, Berkeley (BSD), Microsoft (Xenix), Sun Microsystems (SunOS/Solaris), HP/HPE (HP-UX), and IBM (AIX).
...
Unix was mentioned in the 1994 film Jurassic Park as the operating system behind park facilities. There is debate about how Unix is portrayed visually on the computer screen within the film.
