...
level: intermediate
source: "https://en.wikipedia.org/wiki/Xgrid"
wikipedia_categories: ["Apple Inc. software", "Cluster computing", "Grid computing", "Job scheduling", "MacOS Server", "Proprietary software"]
related: ["[[Oracle Grid Engine]]", "[[Slurm Workload Manager]]", "[[AppleScript]]", "[[Beowulf cluster]]", "[[HTCondor]]", "[[IBM Spectrum LSF]]", "[[MOSIX]]", "[[OpenHPC]]", "[[OpenLava]]", "[[Pilot job]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Xgrid