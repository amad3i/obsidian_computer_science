...
wikipedia_categories: ["Servers (computing)", "Virtualization software"]
related: ["[[AiScaler]]", "[[Application server]]", "[[Apptainer]]", "[[Authentication server]]", "[[Autoscaling]]", "[[Citrix Virtual Apps]]", "[[Client–server model]]", "[[Colocation centre]]", "[[Common Gateway Interface]]", "[[Daemon (computing)]]"]
---
