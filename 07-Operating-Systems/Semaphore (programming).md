...
wikipedia_categories: ["Computer-mediated communication", "Concurrency (computer science)", "Concurrency control", "Dutch inventions", "Edsger W. Dijkstra", "Parallel computing", "Synchronization"]
related: ["[[Barrier (computer science)]]", "[[Language of Temporal Ordering Specification]]", "[[Synchronization (computer science)]]", "[[Advanced Synchronization Facility]]", "[[Asynchronous communication mechanism]]", "[[Dijkstra's algorithm]]", "[[Speculative multithreading]]", "[[Transactional Synchronization Extensions]]", "[[ABIT BP6]]", "[[ACID]]"]
---
...
Downey, Allen B. (2016) . "The Little Book of Semaphores" (2nd ed.). Green Tea Press.
