...
wikipedia_categories: ["Concurrent computing", "Operating system technology", "Process (computing)"]
related: ["[[Chain loading]]", "[[Computer multitasking]]", "[[Concurrent computing]]", "[[Coprocess]]", "[[Cyclic executive]]", "[[Preemption (computing)]]", "[[Process management (computing)]]", "[[Yield (multithreading)]]", "[[Actor model]]", "[[ALTQ]]"]
---
...
== Further reading ==
Lauer, Hugh; Needham, Roger (October 1978). "On the Duality of Operating System Structures". Proc. Second International Symposium on Operating Systems. IRIA. [Historic paper classifying multi-process OS architectures into two dual categories.]
