...
level: intermediate
source: "https://en.wikipedia.org/wiki/Web3D_Consortium"
wikipedia_categories: ["Computer graphics organizations", "Graphics standards", "ISO standards", "Markup languages", "Mountain View, California", "Virtual reality organizations"]
related: ["[[Encoded Archival Description]]", "[[Graphical Kernel System]]", "[[ISO 12083]]", "[[JSON]]", "[[Observations and Measurements]]", "[[OpenDocument standardization]]", "[[Standard Generalized Markup Language]]", "[[Standardization of Office Open XML]]", "[[3DML]]", "[[AAP DTD]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Web3D_Consortium