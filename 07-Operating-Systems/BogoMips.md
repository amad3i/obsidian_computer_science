...
wikipedia_categories: ["Benchmarks (computing)", "Linux kernel"]
related: ["[[Algorithmic qubits]]", "[[Boot folder]]", "[[Booting process of Linux]]", "[[Byte Sieve]]", "[[Configuration Menu Language]]", "[[Copy Fail]]", "[[Coremark]]", "[[Creative Computing Benchmark]]", "[[Cryptoloop]]", "[[Debugfs]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/BogoMips