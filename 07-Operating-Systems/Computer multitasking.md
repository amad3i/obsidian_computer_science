...
related: ["[[Concurrent computing]]", "[[Cyclic executive]]", "[[Preemption (computing)]]", "[[Process (computing)]]", "[[Yield (multithreading)]]", "[[Actor model]]", "[[ALTQ]]", "[[Application binary interface]]", "[[Apptainer]]", "[[Asynchronous system trap]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Computer_multitasking