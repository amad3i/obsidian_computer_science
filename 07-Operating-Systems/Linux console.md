...
level: intermediate
source: "https://en.wikipedia.org/wiki/Linux_console"
wikipedia_categories: ["Computer terminals", "Linux kernel", "Text user interface"]
related: ["[[BogoMips]]", "[[Boot folder]]", "[[Booting process of Linux]]", "[[Computer terminal]]", "[[Configuration Menu Language]]", "[[Copy Fail]]", "[[Cryptoloop]]", "[[Debugfs]]", "[[Delete character]]", "[[Dirty COW]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Linux_console