...
wikipedia_categories: ["Operating systems"]
...
As of October 2025, metrics for web traffic show that Android is the most popular operating system used to connect to the web, with a 38% share, followed by Microsoft Windows at 31%, iOS and iPadOS at 15%, macOS at 7%, and Linux at 1%. Android, iOS, and iPadOS are mobile operating systems, while Windows, macOS, and Linux are desktop operating systems.
