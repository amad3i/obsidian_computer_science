...
wikipedia_categories: ["Computer file systems", "Computer files", "Inter-process communication"]
related: ["[[Archive file]]", "[[Data set (IBM mainframe)]]", "[[Filename mangling]]", "[[Access method]]", "[[Advanced Message Queuing Protocol]]", "[[Allocate-on-flush]]", "[[Apple File System]]", "[[Apple Partition Map]]", "[[Archive bit]]", "[[ARexx]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Computer_file