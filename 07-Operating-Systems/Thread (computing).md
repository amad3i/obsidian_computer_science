...
wikipedia_categories: ["Concurrent computing", "Threads (computing)"]
related: ["[[Concurrent object-oriented programming]]", "[[Thread pool]]", "[[Yield (multithreading)]]", "[[Actor model]]", "[[Asynchronous method invocation]]", "[[Cache coherence]]", "[[Choreographic programming]]", "[[Code cave]]", "[[Communicating sequential processes]]", "[[Computer cluster]]"]
---
...
The Mach implementation of threads was described in the summer of 1986. OS/2 1.0, released in 1987, supported threads. Digital Research's MP/M operating system provided multiprogramming, multi-tasking, and preemptive multi-tasking for the Intel 8080 processor in 1979, and on the 8086 processor in 1981. The first version of Windows to have threads was Windows NT, which was released in 1993.
...
If all threads are busy, additional work items are placed in a queue until a thread becomes available to execute them.
