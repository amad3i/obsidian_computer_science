...
wikipedia_categories: ["2021 software", "ARM operating systems", "Android (operating system)", "Microsoft Windows", "Proprietary operating systems", "Tablet operating systems", "Windows 11"]
related: ["[[Windows 10]]", "[[Windows 8]]", "[[Windows 8.1]]", "[[Android Team Awareness Kit]]", "[[ArkTS]]", "[[BitClout]]", "[[ERIKA Enterprise]]", "[[Glass OS]]", "[[GLM (AI)]]", "[[Kernel Assisted Superuser]]"]
---
