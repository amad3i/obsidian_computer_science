...
wikipedia_categories: ["Computer network technology", "Data transmission", "Network protocols", "Packets (information technology)"]
related: ["[[Acknowledgement (data networks)]]", "[[Cell relay]]", "[[Communication protocol]]", "[[Comparison of MQTT implementations]]", "[[Digital Audio Access Protocol]]", "[[Digital Media Access Protocol]]", "[[Handshake (computing)]]", "[[Identity Registration Protocol]]", "[[IF-MAP]]", "[[List of packet-switched networks]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Encapsulation_(networking)