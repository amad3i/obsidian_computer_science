...
level: intermediate
source: "https://en.wikipedia.org/wiki/Protected_computer"
wikipedia_categories: ["Computer law", "Computer network security", "United States federal criminal legislation"]
related: ["[[3-subset meet-in-the-middle attack]]", "[[ACARM-ng]]", "[[Administrative domain]]", "[[AEGIS SecureConnect]]", "[[Alliance for Creativity and Entertainment]]", "[[Anomaly-based intrusion detection system]]", "[[Application Defined Network]]", "[[Application-level gateway]]", "[[Artificial intelligence and copyright]]", "[[Associated Signature Containers]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Protected_computer