...
wikipedia_categories: ["Applications of distributed computing", "Data management", "Database management systems", "Distributed computing architecture", "Types of databases"]
related: ["[[Multi-model database]]", "[[Couchbase Server]]", "[[Document-oriented database]]", "[[Aggregate Level Simulation Protocol]]", "[[Commit (data management)]]", "[[Concurrency control]]", "[[Data Analysis Expressions]]", "[[Data center]]", "[[Data hub]]", "[[Database administration]]"]
---
