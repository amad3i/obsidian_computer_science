...
wikipedia_categories: ["IP addresses", "Internet architecture"]
related: ["[[Classful network]]", "[[Classless Inter-Domain Routing]]", "[[IPv4 address exhaustion]]", "[[Localhost]]", "[[Subnet]]", "[[Wildcard mask]]", "[[6bone]]", "[[Adaptive quality of service multi-hop routing]]", "[[Address pool]]", "[[AiScaler]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Private_network