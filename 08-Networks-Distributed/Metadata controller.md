---
title: "Metadata controller"
tags: ["cs", "networks-distributed", "intermediate"]
domain: Networks & Distributed
level: intermediate
source: "https://en.wikipedia.org/wiki/Metadata_controller"
wikipedia_categories: ["Computer storage stubs", "Data management", "Local area networks", "Storage area networks", "Telecommunications engineering"]
related: ["[[Storage area network]]", "[[VSAN]]", "[[Clustered file system]]", "[[DMAPI]]", "[[Dynamic knowledge repository]]", "[[Storage model]]", "[[Abstraction (computer science)]]", "[[Adaptive quality of service multi-hop routing]]", "[[Address space]]", "[[ADO.NET]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Metadata_controller