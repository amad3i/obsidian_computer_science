...
level: intermediate
source: "https://en.wikipedia.org/wiki/Host_model"
wikipedia_categories: ["Computer networking", "Internet protocols"]
related: ["[[Connection-oriented communication]]", "[[Connectionless communication]]", "[[Domain Name System]]", "[[Named data networking]]", "[[QUIC]]", "[[Tor (network)]]", "[[Tsunami UDP Protocol]]", "[[Application Defined Network]]", "[[Asynchronous Layered Coding]]", "[[Automatic Certificate Management Environment]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Host_model