...
wikipedia_categories: ["1911 establishments in New York (state)", "American companies established in 1911", "Cloud computing providers", "Collier Trophy recipients", "Companies based in Westchester County, New York", "Companies in the Dow Jones Global Titans 50", "Companies in the Dow Jones Industrial Average", "Companies in the S&P 500 Dividend Aristocrats"]
related: ["[[Microsoft]]", "[[Alphabet Inc]]", "[[Alibaba Cloud]]", "[[Amazon Elastic Compute Cloud]]", "[[Aptum Technologies]]", "[[Azure Data Lake]]", "[[Azure Stream Analytics]]", "[[Citrix Cloud]]", "[[Cloud Foundry]]", "[[Garmin]]"]
---
