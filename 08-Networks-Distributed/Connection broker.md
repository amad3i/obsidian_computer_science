...
wikipedia_categories: ["Distributed computing architecture", "Software architecture", "Software engineering stubs"]
related: ["[[Active reviews for intermediate designs]]", "[[Bulkhead pattern]]", "[[Common Component Architecture]]", "[[Darwin (ADL)]]", "[[Database-centric architecture]]", "[[GemStone-S]]", "[[Monolithic application]]", "[[Multitier architecture]]", "[[Presentation logic]]", "[[Reference architecture]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Connection_broker