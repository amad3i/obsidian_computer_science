...
level: intermediate
source: "https://en.wikipedia.org/wiki/Database-centric_architecture"
wikipedia_categories: ["Data management", "Distributed computing architecture", "Software architecture"]
related: ["[[Bulkhead pattern]]", "[[Connection broker]]", "[[Couchbase Server]]", "[[Distributed database]]", "[[GemStone-S]]", "[[Linked data]]", "[[Multi-model database]]", "[[Multitier architecture]]", "[[SciDB]]", "[[Shared-disk architecture]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Database-centric_architecture