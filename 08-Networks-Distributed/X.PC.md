...
level: intermediate
source: "https://en.wikipedia.org/wiki/X.PC"
wikipedia_categories: ["Network protocols", "Telecommunications stubs", "X.25"]
related: ["[[BIP-8]]", "[[Coloured Book protocols]]", "[[Protocol Wars]]", "[[Route reestablishment notification]]", "[[SPI-3]]", "[[Terminal Identifier – Address Resolution Protocol]]", "[[Access stratum]]", "[[Acknowledgement (data networks)]]", "[[Adaptive predictive coding]]", "[[Alternating bit protocol]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/X.PC