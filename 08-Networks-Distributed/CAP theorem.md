...
wikipedia_categories: ["Database management systems", "Distributed computing"]
related: ["[[PACELC design principle]]", "[[ACID]]", "[[ActivityPub]]", "[[ANSI-SPARC Architecture]]", "[[Armstrong's axioms]]", "[[Array DBMS]]", "[[AT Protocol]]", "[[AutoNumber]]", "[[Availability zone]]", "[[Azure Data Explorer]]"]
---
