---
title: "Ethernet over SDH"
tags: ["cs", "networks-distributed", "intermediate"]
domain: Networks & Distributed
level: intermediate
source: "https://en.wikipedia.org/wiki/Ethernet_over_SDH"
wikipedia_categories: ["Computer network stubs", "Ethernet", "Network protocols", "Synchronous optical networking"]
related: ["[[Multiwavelength optical networking]]", "[[Virtual Link Aggregation Control Protocol]]", "[[ATA over Ethernet]]", "[[Autonegotiation]]", "[[Available bit rate]]", "[[Bandwidth allocation protocol]]", "[[BatiBUS]]", "[[Bearer-Independent Call Control]]", "[[Common Industrial Protocol]]", "[[Constraint-based Routing Label Distribution Protocol]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Ethernet_over_SDH