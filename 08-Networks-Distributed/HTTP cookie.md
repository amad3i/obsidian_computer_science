...
wikipedia_categories: ["Computer access control", "Hacking (computer security)", "Hypertext Transfer Protocol headers", "Internet Standards", "Internet privacy", "Metaphors referring to food and drink", "Privacy", "Tracking"]
related: ["[[Third-party cookies]]", "[[Web tracking]]", "[[Client Hints]]", "[[Cross-device tracking]]", "[[Cross-site leaks]]", "[[CSS fingerprinting]]", "[[Data re-identification]]", "[[Device fingerprint]]", "[[DNS hijacking]]", "[[Do Not Track]]"]
---
