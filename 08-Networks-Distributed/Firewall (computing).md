...
wikipedia_categories: ["American inventions", "Cyberwarfare", "Data security", "Firewall software", "Metaphors referring to objects", "Network management", "Packets (information technology)"]
related: ["[[Stateful firewall]]", "[[Adaptive redaction]]", "[[Anomaly detection]]", "[[Autoscaling]]", "[[Backup]]", "[[BASIC]]", "[[Berserk Bear]]", "[[Bidirectional Forwarding Detection]]", "[[Biological pacemaker]]", "[[Bionic contact lens]]"]
---
...
A History and Survey of Network Firewalls Archived 2017-08-30 at the Wayback Machine – provides an overview of firewalls at various ISO levels, with references to original papers where early firewall work was reported.
