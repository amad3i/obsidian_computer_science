---
title: "National Cyber Range Complex"
tags: ["cs", "networks-distributed", "intermediate"]
domain: Networks & Distributed
level: intermediate
source: "https://en.wikipedia.org/wiki/National_Cyber_Range_Complex"
wikipedia_categories: ["Computer network security", "Cyber ranges", "Internet stubs", "National cyber security centres", "United States Department of Defense"]
related: ["[[Cyber range]]", "[[Interest Flooding Attack]]", "[[Terrapin attack]]", "[[3-subset meet-in-the-middle attack]]", "[[ACARM-ng]]", "[[Address pool]]", "[[Administrative domain]]", "[[AEGIS SecureConnect]]", "[[Anomaly-based intrusion detection system]]", "[[Application Defined Network]]"]
---
...
The NCRC has cyber range facilities in multiple locations, including Orlando, FL; Charleston, SC; Fort Walton Beach, FL; Patuxent River, MD; Huntsville, AL; Augusta, GA; and Oahu, HI.
...
- Wikipedia: https://en.wikipedia.org/wiki/National_Cyber_Range_Complex