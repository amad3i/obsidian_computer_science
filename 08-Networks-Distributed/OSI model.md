...
wikipedia_categories: ["Computer-related introductions in 1977", "ISO/IEC 7498", "ISO standards", "ITU-T X Series Recommendations", "ITU-T recommendations", "OSI model", "Reference models"]
related: ["[[RM-ODP]]", "[[Security service (telecommunication)]]", "[[Dublin Core]]", "[[X.1035]]", "[[ATM Adaptation Layer 2]]", "[[Basic Formal Ontology]]", "[[Business reference model]]", "[[C Sharp (programming language)]]", "[[Common Object Request Broker Architecture]]", "[[Core architecture data model]]"]
---
...
"ISO/IEC standard 7498-1:1994 - Service definition for the association control service element". ISO Standards Maintenance Portal. ISO. Retrieved 12 July 2024.  (PDF document inside ZIP archive) (requires HTTP cookies in order to accept licence agreement)
...
EdXD; Saikot, Mahmud Hasan (25 November 2021). "7 Layers of OSI Model Explained". ByteXD. Retrieved 12 July 2024.
