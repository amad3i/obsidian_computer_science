...
level: intermediate
source: "https://en.wikipedia.org/wiki/Libraries.io"
wikipedia_categories: ["Code search engines", "Free software websites", "Internet properties established in 2015", "Software metrics"]
related: ["[[Open Hub]]", "[[ABC Software Metric]]", "[[Azure DevOps Server]]", "[[Bauhaus Project (computing)]]", "[[Cockburn Scale]]", "[[Code coverage]]", "[[Cohesion (computer science)]]", "[[COSMIC functional size measurement]]", "[[Coupling (computer programming)]]", "[[Cppdepend]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Libraries.io