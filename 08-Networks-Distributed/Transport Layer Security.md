...
wikipedia_categories: ["Cryptographic protocols", "Internet properties established in 1999", "Presentation layer protocols", "Transport Layer Security"]
related: ["[[HTTPS]]", "[[OCSP stapling]]", "[[Online Certificate Status Protocol]]", "[[Apple Filing Protocol]]", "[[Application-Layer Protocol Negotiation]]", "[[AS1 (networking)]]", "[[AS2]]", "[[BREACH]]", "[[CCMP (cryptography)]]", "[[Certificate Management over CMS]]"]
---
...
RFC 8446 – "The Transport Layer Security (TLS) Protocol Version 1.3," Proposed Standard.
