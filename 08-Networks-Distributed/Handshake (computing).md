---
title: "Handshake (computing)"
tags: ["cs", "networks-distributed", "intermediate"]
domain: Networks & Distributed
level: intermediate
source: "https://en.wikipedia.org/wiki/Handshake_(computing)"
wikipedia_categories: ["Data transmission", "Network architecture", "Network protocols"]
related: ["[[Acknowledgement (data networks)]]", "[[Communication protocol]]", "[[Comparison of MQTT implementations]]", "[[Delay-tolerant networking]]", "[[Digital Audio Access Protocol]]", "[[Digital Media Access Protocol]]", "[[Encapsulation (networking)]]", "[[Hop-by-hop transport]]", "[[Identity Registration Protocol]]", "[[IF-MAP]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Handshake_(computing)