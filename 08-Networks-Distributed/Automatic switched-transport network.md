---
title: "Automatic switched-transport network"
tags: ["cs", "networks-distributed", "intermediate"]
domain: Networks & Distributed
level: intermediate
source: "https://en.wikipedia.org/wiki/Automatic_switched-transport_network"
wikipedia_categories: ["Internet Standards", "MPLS networking", "Network protocols", "Telephony"]
related: ["[[MPLS-TP]]", "[[Router alert label]]", "[[T-MPLS]]", "[[Constrained Shortest Path First]]", "[[Constraint-based Routing Label Distribution Protocol]]", "[[Domain Name System]]", "[[G.9963]]", "[[G.9970]]", "[[G.hn]]", "[[Generalized Multi-Protocol Label Switching]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Automatic_switched-transport_network