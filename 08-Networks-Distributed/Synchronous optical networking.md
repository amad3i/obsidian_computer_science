...
level: intermediate
source: "https://en.wikipedia.org/wiki/Synchronous_optical_networking"
wikipedia_categories: ["Fiber-optic communications", "ITU-T G Series Recommendations", "ITU-T recommendations", "Network protocols", "Synchronous optical networking"]
related: ["[[G.9963]]", "[[G.9970]]", "[[G.9972]]", "[[G.hn]]", "[[Multiwavelength optical networking]]", "[[ATM Adaptation Layer 2]]", "[[Automatically switched optical network]]", "[[Ethernet over SDH]]", "[[Optical burst switching]]", "[[Optical mesh network]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Synchronous_optical_networking