...
level: intermediate
source: "https://en.wikipedia.org/wiki/Port_Control_Protocol"
wikipedia_categories: ["Internet protocols", "Network address translation", "Network protocols"]
related: ["[[Traversal Using Relays around NAT]]", "[[BEEP]]", "[[Connection-oriented communication]]", "[[Connectionless communication]]", "[[Constrained Shortest Path First]]", "[[Domain Name System]]", "[[Forward-confirmed reverse DNS]]", "[[GPSoverIP]]", "[[Internet Fibre Channel Protocol]]", "[[Internet Gateway Device Protocol]]"]
---
...
In environments where NAT64 is deployed, PCP allows a host to learn the IPv6 prefix(es) used by a PCP-controlled NAT64 device to build IPv4-converted IPv6 addresses by the NAT64 (RFC7225).
...
- Wikipedia: https://en.wikipedia.org/wiki/Port_Control_Protocol