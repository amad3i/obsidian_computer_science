...
wikipedia_categories: ["Application layer protocols", "Hypertext Transfer Protocol", "Internet properties established in 1991", "World Wide Web Consortium standards"]
related: ["[[Variant object]]", "[[WebDAV]]", "[[XML]]", "[[Advanced Message Queuing Protocol]]", "[[Aggregate Level Simulation Protocol]]", "[[Border Gateway Protocol]]", "[[Client–server model]]", "[[Comparison of MQTT implementations]]", "[[Composite Capability-Preference Profiles]]", "[[CryptoNote]]"]
---
