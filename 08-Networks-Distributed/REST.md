...
wikipedia_categories: ["Cloud standards", "Hypertext Transfer Protocol", "Software architecture", "Web 2.0 neologisms"]
related: ["[[Domain application protocol]]", "[[Learning Tools Interoperability]]", "[[Mashup (web application hybrid)]]", "[[Overview of RESTful API Description Languages]]", "[[Web API]]", "[[Web of Things]]", "[[4+1 architectural view model]]", "[[Active reviews for intermediate designs]]", "[[Agent architecture]]", "[[Anemic domain model]]"]
---
