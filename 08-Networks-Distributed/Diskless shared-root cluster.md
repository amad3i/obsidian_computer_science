---
title: "Diskless shared-root cluster"
tags: ["cs", "networks-distributed", "intermediate"]
domain: Networks & Distributed
level: intermediate
source: "https://en.wikipedia.org/wiki/Diskless_shared-root_cluster"
wikipedia_categories: ["Cluster computing", "Computer networking", "Parallel computing"]
related: ["[[Aiyara cluster]]", "[[Alewife (multiprocessor)]]", "[[Beowulf cluster]]", "[[Cluster manager]]", "[[Computer cluster]]", "[[Distributed R]]", "[[History of computer clusters]]", "[[IBM Parallel Sysplex]]", "[[MOSIX]]", "[[Network on a chip]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Diskless_shared-root_cluster