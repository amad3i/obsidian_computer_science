...
wikipedia_categories: ["Computer-related introductions in 1980", "Internet Standards", "Internet protocols", "Transport layer protocols"]
related: ["[[Fast and Secure Protocol]]", "[[SCTP packet structure]]", "[[Usenet]]", "[[Xpress Transport Protocol]]", "[[Berkeley r-commands]]", "[[Bidirectional Forwarding Detection]]", "[[Bootstrap Protocol]]", "[[Border Gateway Multicast Protocol]]", "[[Border Gateway Protocol]]", "[[Certificate Management over CMS]]"]
---
...
Checksum: 16 bits
The checksum field may be used for error-checking of the header and data. This field is optional in IPv4, and mandatory in most cases in IPv6.
Data: Variable
...
The final destination; if the IPv6 packet does not contain a Routing header, UDP uses the destination address in the IPv6 header, otherwise, at the originating node, it uses the address in the last element of the Routing header, and, at the receiving node, it uses the destination address in the IPv6 header.
UDP length: 32 bits
The length of the UDP header and data (measured in octets).
...
== Standards ==
RFC 9868 – User Datagram Protocol
...
Breakdown of UDP frame Archived 22 January 2009 at the Wayback Machine
