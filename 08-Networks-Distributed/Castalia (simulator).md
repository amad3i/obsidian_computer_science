...
level: intermediate
source: "https://en.wikipedia.org/wiki/Castalia_(simulator)"
wikipedia_categories: ["Computer network analysis", "Simulation software stubs", "Wireless networking"]
related: ["[[GloMoSim]]", "[[QualNet]]", "[[2016 United States wireless spectrum auction]]", "[[Ad hoc wireless distribution service]]", "[[Air2Web]]", "[[AirHop Communications]]", "[[Andrea Goldsmith (engineer)]]", "[[Augmented tree-based routing]]", "[[Backhaul (telecommunications)]]", "[[Barker code]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Castalia_(simulator)