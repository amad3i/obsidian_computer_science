...
level: intermediate
source: "https://en.wikipedia.org/wiki/Real-time_adaptive_security"
wikipedia_categories: ["Computer network security", "System administration"]
related: ["[[DDoS mitigation]]", "[[Intrusion detection system]]", "[[3-subset meet-in-the-middle attack]]", "[[ACARM-ng]]", "[[Administrative domain]]", "[[AEGIS SecureConnect]]", "[[Anomaly-based intrusion detection system]]", "[[Application Defined Network]]", "[[Application-level gateway]]", "[[Attack tree]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Real-time_adaptive_security