...
level: intermediate
source: "https://en.wikipedia.org/wiki/Forward-confirmed_reverse_DNS"
wikipedia_categories: ["Domain Name System", "Email authentication", "Internet protocols", "Network protocols"]
related: ["[[Domain Name System]]", "[[Link-Local Multicast Name Resolution]]", "[[BEEP]]", "[[Bonjour Sleep Proxy]]", "[[Connection-oriented communication]]", "[[Connectionless communication]]", "[[Constrained Shortest Path First]]", "[[DNS over HTTPS]]", "[[DNS over TLS]]", "[[DNSCrypt]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Forward-confirmed_reverse_DNS