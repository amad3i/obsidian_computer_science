...
level: intermediate
source: "https://en.wikipedia.org/wiki/Bidirectional_Forwarding_Detection"
wikipedia_categories: ["Internet Standards", "Internet protocols", "Network management"]
related: ["[[MIMIC Simulator]]", "[[NETCONF]]", "[[Rsyslog]]", "[[Simple Network Management Protocol]]", "[[Syslog]]", "[[Syslog-ng]]", "[[Berkeley r-commands]]", "[[Bootstrap Protocol]]", "[[Border Gateway Multicast Protocol]]", "[[Border Gateway Protocol]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Bidirectional_Forwarding_Detection