...
wikipedia_categories: ["Internet architecture", "Routing protocols"]
related: ["[[Border Gateway Multicast Protocol]]", "[[Border Gateway Protocol]]", "[[EraMobile]]", "[[Resource Public Key Infrastructure]]", "[[6bone]]", "[[Acknowledgement (data networks)]]", "[[Adaptive quality of service multi-hop routing]]", "[[Address pool]]", "[[AiScaler]]", "[[Any-source multicast]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Longest_prefix_match