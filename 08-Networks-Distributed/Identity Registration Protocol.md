---
title: "Identity Registration Protocol"
tags: ["cs", "networks-distributed", "intermediate"]
domain: Networks & Distributed
level: intermediate
source: "https://en.wikipedia.org/wiki/Identity_Registration_Protocol"
wikipedia_categories: ["Data transmission", "Internet stubs", "Network protocols"]
related: ["[[Acknowledgement (data networks)]]", "[[Communication protocol]]", "[[Comparison of MQTT implementations]]", "[[Digital Audio Access Protocol]]", "[[Digital Media Access Protocol]]", "[[Encapsulation (networking)]]", "[[Handshake (computing)]]", "[[IF-MAP]]", "[[MQTT]]", "[[Remote Audio Output Protocol]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Identity_Registration_Protocol