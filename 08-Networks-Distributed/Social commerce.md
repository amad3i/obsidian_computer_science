...
level: intermediate
source: "https://en.wikipedia.org/wiki/Social_commerce"
wikipedia_categories: ["Collaboration", "E-commerce", "Social media", "Social networks"]
related: ["[[Social profiling]]", "[[Trust management (managerial science)]]", "[[Abandonment rate]]", "[[Abdullah bin Ibrahim Al-Saleh]]", "[[AdsML]]", "[[Agentic commerce]]", "[[Algorithmic amplification]]", "[[Amazon China]]", "[[Amazon Effect]]", "[[AMiner (database)]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Social_commerce