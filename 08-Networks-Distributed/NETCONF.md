...
wikipedia_categories: ["Application layer protocols", "Internet Standards", "Internet protocols", "Network management", "System administration"]
related: ["[[MIMIC Simulator]]", "[[Simple Network Management Protocol]]", "[[Net-SNMP]]", "[[Rsyslog]]", "[[Syslog]]", "[[Syslog-ng]]", "[[Bidirectional Forwarding Detection]]", "[[Border Gateway Protocol]]", "[[Domain Name System]]", "[[GPSoverIP]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/NETCONF