...
level: core
source: "https://en.wikipedia.org/wiki/Grid_computing"
wikipedia_categories: ["Grid computing"]
related: ["[[Access Grid]]", "[[Altair Engineering]]", "[[CDDLM]]", "[[D-Grid]]", "[[Data Format Description Language]]", "[[DRMAA]]", "[[Dynamic infrastructure]]", "[[EMBRACE]]", "[[Global Information Grid]]", "[[Global Information Grid-Bandwidth Expansion]]"]
---
...
An earlier example of the notion of computing as a utility was in 1965 by MIT's Fernando Corbató. Corbató and the other designers of the Multics operating system envisioned a computer facility operating “like a power company or water company”.
...
- Wikipedia: https://en.wikipedia.org/wiki/Grid_computing