...
wikipedia_categories: ["Architectural pattern (computer science)", "Service-oriented (business computing)"]
related: ["[[Service-oriented architecture]]", "[[Action–domain–responder]]", "[[Active record pattern]]", "[[Architecture of Interoperable Information Systems]]", "[[Cloud-native computing]]", "[[Data access object]]", "[[Data mapper pattern]]", "[[Data transfer object]]", "[[Differentiated service]]", "[[Digital nervous system]]"]
---
