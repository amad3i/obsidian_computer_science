...
wikipedia_categories: ["Computer-related introductions in 1918", "Computer memory", "Digital electronics", "Digital systems", "Electronic engineering", "Logic gates"]
related: ["[[Shift register lookup table]]", "[[Random flip-flop]]", "[[AND gate]]", "[[C-element]]", "[[Computer module]]", "[[Logic optimization]]", "[[OR gate]]", "[[XOR gate]]", "[[2025–present global memory supply shortage]]", "[[AND-OR-invert]]"]
---
