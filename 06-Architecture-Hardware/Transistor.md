...
wikipedia_categories: ["1947 in computing", "1947 in technology", "20th-century inventions", "American inventions", "Bell Labs", "Computer-related introductions in 1947", "Electrical components", "Semiconductor devices"]
related: ["[[Integrated circuit]]", "[[Credit card]]", "[[Debit card]]", "[[ATM]]", "[[BASIC]]", "[[Biological pacemaker]]", "[[Bionic contact lens]]", "[[Bulletin board system]]", "[[Butler in a Box]]", "[[C (programming language)]]"]
---
...
IEEE Global History Network, The Transistor and Portable Electronics Archived February 14, 2015, at the Wayback Machine. All about the history of transistors and integrated circuits.
