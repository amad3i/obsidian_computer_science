...
wikipedia_categories: ["Memory management"]
related: ["[[bss]]", "[[Dispose pattern]]", "[[Finalizer]]", "[[Garbage collection (computer science)]]", "[[Memory management]]", "[[Memory management (operating systems)]]", "[[Pool (computer science)]]", "[[Resource allocation (computing)]]", "[[Write barrier]]"]
---
