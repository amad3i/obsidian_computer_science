---
title: "Red Storm (computing)"
tags: ["cs", "architecture-hardware", "intermediate"]
domain: Architecture & Hardware
level: intermediate
source: "https://en.wikipedia.org/wiki/Red_Storm_(computing)"
wikipedia_categories: ["Cray products", "Parallel computing", "United States Department of Energy", "X86 supercomputers"]
related: ["[[QPACE2]]", "[[Shaheen (supercomputer)]]", "[[ABIT BP6]]", "[[Advanced Synchronization Facility]]", "[[Aiyara cluster]]", "[[Alewife (multiprocessor)]]", "[[Algorithmic skeleton]]", "[[All nearest smaller values]]", "[[All-to-all (parallel pattern)]]", "[[AMD Instinct]]"]
---

# Red Storm (computing)

Red Storm was a supercomputer architecture designed for the US Department of Energy’s National Nuclear Security Administration Advanced Simulation and Computing Program. Cray, Inc developed it in 2004 based on the contracted architectural specifications provided by Sandia National Laboratories. The architecture was later commercially produced as the
Cray XT3.
...
- Wikipedia: https://en.wikipedia.org/wiki/Red_Storm_(computing)