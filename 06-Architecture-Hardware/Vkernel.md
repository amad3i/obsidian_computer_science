...
level: intermediate
source: "https://en.wikipedia.org/wiki/Vkernel"
wikipedia_categories: ["2006 software", "BSD software", "Computer architecture", "Computer performance", "DragonFly BSD", "Free software programmed in C", "Free virtualization software", "Operating system kernels"]
related: ["[[ALTQ]]", "[[FreeBSD jail]]", "[[Busdma]]", "[[Kqueue]]", "[[Linux-libre]]", "[[Soft updates]]", "[[Vinum volume manager]]", "[[Abstraction layer]]", "[[Address space]]", "[[Addressing mode]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Vkernel