...
level: advanced
source: "https://en.wikipedia.org/wiki/And-inverter_graph"
wikipedia_categories: ["Application-specific graphs", "Diagrams", "Electrical circuits", "Electronic design automation", "Formal methods"]
related: ["[[Asynchronous system]]", "[[1-in-3-SAT]]", "[[Boolean satisfiability problem]]", "[[Conceptual graph]]", "[[Satisfiability modulo theories]]", "[[State diagram]]", "[[Symbolic simulation]]", "[[Trace diagram]]", "[[XOR-SAT]]", "[[Abstract state machine]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/And-inverter_graph