...
level: intermediate
source: "https://en.wikipedia.org/wiki/Open_architecture"
wikipedia_categories: ["Computer architecture", "Open-source hardware", "Open standards", "Software architecture"]
related: ["[[Enterprise Mashup Markup Language]]", "[[Whitewater Interactive System Development with Object Models]]", "[[4+1 architectural view model]]", "[[Abstraction layer]]", "[[Active reviews for intermediate designs]]", "[[Address space]]", "[[Addressing mode]]", "[[Advanced Message Queuing Protocol]]", "[[Agent architecture]]", "[[Akoma Ntoso]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Open_architecture