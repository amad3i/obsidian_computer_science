...
related: ["[[Blocking (computing)]]", "[[Kernel preemption]]", "[[Light-weight process]]", "[[Makespan]]", "[[Resource allocation (computing)]]", "[[Run queue]]", "[[Schedule]]", "[[Scheduling (computing)]]", "[[Scheduling analysis real-time systems]]", "[[Server hog]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Idle_(CPU)