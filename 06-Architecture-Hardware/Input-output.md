...
wikipedia_categories: ["Input/output"]
related: ["[[Blocking (computing)]]", "[[Direct voice input]]", "[[General-Purpose Serial Interface]]", "[[Innovation SSI-2001]]", "[[Input method]]", "[[Predictive text]]", "[[Standard streams]]", "[[Swarachakra]]", "[[Text entry interface]]"]
---
