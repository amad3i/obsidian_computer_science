...
wikipedia_categories: ["Computer hardware", "Digital electronics"]
related: ["[[4D vector]]", "[[AMD XDNA]]", "[[AND gate]]", "[[ASRock M8]]", "[[B5000 instruction set]]", "[[Behavior tree (artificial intelligence, robotics and control)]]", "[[Bitwise ternary logic instruction]]", "[[Bus (computing)]]", "[[C-element]]", "[[Cache hierarchy]]"]
---
...
=== Embedded system ===
Embedded systems have the most variation in their processing power and cost: from an 8-bit processor that could cost less than USD0.10, to higher-end processors capable of billions of operations per second and costing over USD100. Cost is a particular concern with these systems, with designers often choosing the cheapest option that satisfies the performance requirements.
...
Hennessy, John L.; Patterson, David A. (2011). Computer Architecture: A Quantitative Approach. Elsevier. ISBN 978-0-12-383872-8.
Mendelson, Avi (2022). "The Architecture". In Anupam Chattopadhyay (ed.). Handbook of Computer Architecture. Springer Nature. pp. 1–42. doi:10.1007/978-981-15-6401-7_1-1. ISBN 978-981-15-6401-7.
