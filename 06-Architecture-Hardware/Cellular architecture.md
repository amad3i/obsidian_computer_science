...
level: intermediate
source: "https://en.wikipedia.org/wiki/Cellular_architecture"
wikipedia_categories: ["Classes of computers", "Computer architecture", "Computer hardware stubs", "Parallel computing"]
related: ["[[Locale (computer hardware)]]", "[[Single instruction, multiple threads]]", "[[Spatial architecture]]", "[[Superscalar processor]]", "[[Amorphous computing]]", "[[Asymmetric multiprocessing]]", "[[Computer cluster]]", "[[Content-addressable parallel processor]]", "[[Dataflow architecture]]", "[[DOPIPE]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Cellular_architecture