...
wikipedia_categories: ["Central processing unit", "Instruction processing", "Instruction set architectures", "Microprocessors"]
related: ["[[TRIPS architecture]]", "[[Microarchitecture]]", "[[Multithreading (computer architecture)]]", "[[Very long instruction word]]", "[[Arithmetic logic unit]]", "[[Branch queue]]", "[[Byte addressing]]", "[[Central processing unit]]", "[[Comparison of instruction set architectures]]", "[[Computer architecture]]"]
---
...
Execute an instruction at another location and continue at the next instruction following the execute.
...
Call another block of code, while saving the context of the next instruction as a point to return to.
