...
level: core
source: "https://en.wikipedia.org/wiki/Graphics_pipeline"
wikipedia_categories: ["3D rendering", "Graphics hardware"]
related: ["[[Cinematic rendering]]", "[[CUDA]]", "[[Floating origin]]", "[[Gaussian splatting]]", "[[General-purpose computing on graphics processing units]]", "[[Graphics address remapping table]]", "[[Graphics processing unit]]", "[[Hogel processing unit]]", "[[List of home computers by video hardware]]", "[[Mode setting]]"]
---
...
== Sources ==
Akenine-Möller, Tomas; Haines, Eric; Hoffman, Naty (2019) . Real-Time Rendering. CRC Press. ISBN 9781315362007.
...
- Wikipedia: https://en.wikipedia.org/wiki/Graphics_pipeline