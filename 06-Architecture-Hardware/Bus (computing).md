...
wikipedia_categories: ["Communication interfaces", "Computer buses", "Digital electronics", "Motherboard"]
related: ["[[ABIT BP6]]", "[[AND gate]]", "[[Behavior tree (artificial intelligence, robotics and control)]]", "[[Board support package]]", "[[C-element]]", "[[Central processing unit]]", "[[Combinational logic]]", "[[Computer hardware]]", "[[Cyphal]]", "[[Degradation (telecommunications)]]"]
---
...
To reduce cost, most microcomputers have a bidirectional data bus, reusing the same wires for input and output at different times.
...
- Wikipedia: https://en.wikipedia.org/wiki/Bus_(computing)