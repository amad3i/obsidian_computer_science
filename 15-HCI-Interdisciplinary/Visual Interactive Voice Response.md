---
title: "Visual Interactive Voice Response"
tags: ["cs", "hci-interdisciplinary", "intermediate"]
domain: HCI & Interdisciplinary
level: intermediate
source: "https://en.wikipedia.org/wiki/Visual_Interactive_Voice_Response"
wikipedia_categories: ["Telephone services", "User interface techniques"]
related: ["[[Interactions Corporation]]", "[[Interactive voice response]]", "[[SmartAction]]", "[[3D human–computer interaction]]", "[[Accelerator table]]", "[[Alt-Tab]]", "[[Application posture]]", "[[Attentive user interface]]", "[[Audification]]", "[[Auditory display]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Visual_Interactive_Voice_Response