...
level: intermediate
source: "https://en.wikipedia.org/wiki/European_Data_Format"
wikipedia_categories: ["Bioinformatics", "Computer file formats", "Electroencephalography", "Electrophysiology", "Neurophysiology", "Neurotechnology", "Standards for electronic health records"]
related: ["[[Multiscale Electrophysiology Format]]", "[[General Data Format for Biomedical Signals]]", "[[BGZF]]", "[[Brain mapping]]", "[[EEG analysis]]", "[[Gene transfer format]]", "[[OpenVibe]]", "[[Predicted Aligned Error]]", "[[wps]]", "[[100,000 Genomes Project]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/European_Data_Format