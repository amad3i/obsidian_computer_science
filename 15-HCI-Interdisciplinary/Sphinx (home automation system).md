---
title: "Sphinx (home automation system)"
tags: ["cs", "hci-interdisciplinary", "intermediate"]
domain: HCI & Interdisciplinary
level: intermediate
source: "https://en.wikipedia.org/wiki/Sphinx_(home_automation_system)"
wikipedia_categories: ["History of computing", "Product design", "Science and technology in the Soviet Union"]
related: ["[[1984 (advertisement)]]", "[[Actor model later history]]", "[[Actor model middle history]]", "[[Addiction by Design]]", "[[Adding machine]]", "[[Algorithms + Data Structures = Programs]]", "[[Alice and Bob]]", "[[Antikythera mechanism]]", "[[Aperture card]]", "[[As We May Think]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Sphinx_(home_automation_system)