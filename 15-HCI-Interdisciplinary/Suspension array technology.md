---
title: "Suspension array technology"
tags: ["cs", "hci-interdisciplinary", "intermediate"]
domain: HCI & Interdisciplinary
level: intermediate
source: "https://en.wikipedia.org/wiki/Suspension_array_technology"
wikipedia_categories: ["Bioinformatics", "DNA", "Gene expression", "Microarrays", "Microtechnology", "Molecular biology techniques"]
related: ["[[DNA microarray]]", "[[Silverquant]]", "[[ChIP-on-chip]]", "[[SNP array]]", "[[Amplicon sequence variant]]", "[[Biochip]]", "[[Chip description file]]", "[[ChIP-exo]]", "[[Consensus sequence]]", "[[DNA and RNA codon tables]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Suspension_array_technology