---
title: "Primary care service area"
tags: ["cs", "hci-interdisciplinary", "intermediate"]
domain: HCI & Interdisciplinary
level: intermediate
source: "https://en.wikipedia.org/wiki/Primary_care_service_area"
wikipedia_categories: ["Accessibility", "Spatial analysis", "Urban studies and planning terminology"]
related: ["[[Accessibility]]", "[[Two-step floating catchment area method]]", "[[Accessibility apps]]", "[[Accessible Books Consortium]]", "[[Accessible housing]]", "[[AccessiWay]]", "[[Acoustic wayfinding]]", "[[ADA Signs]]", "[[Adapted automobile]]", "[[Alignments of random points]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Primary_care_service_area