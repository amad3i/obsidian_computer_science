---
title: "European Master Program in Computational Logic"
tags: ["cs", "hci-interdisciplinary", "intermediate"]
domain: HCI & Interdisciplinary
level: intermediate
source: "https://en.wikipedia.org/wiki/European_Master_Program_in_Computational_Logic"
wikipedia_categories: ["Computer science education", "Erasmus Mundus Programmes", "Study abroad programs"]
related: ["[[Color in Informatics and Media Technology]]", "[[European Master on Software Engineering]]", "[[ACM-W]]", "[[AP Computer Science]]", "[[AP Computer Science A]]", "[[AP Computer Science Principles]]", "[[App Academy]]", "[[Bachelor of Computer Information Systems]]", "[[Bachelor of Computer Science]]", "[[Bachelor of Computing]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/European_Master_Program_in_Computational_Logic