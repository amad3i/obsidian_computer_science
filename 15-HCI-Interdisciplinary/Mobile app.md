...
level: intermediate
source: "https://en.wikipedia.org/wiki/Mobile_app"
wikipedia_categories: ["Mobile applications", "Mobile software", "User interface techniques"]
related: ["[[Coolgorilla]]", "[[3D human–computer interaction]]", "[[Accelerator table]]", "[[Accessibility apps]]", "[[Alt-Tab]]", "[[Application posture]]", "[[Attentive user interface]]", "[[Audification]]", "[[Auditory display]]", "[[Augmented reality]]"]
---
