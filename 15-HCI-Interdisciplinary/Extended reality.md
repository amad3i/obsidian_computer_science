...
wikipedia_categories: ["Extended reality", "Science fiction themes", "Subfields of computer science", "User interface techniques", "Wearable computers", "Wearable devices"]
related: ["[[AlterEgo]]", "[[Smart ring]]", "[[Spatial computing]]", "[[Wearable computer]]", "[[3D computer graphics]]", "[[3D human–computer interaction]]", "[[Accelerator table]]", "[[AI takeover]]", "[[Alt-Tab]]", "[[Apple Vision Pro]]"]
---

# Extended reality

Extended reality (XR) is both an umbrella term for the various realities like augmented reality (AR), virtual reality (VR), etc., as well as a means to interpolate between them and eXtrapolate (eXtend) beyond them.  See also  The technology is intended to combine or mirror the physical world with a "digital twin world" able to interact with it, giving users an immersive experience by being in a virtual, augmented, intelligent, digital, etc., environment.
...
The International Institute of MetaNumismatics (INIMEN) studies the applications of extended reality technologies in numismatic research, with a research department.
