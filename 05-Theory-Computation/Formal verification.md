...
wikipedia_categories: ["Electronic circuit verification", "Formal methods", "Logic in computer science", "Theoretical computer science"]
related: ["[[Bisimulation]]", "[[1-in-3-SAT]]", "[[Agent verification]]", "[[Algebraic semantics (computer science)]]", "[[Assertion (software development)]]", "[[Automated reasoning]]", "[[Bigraph]]", "[[Boolean satisfiability problem]]", "[[CompCert]]", "[[Formal equivalence checking]]"]
---
