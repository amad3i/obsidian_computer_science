...
wikipedia_categories: ["Logic in computer science", "Model checking"]
related: ["[[1-in-3-SAT]]", "[[Abstract model checking]]", "[[Abstract rewriting system]]", "[[ACM Transactions on Computational Logic]]", "[[Agent verification]]", "[[Agentive logic]]", "[[Algebraic semantics (computer science)]]", "[[Alternating timed automaton]]", "[[Alternating-time temporal logic]]", "[[Assertion (software development)]]"]
---
