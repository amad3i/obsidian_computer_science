...
wikipedia_categories: ["Automata (computation)", "Digital electronics", "Logic in computer science"]
related: ["[[Behavior tree (artificial intelligence, robotics and control)]]", "[[Combinational logic]]", "[[Computation tree logic]]", "[[Logic optimization]]", "[[Star-free language]]", "[[UML state machine]]", "[[1-in-3-SAT]]", "[[Abstract machine]]", "[[Abstract rewriting system]]", "[[ACM Transactions on Computational Logic]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Sequential_logic