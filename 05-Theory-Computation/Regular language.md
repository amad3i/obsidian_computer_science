...
wikipedia_categories: ["Finite-state machines", "Formal languages"]
related: ["[[Myhill–Nerode theorem]]", "[[Pumping lemma for regular languages]]", "[[Tree transducer]]", "[[Abstract family of acceptors]]", "[[Abstract family of languages]]", "[[Abstract rewriting system]]", "[[Abstract semantic graph]]", "[[Abstract syntax tree]]", "[[Action algebra]]", "[[Adaptive grammar]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Regular_language