...
level: advanced
source: "https://en.wikipedia.org/wiki/Automated_reasoning"
wikipedia_categories: ["Automated reasoning", "Automated theorem proving", "Logic in computer science", "Theoretical computer science"]
related: ["[[Backward chaining]]", "[[Bisimulation]]", "[[Formal verification]]", "[[Model elimination]]", "[[Proof complexity]]", "[[Propositional proof system]]", "[[Reasoning system]]", "[[Unification (computer science)]]", "[[WalkSAT]]", "[[1-in-3-SAT]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Automated_reasoning