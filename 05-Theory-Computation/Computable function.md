...
level: advanced
source: "https://en.wikipedia.org/wiki/Computable_function"
wikipedia_categories: ["Computability theory", "Theory of computation"]
related: ["[[Ackermann function]]", "[[Admissible numbering]]", "[[Busy beaver]]", "[[Chain rule for Kolmogorov complexity]]", "[[Church–Turing thesis]]", "[[Church–Turing–Deutsch principle]]", "[[Computability]]", "[[Computable number]]", "[[Computable set]]", "[[Computably enumerable set]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Computable_function