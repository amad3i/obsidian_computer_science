...
wikipedia_categories: ["1936 in computing", "1937 in computing", "Abstract machines", "Alan Turing", "Automata (computation)", "Computability theory", "Educational abstract machines", "English inventions"]
related: ["[[Random-access Turing machine]]", "[[Krivine machine]]", "[[Abstract machine]]", "[[Church–Turing thesis]]", "[[Church–Turing–Deutsch principle]]", "[[Description number]]", "[[History of the Church–Turing thesis]]", "[[Lambda calculus]]", "[[Turing degree]]", "[[Ackermann function]]"]
---
...
== Formal definition ==
Following Hopcroft & Ullman (1979), a (one-tape) Turing machine can be formally defined as a 7-tuple 
