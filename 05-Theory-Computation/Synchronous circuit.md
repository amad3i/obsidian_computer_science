...
level: advanced
source: "https://en.wikipedia.org/wiki/Synchronous_circuit"
wikipedia_categories: ["Automata (computation)", "Clock signal"]
related: ["[[Asynchronous circuit]]", "[[Abstract machine]]", "[[Alternating timed automaton]]", "[[Alternating tree automata]]", "[[Augmented transition network]]", "[[Automata theory]]", "[[Automatic sequence]]", "[[Behavior tree (artificial intelligence, robotics and control)]]", "[[Boolean differential calculus]]", "[[CIP-Tool]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Synchronous_circuit