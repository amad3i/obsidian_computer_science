---
title: "Server-Gated Cryptography"
tags: ["cs", "security-cryptography", "intermediate"]
domain: Security & Cryptography
level: intermediate
source: "https://en.wikipedia.org/wiki/Server-Gated_Cryptography"
wikipedia_categories: ["Cryptography", "Transport Layer Security"]
related: ["[[BREACH]]", "[[HTTP Strict Transport Security]]", "[[POODLE]]", "[[123 Reg]]", "[[Accumulator (cryptography)]]", "[[Adaptive redaction]]", "[[Advanced Encryption Standard]]", "[[Alice and Bob]]", "[[Anonymous matching]]", "[[Anonymous remailer]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Server-Gated_Cryptography