...
wikipedia_categories: ["Access control", "Applications of cryptography", "Authentication", "Computer access control", "Notary", "Packaging"]
related: ["[[Authorization]]", "[[Friend-to-friend]]", "[[Access control]]", "[[Anti-hijack system]]", "[[Attack path management]]", "[[CAPTCHA]]", "[[Crypto-anarchy]]", "[[Cryptocurrency]]", "[[Decentralized autonomous organization]]", "[[Delegated administration]]"]
---
