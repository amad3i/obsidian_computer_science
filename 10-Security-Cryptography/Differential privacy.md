...
wikipedia_categories: ["Differential privacy", "Information privacy", "Theory of cryptography"]
related: ["[[Adversarial stylometry]]", "[[Averaging argument]]", "[[Bent function]]", "[[Data aggregation]]", "[[Data shadow]]", "[[Differentially private stochastic gradient descent]]", "[[Dual basis in a field extension]]", "[[HAIFA construction]]", "[[Information privacy law]]", "[[Lattice reduction]]"]
---
...
The algorithm 
 ...
 is said to provide (ε, δ)-differential privacy if, for all datasets 
...
. In the latter case, the algorithm is commonly said to satisfy ε-differential privacy (i.e., omitting 
...
, then they would be unable to distinguish between the two datasets.
...
An important definition with respect to ε-differentially private mechanisms is sensitivity. Let 
...
where the maximum is over all pairs of datasets 
 ...
 denotes the L1 norm. In the example of the medical database above, if we consider 
