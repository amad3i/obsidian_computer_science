...
level: core
source: "https://en.wikipedia.org/wiki/Block_cipher"
wikipedia_categories: ["Block ciphers", "Cryptographic primitives"]
related: ["[[Advanced Encryption Standard]]", "[[Ascon (cipher)]]", "[[CDMF]]", "[[Comparison of cryptographic hash functions]]", "[[Conditional disclosure of secrets]]", "[[Cryptographic hash function]]", "[[Cryptographically secure pseudorandom number generator]]", "[[Digital signature]]", "[[Format-preserving encryption]]", "[[Mix network]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Block_cipher