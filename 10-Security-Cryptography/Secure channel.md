...
wikipedia_categories: ["Cryptography", "Secure communication"]
related: ["[[Blacker (security)]]", "[[End-to-end encryption]]", "[[Messaging Layer Security]]", "[[Red-black concept]]", "[[Secure voice]]", "[[Sender Keys]]", "[[123 Reg]]", "[[Accumulator (cryptography)]]", "[[Adaptive redaction]]", "[[Advanced Encryption Standard]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Secure_channel