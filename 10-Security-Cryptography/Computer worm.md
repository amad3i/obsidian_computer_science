...
wikipedia_categories: ["Computer worms", "Security breaches", "Types of malware"]
related: ["[[Infostealer]]", "[[Keystroke logging]]", "[[List of spyware programs]]", "[[Ransomware]]", "[[Spyware]]", "[[Agent Tesla]]", "[[Backdoor (computing)]]", "[[BianLian]]", "[[Botnet]]", "[[Code mobility]]"]
---
...
Comprehensive Study on Computer Worm, Valliammal.N
...
- Wikipedia: https://en.wikipedia.org/wiki/Computer_worm