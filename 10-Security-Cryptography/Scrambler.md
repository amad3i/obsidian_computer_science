...
level: intermediate
source: "https://en.wikipedia.org/wiki/Scrambler"
wikipedia_categories: ["Applications of randomness", "Cryptography", "Line codes", "Satellite broadcasting", "Telecommunications equipment", "Television terminology"]
related: ["[[10-foot user interface]]", "[[123 Reg]]", "[[Accumulator (cryptography)]]", "[[Adaptive redaction]]", "[[Advanced Encryption Standard]]", "[[Alice and Bob]]", "[[Anonymous matching]]", "[[Anonymous remailer]]", "[[Array controller based encryption]]", "[[Backdoor (computing)]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Scrambler