...
wikipedia_categories: ["21st-century inventions", "Bitcoin", "Blockchains", "Computer-related introductions in 2009"]
related: ["[[Andrew Lee (entrepreneur)]]", "[[Avalanche (blockchain platform)]]", "[[Bitcoin]]", "[[Bitcoin Satoshi Vision]]", "[[Blockchain game]]", "[[Confidential Consortium Framework]]", "[[Cosmos (network)]]", "[[Cryptocurrency exchange]]", "[[Cryptoeconomics]]", "[[Decentralized application]]"]
---
