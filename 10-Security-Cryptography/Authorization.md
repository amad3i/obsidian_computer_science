...
wikipedia_categories: ["Access control", "Authority", "Computer access control"]
related: ["[[Authentication]]", "[[Access control]]", "[[Anti-hijack system]]", "[[Attack path management]]", "[[Delegated administration]]", "[[HTTP cookie]]", "[[Light-weight Identity]]", "[[OAuth]]", "[[Software token]]", "[[Time-based one-time password]]"]
---
