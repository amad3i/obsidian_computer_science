...
wikipedia_categories: ["Extreme programming", "Types of tools used in software development", "Unit testing"]
related: ["[[Mock object]]", "[[Build automation]]", "[[Code refactoring]]", "[[Continuous integration]]", "[[Continuous test-driven development]]", "[[Daily build]]", "[[Database refactoring]]", "[[Extreme programming]]", "[[Extreme programming practices]]", "[[Google Guice]]"]
---
...
Unit testing embedded system software presents challenges because the software is being developed on a different platform than the one it will eventually run on, making it difficult to run a test program in the actual deployment environment, as is possible with desktop programs.
...
Unit testing is also critical to the concept of Emergent Design, which develops software design iteratively through short test-driven development cycles of writing a unit test, making it pass, and refactoring; unit tests provide the regression safety net that makes continuous refactoring safe.
