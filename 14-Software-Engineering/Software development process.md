...
wikipedia_categories: ["Methodology", "Software development process", "Software engineering"]
related: ["[[Developer experience]]", "[[Lightweight methodology]]", "[[List of software development philosophies]]", "[[Mobile DevOps]]", "[[Systems development life cycle]]", "[[Test data management]]", "[[Abstraction (computer science)]]", "[[Adaptive software development]]", "[[Agile contracts]]", "[[Agile software development]]"]
---
