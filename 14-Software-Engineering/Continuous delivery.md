...
wikipedia_categories: ["Software design", "Software development process", "Software release"]
related: ["[[Continuous deployment]]", "[[Deployment environment]]", "[[DevOps toolchain]]", "[[Domain engineering]]", "[[Empathy map]]", "[[Thoughtworks]]", "[[Adaptive software development]]", "[[Agile contracts]]", "[[Alsys]]", "[[Ambiguous viewpoint]]"]
---
