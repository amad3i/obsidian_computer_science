...
level: intermediate
source: "https://en.wikipedia.org/wiki/Software_quality"
wikipedia_categories: ["Software quality", "Software testing", "Source code", "Systems thinking"]
related: ["[[Business process validation]]", "[[Flaky test]]", "[[List of software bugs]]", "[[Process validation]]", "[[Reverse semantic traceability]]", "[[Self-healing test automation]]", "[[Software map]]", "[[Software testability]]", "[[Software visualization]]", "[[Sourcetrail]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Software_quality