...
level: intermediate
source: "https://en.wikipedia.org/wiki/Adaptive_software_development"
wikipedia_categories: ["Agile software development", "Software development process"]
related: ["[[Agile contracts]]", "[[Continuous configuration automation]]", "[[Continuous integration]]", "[[Design sprint]]", "[[ICONIX]]", "[[Infrastructure as code]]", "[[Lightweight methodology]]", "[[P-Modeling Framework]]", "[[Service design sprint]]", "[[Spike (software development)]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Adaptive_software_development