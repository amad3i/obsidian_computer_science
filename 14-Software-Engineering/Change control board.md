...
level: intermediate
source: "https://en.wikipedia.org/wiki/Change_control_board"
wikipedia_categories: ["Software development process", "Software engineering stubs"]
related: ["[[Developer ecosystem]]", "[[ISO-IEC 33001]]", "[[Merise]]", "[[Microsoft Security Development Lifecycle]]", "[[Push on green]]", "[[Spike (software development)]]", "[[Tester-driven development]]", "[[Active reviews for intermediate designs]]", "[[Adaptive algorithm]]", "[[Adaptive software development]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Change_control_board