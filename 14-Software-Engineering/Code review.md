...
wikipedia_categories: ["Peer review", "Software review", "Source code"]
related: ["[[Dead code]]", "[[Duplicate code]]", "[[Infer Static Analyzer]]", "[[Label (computer science)]]", "[[Mock object]]", "[[Pair programming]]", "[[Polyglot (computing)]]", "[[Software inspection]]", "[[Software intelligence]]", "[[Software quality]]"]
---
