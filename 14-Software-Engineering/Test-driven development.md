...
related: ["[[Continuous test-driven development]]", "[[Transformation Priority Premise]]", "[[Acceptance test-driven development]]", "[[Classification Tree Method]]", "[[Continuous integration]]", "[[Daily build]]", "[[Door problem]]", "[[Dynamic testing]]", "[[Extreme programming]]", "[[Extreme programming practices]]"]
---
