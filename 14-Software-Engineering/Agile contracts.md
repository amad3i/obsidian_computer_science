...
level: intermediate
source: "https://en.wikipedia.org/wiki/Agile_contracts"
wikipedia_categories: ["Agile software development", "Procurement", "Software development process", "Software project management"]
related: ["[[Acceptance testing]]", "[[Adaptive software development]]", "[[Agile software development]]", "[[Continuous configuration automation]]", "[[Continuous integration]]", "[[Design sprint]]", "[[Endeavour Software Project Management]]", "[[Enterprise unified process]]", "[[ICONIX]]", "[[Infrastructure as code]]"]
---
...
- Wikipedia: https://en.wikipedia.org/wiki/Agile_contracts