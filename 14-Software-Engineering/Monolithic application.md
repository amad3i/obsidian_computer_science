...
wikipedia_categories: ["History of software", "Software architecture", "Software engineering stubs"]
related: ["[[Active reviews for intermediate designs]]", "[[Common Component Architecture]]", "[[Connection broker]]", "[[Darwin (ADL)]]", "[[Presentation logic]]", "[[Reference architecture]]", "[[SAP Enterprise Architecture Framework]]", "[[Semantic architecture]]", "[[Service mesh]]", "[[Software architecture analysis method]]"]
---
