...
wikipedia_categories: ["Agile software development", "Continuous integration", "Extreme programming", "Software development process"]
related: ["[[Adaptive software development]]", "[[Agile contracts]]", "[[Azure DevOps Server]]", "[[Continuous configuration automation]]", "[[Continuous test-driven development]]", "[[Design sprint]]", "[[Extreme programming]]", "[[Extreme programming practices]]", "[[ICONIX]]", "[[Infrastructure as code]]"]
---
